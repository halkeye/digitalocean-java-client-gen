...
public final class VolumeSnapshots {
    ...
    private interface VolumeSnapshotsService {
        ...
        Mono<VolumeSnapshotsGetByIdResponse> getById(
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VolumeSnapshotsDeleteByIdResponse> deleteById(
                @HostParam("$host") String host,
                @PathParam("snapshot_id") Object snapshotId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VolumeSnapshotsListResponse> list(
                @HostParam("$host") String host,
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VolumeSnapshotsCreateResponse> create(
                @HostParam("$host") String host,
                @PathParam("volume_id") UUID volumeId,
                @BodyParam("application/json")
                        Paths1Vjb9PvV2VolumesVolumeIdSnapshotsPostRequestbodyContentApplicationJsonSchema body,
                @HeaderParam("Accept") String accept);
    }
     ...
     *
     * <p>To retrieve the details of a snapshot that has been created from a volume, send a GET request to
    ...
    public Mono<Object> getByIdAsync(Object snapshotId) {
        return getByIdWithResponseAsync(snapshotId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Delete a Volume Snapshot
     *
     * <p>To delete a volume snapshot, send a DELETE request to `/v2/snapshots/$SNAPSHOT_ID`.
     *
    ...
    public Mono<Error> deleteByIdAsync(Object snapshotId) {
        return deleteByIdWithResponseAsync(snapshotId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * List Snapshots for a Volume
     *
     * <p>To retrieve the snapshots that have been created from a volume, send a GET request to
     ...
     *
     * <p>To create a snapshot from a volume, sent a POST request to `/v2/volumes/$VOLUME_ID/snapshots`.
     *
     * @param volumeId The ID of the block storage volume.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VolumeSnapshotsCreateResponse> createWithResponseAsync(
            UUID volumeId, Paths1Vjb9PvV2VolumesVolumeIdSnapshotsPostRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> createAsync(
            UUID volumeId, Paths1Vjb9PvV2VolumesVolumeIdSnapshotsPostRequestbodyContentApplicationJsonSchema body) {
        return createWithResponseAsync(volumeId, body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
}
