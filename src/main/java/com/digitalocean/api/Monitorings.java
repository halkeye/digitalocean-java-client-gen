...
public final class Monitorings {
     ...
     */
     Monitorings(GeneratedClient client) {
        this.service = RestProxy.create(MonitoringsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for GeneratedClientMonitorings to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface MonitoringsService {
        ...
        Mono<MonitoringsListAlertPolicyResponse> listAlertPolicy(@HostParam("$host") String host, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Post("/v2/monitoring/alerts")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsCreateAlertPolicyResponse> createAlertPolicy(@HostParam("$host") String host, @BodyParam("application/json") AlertPolicyRequest body, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/alerts/{alert_uuid}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetAlertPolicyResponse> getAlertPolicy(@HostParam("$host") String host, @PathParam("alert_uuid") String alertUuid, @HeaderParam("Accept") String accept);

        @Put("/v2/monitoring/alerts/{alert_uuid}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsUpdateAlertPolicyResponse> updateAlertPolicy(@HostParam("$host") String host, @PathParam("alert_uuid") String alertUuid, @BodyParam("application/json") AlertPolicyRequest body, @HeaderParam("Accept") String accept);

        @Delete("/v2/monitoring/alerts/{alert_uuid}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsDeleteAlertPolicyResponse> deleteAlertPolicy(@HostParam("$host") String host, @PathParam("alert_uuid") String alertUuid, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/bandwidth")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletBandwidthMetricsResponse> getDropletBandwidthMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("interface") Enum78 interfaceParameter, @QueryParam("direction") Enum79 direction, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/cpu")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletCpuMetricsResponse> getDropletCpuMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/filesystem_free")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletFilesystemFreeMetricsResponse> getDropletFilesystemFreeMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/filesystem_size")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletFilesystemSizeMetricsResponse> getDropletFilesystemSizeMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/load_1")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletLoad1MetricsResponse> getDropletLoad1Metrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/load_5")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletLoad5MetricsResponse> getDropletLoad5Metrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/load_15")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletLoad15MetricsResponse> getDropletLoad15Metrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/memory_cached")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletMemoryCachedMetricsResponse> getDropletMemoryCachedMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/memory_free")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletMemoryFreeMetricsResponse> getDropletMemoryFreeMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/memory_total")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletMemoryTotalMetricsResponse> getDropletMemoryTotalMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);

        @Get("/v2/monitoring/metrics/droplet/memory_available")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<MonitoringsGetDropletMemoryAvailableMetricsResponse> getDropletMemoryAvailableMetrics(@HostParam("$host") String host, @QueryParam("host_id") String hostId, @QueryParam("start") String start, @QueryParam("end") String end, @HeaderParam("Accept") String accept);
    }
    ...
    public Mono<Object> listAlertPolicyAsync(Integer perPage, Integer page) {
        return listAlertPolicyWithResponseAsync(perPage, page)
    ...
    public Mono<Object> createAlertPolicyAsync(AlertPolicyRequest body) {
        return createAlertPolicyWithResponseAsync(body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getAlertPolicyAsync(String alertUuid) {
        return getAlertPolicyWithResponseAsync(alertUuid)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsUpdateAlertPolicyResponse> updateAlertPolicyWithResponseAsync(String alertUuid, AlertPolicyRequest body) {
        final String accept = "application/json";
    ...
    public Mono<Object> updateAlertPolicyAsync(String alertUuid, AlertPolicyRequest body) {
        return updateAlertPolicyWithResponseAsync(alertUuid, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Error> deleteAlertPolicyAsync(String alertUuid) {
        return deleteAlertPolicyWithResponseAsync(alertUuid)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletBandwidthMetricsResponse> getDropletBandwidthMetricsWithResponseAsync(String hostId, Enum78 interfaceParameter, Enum79 direction, String start, String end) {
        final String accept = "application/json";
        return service.getDropletBandwidthMetrics(this.client.getHost(), hostId, interfaceParameter, direction, start, end, accept);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> getDropletBandwidthMetricsAsync(String hostId, Enum78 interfaceParameter, Enum79 direction, String start, String end) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletCpuMetricsResponse> getDropletCpuMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletFilesystemFreeMetricsResponse> getDropletFilesystemFreeMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletFilesystemSizeMetricsResponse> getDropletFilesystemSizeMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletLoad1MetricsResponse> getDropletLoad1MetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletLoad5MetricsResponse> getDropletLoad5MetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletLoad15MetricsResponse> getDropletLoad15MetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletMemoryCachedMetricsResponse> getDropletMemoryCachedMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletMemoryFreeMetricsResponse> getDropletMemoryFreeMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletMemoryTotalMetricsResponse> getDropletMemoryTotalMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<MonitoringsGetDropletMemoryAvailableMetricsResponse> getDropletMemoryAvailableMetricsWithResponseAsync(String hostId, String start, String end) {
        final String accept = "application/json";
