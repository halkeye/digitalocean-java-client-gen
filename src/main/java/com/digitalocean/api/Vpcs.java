...
public final class Vpcs {
    ...
    private interface VpcsService {
        ...
        Mono<VpcsListResponse> list(@HostParam("$host") String host, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Post("/v2/vpcs")
        @ExpectedResponses({201, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsCreateResponse> create(@HostParam("$host") String host, @BodyParam("application/json") Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema body, @HeaderParam("Accept") String accept);

        @Get("/v2/vpcs/{vpc_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsGetResponse> get(@HostParam("$host") String host, @PathParam("vpc_id") UUID vpcId, @HeaderParam("Accept") String accept);

        @Put("/v2/vpcs/{vpc_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsUpdateResponse> update(@HostParam("$host") String host, @PathParam("vpc_id") UUID vpcId, @BodyParam("application/json") PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema body, @HeaderParam("Accept") String accept);

        @Patch("/v2/vpcs/{vpc_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsPatchResponse> patch(@HostParam("$host") String host, @PathParam("vpc_id") UUID vpcId, @BodyParam("application/json") Paths1NwapakV2VpcsVpcIdPatchRequestbodyContentApplicationJsonSchema body, @HeaderParam("Accept") String accept);

        @Delete("/v2/vpcs/{vpc_id}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsDeleteResponse> delete(@HostParam("$host") String host, @PathParam("vpc_id") UUID vpcId, @HeaderParam("Accept") String accept);

        @Get("/v2/vpcs/{vpc_id}/members")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<VpcsListMembersResponse> listMembers(@HostParam("$host") String host, @PathParam("vpc_id") UUID vpcId, @QueryParam("resource_type") String resourceType, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpcsCreateResponse> createWithResponseAsync(Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
    ...
    public Mono<Object> getAsync(UUID vpcId) {
        return getWithResponseAsync(vpcId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpcsUpdateResponse> updateWithResponseAsync(UUID vpcId, PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
    ...
    public Mono<Object> updateAsync(UUID vpcId, PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema body) {
        return updateWithResponseAsync(vpcId, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpcsPatchResponse> patchWithResponseAsync(UUID vpcId, Paths1NwapakV2VpcsVpcIdPatchRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> patchAsync(UUID vpcId, Paths1NwapakV2VpcsVpcIdPatchRequestbodyContentApplicationJsonSchema body) {
        return patchWithResponseAsync(vpcId, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Error> deleteAsync(UUID vpcId) {
        return deleteWithResponseAsync(vpcId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpcsListMembersResponse> listMembersWithResponseAsync(UUID vpcId, String resourceType, Integer perPage, Integer page) {
        final String accept = "application/json";
