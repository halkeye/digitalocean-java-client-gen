...
public final class Kubernetes {
    ...
    Kubernetes(GeneratedClient client) {
        this.service =
                RestProxy.create(KubernetesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }
    ...
    private interface KubernetesService {
        ...
        Mono<KubernetesListClustersResponse> listClusters(
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesCreateClusterResponse> createCluster(
                @HostParam("$host") String host,
                @BodyParam("application/json") Cluster body,
                @HeaderParam("Accept") String accept);

        @Get("/v2/kubernetes/clusters/{cluster_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetClusterResponse> getCluster(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);

        @Put("/v2/kubernetes/clusters/{cluster_id}")
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesUpdateClusterResponse> updateCluster(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @BodyParam("application/json") ClusterUpdate body,
                @HeaderParam("Accept") String accept);

        @Delete("/v2/kubernetes/clusters/{cluster_id}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesDeleteClusterResponse> deleteCluster(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesListAssociatedResourcesResponse> listAssociatedResources(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesDestroyAssociatedResourcesSelectiveResponse> destroyAssociatedResourcesSelective(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @BodyParam("application/json") DestroyAssociatedKubernetesResources body,
                @HeaderParam("Accept") String accept);

        @Delete("/v2/kubernetes/clusters/{cluster_id}/destroy_with_associated_resources/dangerous")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesDestroyAssociatedResourcesDangerousResponse> destroyAssociatedResourcesDangerous(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetKubeconfigResponse> getKubeconfig(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetCredentialsResponse> getCredentials(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @QueryParam("expiry_seconds") Integer expirySeconds,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetAvailableUpgradesResponse> getAvailableUpgrades(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesUpgradeClusterResponse> upgradeCluster(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesListNodePoolsResponse> listNodePools(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesAddNodePoolResponse> addNodePool(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @BodyParam("application/json") KubernetesNodePool body,
                @HeaderParam("Accept") String accept);

        @Get("/v2/kubernetes/clusters/{cluster_id}/node_pools/{node_pool_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetNodePoolResponse> getNodePool(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @PathParam("node_pool_id") UUID nodePoolId,
                @HeaderParam("Accept") String accept);

        @Put("/v2/kubernetes/clusters/{cluster_id}/node_pools/{node_pool_id}")
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesUpdateNodePoolResponse> updateNodePool(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @PathParam("node_pool_id") UUID nodePoolId,
                @BodyParam("application/json") KubernetesNodePoolUpdate body,
                @HeaderParam("Accept") String accept);

        @Delete("/v2/kubernetes/clusters/{cluster_id}/node_pools/{node_pool_id}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesDeleteNodePoolResponse> deleteNodePool(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @PathParam("node_pool_id") UUID nodePoolId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesDeleteNodeResponse> deleteNode(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @PathParam("node_pool_id") UUID nodePoolId,
                @PathParam("node_id") UUID nodeId,
                @QueryParam("skip_drain") Integer skipDrain,
                @QueryParam("replace") Integer replace,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetClusterUserResponse> getClusterUser(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @HeaderParam("Accept") String accept);
        ...
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesListOptionsResponse> listOptions(
                @HostParam("$host") String host, @HeaderParam("Accept") String accept);

        @Post("/v2/kubernetes/clusters/{cluster_id}/clusterlint")
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesRunClusterLintResponse> runClusterLint(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @BodyParam("application/json") ClusterlintRequest body,
                @HeaderParam("Accept") String accept);

        @Get("/v2/kubernetes/clusters/{cluster_id}/clusterlint")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesGetClusterLintResultsResponse> getClusterLintResults(
                @HostParam("$host") String host,
                @PathParam("cluster_id") UUID clusterId,
                @QueryParam("run_id") UUID runId,
                @HeaderParam("Accept") String accept);

        @Post("/v2/kubernetes/registry")
        @ExpectedResponses({204, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesAddRegistryResponse> addRegistry(
                @HostParam("$host") String host,
                @BodyParam("application/json") ClusterRegistries body,
                @HeaderParam("Accept") String accept);

        @Delete("/v2/kubernetes/registry")
        @ExpectedResponses({204, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<KubernetesRemoveRegistryResponse> removeRegistry(
                @HostParam("$host") String host,
                @BodyParam("application/json") ClusterRegistries body,
                @HeaderParam("Accept") String accept);
    }
     ...
     *
     * <p>To list all of the Kubernetes clusters on your account, send a GET request to `/v2/kubernetes/clusters`.
     *
    ...
    public Mono<Object> listClustersAsync(Integer perPage, Integer page) {
        return listClustersWithResponseAsync(perPage, page).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Create a New Kubernetes Cluster
     *
     * <p>To create a new Kubernetes cluster, send a POST request to `/v2/kubernetes/clusters`. The request must contain
     * at least one node pool with at least one worker.
     *
     * <p>The request may contain a maintenance window policy describing a time period when disruptive maintenance tasks
     * may be carried out. Omitting the policy implies that a window will be chosen automatically. See
     * [here](https://www.digitalocean.com/docs/kubernetes/how-to/upgrade-cluster/) for details.
     *
     ...
     *
     * <p>To show information about an existing Kubernetes cluster, send a GET request to
    ...
    public Mono<Object> getClusterAsync(UUID clusterId) {
        return getClusterWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Update a Kubernetes Cluster
     *
     * <p>To update a Kubernetes cluster, send a PUT request to `/v2/kubernetes/clusters/$K8S_CLUSTER_ID` and specify
    ...
    public Mono<Object> updateClusterAsync(UUID clusterId, ClusterUpdate body) {
        return updateClusterWithResponseAsync(clusterId, body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Delete a Kubernetes Cluster
     *
     * <p>To delete a Kubernetes cluster and all services deployed to it, send a DELETE request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID`.
     *
     * <p>A 204 status code with no body will be returned in response to a successful request.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
    ...
    public Mono<Error> deleteClusterAsync(UUID clusterId) {
        return deleteClusterWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * List Associated Resources for Cluster Deletion
     *
     * <p>To list the associated billable resources that can be destroyed along with a cluster, send a GET request to
     * the `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/destroy_with_associated_resources` endpoint.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an object containing the IDs of resources associated with a Kubernetes cluster on successful completion
     *     of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ...
    public Mono<Object> listAssociatedResourcesAsync(UUID clusterId) {
        return listAssociatedResourcesWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Selectively Delete a Cluster and its Associated Resources
     *
     * <p>To delete a Kubernetes cluster along with a subset of its associated resources, send a DELETE request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/destroy_with_associated_resources/selective`.
     *
     * <p>The JSON body of the request should include `load_balancers`, `volumes`, or `volume_snapshots` keys each set
     * to an array of IDs for the associated resources to be destroyed.
     *
     * <p>The IDs can be found by querying the cluster's associated resources endpoint. Any associated resource not
     * included in the request will remain and continue to accrue changes on your account.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param body An object containing the IDs of resources to be destroyed along with their associated with a
     *     Kubernetes cluster.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesDestroyAssociatedResourcesSelectiveResponse>
            destroyAssociatedResourcesSelectiveWithResponseAsync(
                    UUID clusterId, DestroyAssociatedKubernetesResources body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Error> destroyAssociatedResourcesSelectiveAsync(
            UUID clusterId, DestroyAssociatedKubernetesResources body) {
     ...
     *
     * <p>To delete a Kubernetes cluster with all of its associated resources, send a DELETE request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/destroy_with_associated_resources/dangerous`. A 204 status code with no
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesDestroyAssociatedResourcesDangerousResponse>
            destroyAssociatedResourcesDangerousWithResponseAsync(UUID clusterId) {
        final String accept = "application/json";
     ...
     *
     * <p>This endpoint returns a kubeconfig file in YAML format. It can be used to connect to and administer the
     * cluster using the Kubernetes command line tool, `kubectl`, or other programs supporting kubeconfig files (e.g.,
     * client libraries).
     *
     * <p>The resulting kubeconfig file uses token-based authentication for clusters supporting it, and
     * certificate-based authentication otherwise. For a list of supported versions and more information, see "[How to
     * Connect to a DigitalOcean Kubernetes Cluster with
     * kubectl](https://www.digitalocean.com/docs/kubernetes/how-to/connect-with-kubectl/)".
     *
     * <p>To retrieve a kubeconfig file for use with a Kubernetes cluster, send a GET request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/kubeconfig`.
     *
     * <p>Clusters supporting token-based authentication may define an expiration by passing a duration in seconds as a
     * query parameter to `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/kubeconfig?expiry_seconds=$DURATION_IN_SECONDS`. If
     * not set or 0, then the token will have a 7 day expiry. The query parameter has no impact in certificate-based
     * authentication.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param expirySeconds The duration in seconds that the returned Kubernetes credentials will be valid. If not set
     *     or 0, the credentials will have a 7 day expiry.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response body on successful completion of {@link Mono}.
     ...
     *
     * <p>This endpoint returns a JSON object . It can be used to programmatically construct Kubernetes clients which
     * cannot parse kubeconfig files.
     *
     * <p>The resulting JSON object contains token-based authentication for clusters supporting it, and
     * certificate-based authentication otherwise. For a list of supported versions and more information, see "[How to
     * Connect to a DigitalOcean Kubernetes Cluster with
     * kubectl](https://www.digitalocean.com/docs/kubernetes/how-to/connect-with-kubectl/)".
     *
     * <p>To retrieve credentials for accessing a Kubernetes cluster, send a GET request to
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesGetCredentialsResponse> getCredentialsWithResponseAsync(
            UUID clusterId, Integer expirySeconds) {
        final String accept = "application/json";
     ...
     *
     * <p>To determine whether a cluster can be upgraded, and the versions to which it can be upgraded, send a GET
     * request to `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/upgrades`.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
    ...
    public Mono<Object> getAvailableUpgradesAsync(UUID clusterId) {
        return getAvailableUpgradesWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Upgrade a Kubernetes Cluster
     *
     * <p>To immediately upgrade a Kubernetes cluster to a newer patch release of Kubernetes, send a POST request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/upgrade`. The body of the request must specify a version attribute.
     *
     * <p>Available upgrade versions for a cluster can be fetched from
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesUpgradeClusterResponse> upgradeClusterWithResponseAsync(
            UUID clusterId,
            Paths1Cfx96QV2KubernetesClustersClusterIdUpgradePostRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Error> upgradeClusterAsync(
            UUID clusterId,
            Paths1Cfx96QV2KubernetesClustersClusterIdUpgradePostRequestbodyContentApplicationJsonSchema body) {
        return upgradeClusterWithResponseAsync(clusterId, body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * List All Node Pools in a Kubernetes Clusters
     *
     * <p>To list all of the node pools in a Kubernetes clusters, send a GET request to
    ...
    public Mono<Object> listNodePoolsAsync(UUID clusterId) {
        return listNodePoolsWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Add a Node Pool to a Kubernetes Cluster
     *
     * <p>To add an additional node pool to a Kubernetes clusters, send a POST request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/node_pools` with the following attributes.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param body The body parameter.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    public Mono<Object> addNodePoolAsync(UUID clusterId, KubernetesNodePool body) {
        return addNodePoolWithResponseAsync(clusterId, body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Retrieve a Node Pool for a Kubernetes Cluster
     *
     * <p>To show information about a specific node pool in a Kubernetes cluster, send a GET request to
    ...
    public Mono<Object> getNodePoolAsync(UUID clusterId, UUID nodePoolId) {
        return getNodePoolWithResponseAsync(clusterId, nodePoolId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Update a Node Pool in a Kubernetes Cluster
     *
     * <p>To update the name of a node pool, edit the tags applied to it, or adjust its number of nodes, send a PUT
     * request to `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/node_pools/$NODE_POOL_ID` with the following attributes.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param nodePoolId A unique ID that can be used to reference a Kubernetes node pool.
     * @param body The body parameter.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesUpdateNodePoolResponse> updateNodePoolWithResponseAsync(
            UUID clusterId, UUID nodePoolId, KubernetesNodePoolUpdate body) {
        final String accept = "application/json";
     ...
     *
     * <p>To delete a node pool, send a DELETE request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/node_pools/$NODE_POOL_ID`.
     *
     * <p>A 204 status code with no body will be returned in response to a successful request. Nodes in the pool will
     * subsequently be drained and deleted.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param nodePoolId A unique ID that can be used to reference a Kubernetes node pool.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
    ...
    public Mono<Error> deleteNodePoolAsync(UUID clusterId, UUID nodePoolId) {
        return deleteNodePoolWithResponseAsync(clusterId, nodePoolId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Delete a Node in a Kubernetes Cluster
     *
     * <p>To delete a single node in a pool, send a DELETE request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/node_pools/$NODE_POOL_ID/nodes/$NODE_ID`.
     *
     * <p>Appending the `skip_drain=1` query parameter to the request causes node draining to be skipped. Omitting the
     * query parameter or setting its value to `0` carries out draining prior to deletion.
     *
     * <p>Appending the `replace=1` query parameter to the request causes the node to be replaced by a new one after
     * deletion. Omitting the query parameter or setting its value to `0` deletes without replacement.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param nodePoolId A unique ID that can be used to reference a Kubernetes node pool.
     * @param nodeId A unique ID that can be used to reference a node in a Kubernetes node pool.
     * @param skipDrain Specifies whether or not to drain workloads from a node before it is deleted. Setting it to `1`
     *     causes node draining to be skipped. Omitting the query parameter or setting its value to `0` carries out
     *     draining prior to deletion.
     * @param replace Specifies whether or not to replace a node after it has been deleted. Setting it to `1` causes the
     *     node to be replaced by a new one after deletion. Omitting the query parameter or setting its value to `0`
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesDeleteNodeResponse> deleteNodeWithResponseAsync(
            UUID clusterId, UUID nodePoolId, UUID nodeId, Integer skipDrain, Integer replace) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Error> deleteNodeAsync(
            UUID clusterId, UUID nodePoolId, UUID nodeId, Integer skipDrain, Integer replace) {
     ...
     *
     * <p>The endpoint has been deprecated. Please use the DELETE
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/node_pools/$NODE_POOL_ID/nodes/$NODE_ID` method instead.
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     * @param nodePoolId A unique ID that can be used to reference a Kubernetes node pool.
     * @param body The body parameter.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesRecycleNodePoolResponse> recycleNodePoolWithResponseAsync(
            UUID clusterId,
            UUID nodePoolId,
            Paths1YaighgV2KubernetesClustersClusterIdNodePoolsNodePoolIdRecyclePostRequestbodyContentApplicationJsonSchema
                    body) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Error> recycleNodePoolAsync(
            UUID clusterId,
            UUID nodePoolId,
            Paths1YaighgV2KubernetesClustersClusterIdNodePoolsNodePoolIdRecyclePostRequestbodyContentApplicationJsonSchema
                    body) {
     ...
     *
     * <p>To show information the user associated with a Kubernetes cluster, send a GET request to
    ...
    public Mono<Object> getClusterUserAsync(UUID clusterId) {
        return getClusterUserWithResponseAsync(clusterId).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * List Available Regions, Node Sizes, and Versions of Kubernetes
     *
     * <p>To list the versions of Kubernetes available for use, the regions that support Kubernetes, and the available
     * node sizes, send a GET request to `/v2/kubernetes/options`.
     *
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response body on successful completion of {@link Mono}.
     ...
     *
     * <p>Clusterlint helps operators conform to Kubernetes best practices around resources, security and reliability to
     * avoid common problems while operating or upgrading the clusters.
     *
     * <p>To request a clusterlint run on your cluster, send a POST request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/clusterlint`. This will run all checks present in the `doks` group by
     * default, if a request body is not specified. Optionally specify the below attributes.
     *
     * <p>For information about the available checks, please refer to [the clusterlint check
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesRunClusterLintResponse> runClusterLintWithResponseAsync(
            UUID clusterId, ClusterlintRequest body) {
        final String accept = "application/json";
    ...
    public Mono<Object> runClusterLintAsync(UUID clusterId, ClusterlintRequest body) {
        return runClusterLintWithResponseAsync(clusterId, body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Fetch Clusterlint Diagnostics for a Kubernetes Cluster
     *
     * <p>To request clusterlint diagnostics for your cluster, send a GET request to
     * `/v2/kubernetes/clusters/$K8S_CLUSTER_ID/clusterlint`. If the `run_id` query parameter is provided, then the
     * diagnostics for the specific run is fetched. By default, the latest results are shown.
     *
     * <p>To find out how to address clusterlint feedback, please refer to [the clusterlint check
     * documentation](https://github.com/digitalocean/clusterlint/blob/master/checks.md).
     *
     * @param clusterId A unique ID that can be used to reference a Kubernetes cluster.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KubernetesGetClusterLintResultsResponse> getClusterLintResultsWithResponseAsync(
            UUID clusterId, UUID runId) {
        final String accept = "application/json";
     ...
     *
     * <p>To integrate the container registry with Kubernetes clusters, send a POST request to
    ...
    public Mono<Error> addRegistryAsync(ClusterRegistries body) {
        return addRegistryWithResponseAsync(body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }

    /**
     * Remove Container Registry from Kubernetes Clusters
     *
     * <p>To remove the container registry from Kubernetes clusters, send a DELETE request to `/v2/kubernetes/registry`.
     *
     * @param body The body parameter.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
    ...
    public Mono<Error> removeRegistryAsync(ClusterRegistries body) {
        return removeRegistryWithResponseAsync(body).flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
}
