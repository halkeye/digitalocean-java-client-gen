...
public final class SshKeysOperations {
    ...
    private interface SshKeysService {
        ...
        Mono<SshKeysListResponse> list(@HostParam("$host") String host, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Post("/v2/account/keys")
        @ExpectedResponses({201, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SshKeysCreateResponse> create(@HostParam("$host") String host, @BodyParam("application/json") SshKeys body, @HeaderParam("Accept") String accept);

        @Get("/v2/account/keys/{ssh_key_identifier}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SshKeysGetResponse> get(@HostParam("$host") String host, @PathParam("ssh_key_identifier") Object sshKeyIdentifier, @HeaderParam("Accept") String accept);

        @Put("/v2/account/keys/{ssh_key_identifier}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SshKeysUpdateResponse> update(@HostParam("$host") String host, @PathParam("ssh_key_identifier") Object sshKeyIdentifier, @BodyParam("application/json") PathsEyeh4JV2AccountKeysSshKeyIdentifierPutRequestbodyContentApplicationJsonSchema body, @HeaderParam("Accept") String accept);

        @Delete("/v2/account/keys/{ssh_key_identifier}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<SshKeysDeleteResponse> delete(@HostParam("$host") String host, @PathParam("ssh_key_identifier") Object sshKeyIdentifier, @HeaderParam("Accept") String accept);
    }
    ...
    public Mono<Object> getAsync(Object sshKeyIdentifier) {
        return getWithResponseAsync(sshKeyIdentifier)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SshKeysUpdateResponse> updateWithResponseAsync(Object sshKeyIdentifier, PathsEyeh4JV2AccountKeysSshKeyIdentifierPutRequestbodyContentApplicationJsonSchema body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> updateAsync(Object sshKeyIdentifier, PathsEyeh4JV2AccountKeysSshKeyIdentifierPutRequestbodyContentApplicationJsonSchema body) {
        return updateWithResponseAsync(sshKeyIdentifier, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Error> deleteAsync(Object sshKeyIdentifier) {
        return deleteWithResponseAsync(sshKeyIdentifier)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
}
