...
public final class Droplets {
    ...
    private interface DropletsService {
        ...
        Mono<DropletsListResponse> list(@HostParam("$host") String host, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @QueryParam("tag_name") String tagName, @QueryParam("name") String name, @HeaderParam("Accept") String accept);

        @Post("/v2/droplets")
        @ExpectedResponses({202, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsCreateResponse> create(@HostParam("$host") String host, @BodyParam("application/json") Object body, @HeaderParam("Accept") String accept);

        @Delete("/v2/droplets")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsDestroyByTagResponse> destroyByTag(@HostParam("$host") String host, @QueryParam("tag_name") String tagName, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsGetResponse> get(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Delete("/v2/droplets/{droplet_id}")
        @ExpectedResponses({204, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsDestroyResponse> destroy(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/backups")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListBackupsResponse> listBackups(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/snapshots")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListSnapshotsResponse> listSnapshots(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/kernels")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListKernelsResponse> listKernels(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/firewalls")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListFirewallsResponse> listFirewalls(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @QueryParam("per_page") Integer perPage, @QueryParam("page") Integer page, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/neighbors")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListNeighborsResponse> listNeighbors(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/destroy_with_associated_resources")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListAssociatedResourcesResponse> listAssociatedResources(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Delete("/v2/droplets/{droplet_id}/destroy_with_associated_resources/selective")
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsDestroyWithAssociatedResourcesSelectiveResponse> destroyWithAssociatedResourcesSelective(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @BodyParam("application/json") SelectiveDestroyAssociatedResource body, @HeaderParam("Accept") String accept);

        @Delete("/v2/droplets/{droplet_id}/destroy_with_associated_resources/dangerous")
        @ExpectedResponses({202, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsDestroyWithAssociatedResourcesDangerousResponse> destroyWithAssociatedResourcesDangerous(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("X-Dangerous") boolean xDangerous, @HeaderParam("Accept") String accept);

        @Get("/v2/droplets/{droplet_id}/destroy_with_associated_resources/status")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsGetDestroyAssociatedResourcesStatusResponse> getDestroyAssociatedResourcesStatus(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Post("/v2/droplets/{droplet_id}/destroy_with_associated_resources/retry")
        @ExpectedResponses({202, 401, 404, 409, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsDestroyRetryWithAssociatedResourcesResponse> destroyRetryWithAssociatedResources(@HostParam("$host") String host, @PathParam("droplet_id") int dropletId, @HeaderParam("Accept") String accept);

        @Get("/v2/reports/droplet_neighbors_ids")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<DropletsListNeighborsIdsResponse> listNeighborsIds(@HostParam("$host") String host, @HeaderParam("Accept") String accept);
    }
     ...
     * @param name Used to filter list response by Droplet name returning only exact matches. It is case-insensitive and can not be combined with `tag_name`.
    ...
    public Mono<DropletsListResponse> listWithResponseAsync(Integer perPage, Integer page, String tagName, String name) {
    ...
    public Mono<Object> listAsync(Integer perPage, Integer page, String tagName, String name) {
        return listWithResponseAsync(perPage, page, tagName, name)
    ...
    public Mono<Error> destroyByTagAsync(String tagName) {
        return destroyByTagWithResponseAsync(tagName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getAsync(int dropletId) {
        return getWithResponseAsync(dropletId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Error> destroyAsync(int dropletId) {
        return destroyWithResponseAsync(dropletId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsListBackupsResponse> listBackupsWithResponseAsync(int dropletId, Integer perPage, Integer page) {
        final String accept = "application/json";
    ...
    public Mono<Object> listBackupsAsync(int dropletId, Integer perPage, Integer page) {
        return listBackupsWithResponseAsync(dropletId, perPage, page)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsListSnapshotsResponse> listSnapshotsWithResponseAsync(int dropletId, Integer perPage, Integer page) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsListKernelsResponse> listKernelsWithResponseAsync(int dropletId, Integer perPage, Integer page) {
        final String accept = "application/json";
    ...
    public Mono<Object> listKernelsAsync(int dropletId, Integer perPage, Integer page) {
        return listKernelsWithResponseAsync(dropletId, perPage, page)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsListFirewallsResponse> listFirewallsWithResponseAsync(int dropletId, Integer perPage, Integer page) {
        final String accept = "application/json";
    ...
    public Mono<Object> listNeighborsAsync(int dropletId) {
        return listNeighborsWithResponseAsync(dropletId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> listAssociatedResourcesAsync(int dropletId) {
        return listAssociatedResourcesWithResponseAsync(dropletId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsDestroyWithAssociatedResourcesSelectiveResponse> destroyWithAssociatedResourcesSelectiveWithResponseAsync(int dropletId, SelectiveDestroyAssociatedResource body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Error> destroyWithAssociatedResourcesSelectiveAsync(int dropletId, SelectiveDestroyAssociatedResource body) {
     ...
     * 
     * @param dropletId A unique identifier for a Droplet instance.
     * @param xDangerous Acknowledge this action will destroy the Droplet and all associated resources and _can not_ be reversed.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response body on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsDestroyWithAssociatedResourcesDangerousResponse> destroyWithAssociatedResourcesDangerousWithResponseAsync(int dropletId, boolean xDangerous) {
        final String accept = "application/json";
     ...
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return an objects containing information about a resources scheduled for deletion on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsGetDestroyAssociatedResourcesStatusResponse> getDestroyAssociatedResourcesStatusWithResponseAsync(int dropletId) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DropletsDestroyRetryWithAssociatedResourcesResponse> destroyRetryWithAssociatedResourcesWithResponseAsync(int dropletId) {
        final String accept = "application/json";
    ...
    public Mono<Object> listNeighborsIdsAsync() {
        return listNeighborsIdsWithResponseAsync()
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
}
