...
public final class Apps {
    ...
    private interface AppsService {
        ...
        Mono<AppsListResponse> list(@HostParam("$host") String host, @QueryParam("page") Integer page, @QueryParam("per_page") Integer perPage, @HeaderParam("Accept") String accept);

        @Post("/v2/apps")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsCreateResponse> create(@HostParam("$host") String host, @BodyParam("application/json") AppsCreateAppRequest body, @HeaderParam("Accept") String accept);

        @Delete("/v2/apps/{id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsDeleteResponse> delete(@HostParam("$host") String host, @PathParam("id") String id, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetResponse> get(@HostParam("$host") String host, @PathParam("id") String id, @QueryParam("name") String name, @HeaderParam("Accept") String accept);

        @Put("/v2/apps/{id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsUpdateResponse> update(@HostParam("$host") String host, @PathParam("id") String id, @BodyParam("application/json") AppsUpdateAppRequest body, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{app_id}/deployments")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsListDeploymentsResponse> listDeployments(@HostParam("$host") String host, @PathParam("app_id") String appId, @QueryParam("page") Integer page, @QueryParam("per_page") Integer perPage, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/deployments")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsCreateDeploymentResponse> createDeployment(@HostParam("$host") String host, @PathParam("app_id") String appId, @BodyParam("application/json") AppsCreateDeploymentRequest body, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{app_id}/deployments/{deployment_id}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetDeploymentResponse> getDeployment(@HostParam("$host") String host, @PathParam("app_id") String appId, @PathParam("deployment_id") String deploymentId, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/deployments/{deployment_id}/cancel")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsCancelDeploymentResponse> cancelDeployment(@HostParam("$host") String host, @PathParam("app_id") String appId, @PathParam("deployment_id") String deploymentId, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{app_id}/deployments/{deployment_id}/components/{component_name}/logs")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetLogsResponseResponse> getLogs(@HostParam("$host") String host, @PathParam("app_id") String appId, @PathParam("deployment_id") String deploymentId, @PathParam("component_name") String componentName, @QueryParam("follow") Boolean follow, @QueryParam("type") Enum18 type, @QueryParam("pod_connection_timeout") String podConnectionTimeout, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{app_id}/deployments/{deployment_id}/logs")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetLogsAggregateResponse> getLogsAggregate(@HostParam("$host") String host, @PathParam("app_id") String appId, @PathParam("deployment_id") String deploymentId, @QueryParam("follow") Boolean follow, @QueryParam("type") Enum18 type, @QueryParam("pod_connection_timeout") String podConnectionTimeout, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/tiers")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsListTiersResponseResponse> listTiers(@HostParam("$host") String host, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/tiers/{slug}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetTierResponseResponse> getTier(@HostParam("$host") String host, @PathParam("slug") String slug, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/tiers/instance_sizes")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsListInstanceSizesResponseResponse> listInstanceSizes(@HostParam("$host") String host, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/tiers/instance_sizes/{slug}")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsGetInstanceSizeResponseResponse> getInstanceSize(@HostParam("$host") String host, @PathParam("slug") String slug, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/regions")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsListRegionsResponseResponse> listRegions(@HostParam("$host") String host, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/propose")
        @ExpectedResponses({200, 401, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsValidateAppSpecResponse> validateAppSpec(@HostParam("$host") String host, @BodyParam("application/json") AppPropose body, @HeaderParam("Accept") String accept);

        @Get("/v2/apps/{app_id}/alerts")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsListAlertsResponseResponse> listAlerts(@HostParam("$host") String host, @PathParam("app_id") String appId, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/alerts/{alert_id}/destinations")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsAssignAlertDestinationsResponse> assignAlertDestinations(@HostParam("$host") String host, @PathParam("app_id") String appId, @PathParam("alert_id") String alertId, @BodyParam("application/json") AppsAssignAppAlertDestinationsRequest body, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/rollback")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsCreateRollbackResponse> createRollback(@HostParam("$host") String host, @PathParam("app_id") String appId, @BodyParam("application/json") AppsRollbackAppRequest body, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/rollback/validate")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsValidateRollbackResponse> validateRollback(@HostParam("$host") String host, @PathParam("app_id") String appId, @BodyParam("application/json") AppsRollbackAppRequest body, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/rollback/commit")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsCommitRollbackResponse> commitRollback(@HostParam("$host") String host, @PathParam("app_id") String appId, @HeaderParam("Accept") String accept);

        @Post("/v2/apps/{app_id}/rollback/revert")
        @ExpectedResponses({200, 401, 404, 429, 500})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<AppsRevertRollbackResponse> revertRollback(@HostParam("$host") String host, @PathParam("app_id") String appId, @HeaderParam("Accept") String accept);
    }
    ...
    public Mono<Object> listAsync(Integer page, Integer perPage) {
        return listWithResponseAsync(page, perPage)
    ...
    public Mono<Object> deleteAsync(String id) {
        return deleteWithResponseAsync(id)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getAsync(String id, String name) {
        return getWithResponseAsync(id, name)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> updateAsync(String id, AppsUpdateAppRequest body) {
        return updateWithResponseAsync(id, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsListDeploymentsResponse> listDeploymentsWithResponseAsync(String appId, Integer page, Integer perPage) {
        final String accept = "application/json";
    ...
    public Mono<Object> listDeploymentsAsync(String appId, Integer page, Integer perPage) {
        return listDeploymentsWithResponseAsync(appId, page, perPage)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsCreateDeploymentResponse> createDeploymentWithResponseAsync(String appId, AppsCreateDeploymentRequest body) {
        final String accept = "application/json";
    ...
    public Mono<Object> createDeploymentAsync(String appId, AppsCreateDeploymentRequest body) {
        return createDeploymentWithResponseAsync(appId, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getDeploymentAsync(String appId, String deploymentId) {
        return getDeploymentWithResponseAsync(appId, deploymentId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> cancelDeploymentAsync(String appId, String deploymentId) {
        return cancelDeploymentWithResponseAsync(appId, deploymentId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     * @param podConnectionTimeout An optional time duration to wait if the underlying component instance is not immediately available. Default: `3m`.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response body on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsGetLogsResponseResponse> getLogsWithResponseAsync(String appId, String deploymentId, String componentName, Enum18 type, Boolean follow, String podConnectionTimeout) {
        final String accept = "application/json";
        return service.getLogs(this.client.getHost(), appId, deploymentId, componentName, follow, type, podConnectionTimeout, accept);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> getLogsAsync(String appId, String deploymentId, String componentName, Enum18 type, Boolean follow, String podConnectionTimeout) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsGetLogsAggregateResponse> getLogsAggregateWithResponseAsync(String appId, String deploymentId, Enum18 type, Boolean follow, String podConnectionTimeout) {
        final String accept = "application/json";
        return service.getLogsAggregate(this.client.getHost(), appId, deploymentId, follow, type, podConnectionTimeout, accept);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> getLogsAggregateAsync(String appId, String deploymentId, Enum18 type, Boolean follow, String podConnectionTimeout) {
    ...
    public Mono<Object> listTiersAsync() {
        return listTiersWithResponseAsync()
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getTierAsync(String slug) {
        return getTierWithResponseAsync(slug)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> listInstanceSizesAsync() {
        return listInstanceSizesWithResponseAsync()
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> getInstanceSizeAsync(String slug) {
        return getInstanceSizeWithResponseAsync(slug)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> listRegionsAsync() {
        return listRegionsWithResponseAsync()
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> validateAppSpecAsync(AppPropose body) {
        return validateAppSpecWithResponseAsync(body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> listAlertsAsync(String appId) {
        return listAlertsWithResponseAsync(appId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsAssignAlertDestinationsResponse> assignAlertDestinationsWithResponseAsync(String appId, String alertId, AppsAssignAppAlertDestinationsRequest body) {
        final String accept = "application/json";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Object> assignAlertDestinationsAsync(String appId, String alertId, AppsAssignAppAlertDestinationsRequest body) {
    ...
    public Mono<Object> createRollbackAsync(String appId, AppsRollbackAppRequest body) {
        return createRollbackWithResponseAsync(appId, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<AppsValidateRollbackResponse> validateRollbackWithResponseAsync(String appId, AppsRollbackAppRequest body) {
        final String accept = "application/json";
    ...
    public Mono<Object> validateRollbackAsync(String appId, AppsRollbackAppRequest body) {
        return validateRollbackWithResponseAsync(appId, body)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Error> commitRollbackAsync(String appId) {
        return commitRollbackWithResponseAsync(appId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
    ...
    public Mono<Object> revertRollbackAsync(String appId) {
        return revertRollbackWithResponseAsync(appId)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));}
}
