...
public final class DropletsDestroyWithAssociatedResourcesSelectiveResponse
        extends ResponseBase<DropletsDestroyWithAssociatedResourcesSelectiveHeaders, Error> {
    /**
     ...
     */
    public DropletsDestroyWithAssociatedResourcesSelectiveResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Error value,
            DropletsDestroyWithAssociatedResourcesSelectiveHeaders headers) {
