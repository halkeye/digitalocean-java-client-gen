...
/**
 * The RegistriesListGarbageCollectionsHeaders model.
 */
@Fluent
public final class RegistriesListGarbageCollectionsHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesListGarbageCollectionsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesListGarbageCollectionsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesListGarbageCollectionsHeaders object itself.
     */
    public RegistriesListGarbageCollectionsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesListGarbageCollectionsHeaders object itself.
     */
    public RegistriesListGarbageCollectionsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesListGarbageCollectionsHeaders object itself.
     */
    public RegistriesListGarbageCollectionsHeaders setRatelimitReset(Integer ratelimitReset) {
