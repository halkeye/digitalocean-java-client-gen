...
/** The DropletsCreateHeaders model. */
@Fluent
public final class DropletsCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletsCreateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletsCreateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletsCreateHeaders object itself.
     */
    public DropletsCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletsCreateHeaders object itself.
     */
    public DropletsCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletsCreateHeaders object itself.
     */
    public DropletsCreateHeaders setRatelimitReset(Integer ratelimitReset) {
