...
/** The DropletsGetHeaders model. */
@Fluent
public final class DropletsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletsGetHeaders object itself.
     */
    public DropletsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletsGetHeaders object itself.
     */
    public DropletsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletsGetHeaders object itself.
     */
    public DropletsGetHeaders setRatelimitReset(Integer ratelimitReset) {
