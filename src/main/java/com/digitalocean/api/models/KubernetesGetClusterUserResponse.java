...
public final class KubernetesGetClusterUserResponse extends ResponseBase<KubernetesGetClusterUserHeaders, Object> {
     ...
     */
    public KubernetesGetClusterUserResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Object value, KubernetesGetClusterUserHeaders headers) {
