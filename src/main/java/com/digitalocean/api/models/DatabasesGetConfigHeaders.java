...
/**
 * The DatabasesGetConfigHeaders model.
 */
@Fluent
public final class DatabasesGetConfigHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetConfigHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetConfigHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetConfigHeaders object itself.
     */
    public DatabasesGetConfigHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetConfigHeaders object itself.
     */
    public DatabasesGetConfigHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetConfigHeaders object itself.
     */
    public DatabasesGetConfigHeaders setRatelimitReset(Integer ratelimitReset) {
