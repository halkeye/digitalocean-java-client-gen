...
/**
 * The DomainsGetRecordHeaders model.
 */
@Fluent
public final class DomainsGetRecordHeaders {
    /*
    ...
    /**
     * Creates an instance of DomainsGetRecordHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DomainsGetRecordHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DomainsGetRecordHeaders object itself.
     */
    public DomainsGetRecordHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DomainsGetRecordHeaders object itself.
     */
    public DomainsGetRecordHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DomainsGetRecordHeaders object itself.
     */
    public DomainsGetRecordHeaders setRatelimitReset(Integer ratelimitReset) {
