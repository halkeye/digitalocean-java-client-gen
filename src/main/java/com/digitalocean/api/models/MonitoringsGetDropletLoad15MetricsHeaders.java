...
/** The MonitoringsGetDropletLoad15MetricsHeaders model. */
@Fluent
public final class MonitoringsGetDropletLoad15MetricsHeaders {
    /*
    ...
    /**
     * Creates an instance of MonitoringsGetDropletLoad15MetricsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public MonitoringsGetDropletLoad15MetricsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the MonitoringsGetDropletLoad15MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad15MetricsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the MonitoringsGetDropletLoad15MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad15MetricsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the MonitoringsGetDropletLoad15MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad15MetricsHeaders setRatelimitReset(Integer ratelimitReset) {
