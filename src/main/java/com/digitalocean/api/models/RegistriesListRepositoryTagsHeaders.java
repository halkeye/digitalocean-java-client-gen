...
/** The RegistriesListRepositoryTagsHeaders model. */
@Fluent
public final class RegistriesListRepositoryTagsHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesListRepositoryTagsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesListRepositoryTagsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesListRepositoryTagsHeaders object itself.
     */
    public RegistriesListRepositoryTagsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesListRepositoryTagsHeaders object itself.
     */
    public RegistriesListRepositoryTagsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesListRepositoryTagsHeaders object itself.
     */
    public RegistriesListRepositoryTagsHeaders setRatelimitReset(Integer ratelimitReset) {
