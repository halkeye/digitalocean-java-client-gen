...
/**
 * The DatabasesPatchConfigHeaders model.
 */
@Fluent
public final class DatabasesPatchConfigHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesPatchConfigHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesPatchConfigHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesPatchConfigHeaders object itself.
     */
    public DatabasesPatchConfigHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesPatchConfigHeaders object itself.
     */
    public DatabasesPatchConfigHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesPatchConfigHeaders object itself.
     */
    public DatabasesPatchConfigHeaders setRatelimitReset(Integer ratelimitReset) {
