...
public final class SubscriptionTierExtendedEligibilityReasonsItem
        extends ExpandableStringEnum<SubscriptionTierExtendedEligibilityReasonsItem> {
    /** Static value OverRepositoryLimit for SubscriptionTierExtendedEligibilityReasonsItem. */
    public static final SubscriptionTierExtendedEligibilityReasonsItem OVER_REPOSITORY_LIMIT =
            fromString("OverRepositoryLimit");

    /** Static value OverStorageLimit for SubscriptionTierExtendedEligibilityReasonsItem. */
    public static final SubscriptionTierExtendedEligibilityReasonsItem OVER_STORAGE_LIMIT =
            fromString("OverStorageLimit");
