...
public final class ErrorWithRootCauses {
    ...
    /**
     * Get the rootCauses property: A list of underlying causes for the error, including details to help resolve it when
     * possible.
     *
    ...
    /**
     * Set the rootCauses property: A list of underlying causes for the error, including details to help resolve it when
     * possible.
     *
