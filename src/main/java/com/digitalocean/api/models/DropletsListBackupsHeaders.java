...
/** The DropletsListBackupsHeaders model. */
@Fluent
public final class DropletsListBackupsHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletsListBackupsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletsListBackupsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletsListBackupsHeaders object itself.
     */
    public DropletsListBackupsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletsListBackupsHeaders object itself.
     */
    public DropletsListBackupsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletsListBackupsHeaders object itself.
     */
    public DropletsListBackupsHeaders setRatelimitReset(Integer ratelimitReset) {
