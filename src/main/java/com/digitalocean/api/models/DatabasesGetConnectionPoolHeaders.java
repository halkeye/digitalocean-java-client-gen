...
/** The DatabasesGetConnectionPoolHeaders model. */
@Fluent
public final class DatabasesGetConnectionPoolHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetConnectionPoolHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetConnectionPoolHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetConnectionPoolHeaders object itself.
     */
    public DatabasesGetConnectionPoolHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetConnectionPoolHeaders object itself.
     */
    public DatabasesGetConnectionPoolHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetConnectionPoolHeaders object itself.
     */
    public DatabasesGetConnectionPoolHeaders setRatelimitReset(Integer ratelimitReset) {
