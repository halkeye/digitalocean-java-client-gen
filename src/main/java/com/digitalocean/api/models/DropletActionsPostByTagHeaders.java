...
/**
 * The DropletActionsPostByTagHeaders model.
 */
@Fluent
public final class DropletActionsPostByTagHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletActionsPostByTagHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletActionsPostByTagHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletActionsPostByTagHeaders object itself.
     */
    public DropletActionsPostByTagHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletActionsPostByTagHeaders object itself.
     */
    public DropletActionsPostByTagHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletActionsPostByTagHeaders object itself.
     */
    public DropletActionsPostByTagHeaders setRatelimitReset(Integer ratelimitReset) {
