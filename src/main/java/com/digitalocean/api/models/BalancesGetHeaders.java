...
/** The BalancesGetHeaders model. */
@Fluent
public final class BalancesGetHeaders {
    /*
    ...
    /**
     * Creates an instance of BalancesGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public BalancesGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the BalancesGetHeaders object itself.
     */
    public BalancesGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the BalancesGetHeaders object itself.
     */
    public BalancesGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the BalancesGetHeaders object itself.
     */
    public BalancesGetHeaders setRatelimitReset(Integer ratelimitReset) {
