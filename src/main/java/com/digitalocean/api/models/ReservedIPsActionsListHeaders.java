...
/**
 * The ReservedIPsActionsListHeaders model.
 */
@Fluent
public final class ReservedIPsActionsListHeaders {
    /*
    ...
    /**
     * Creates an instance of ReservedIPsActionsListHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ReservedIPsActionsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ReservedIPsActionsListHeaders object itself.
     */
    public ReservedIPsActionsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ReservedIPsActionsListHeaders object itself.
     */
    public ReservedIPsActionsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ReservedIPsActionsListHeaders object itself.
     */
    public ReservedIPsActionsListHeaders setRatelimitReset(Integer ratelimitReset) {
