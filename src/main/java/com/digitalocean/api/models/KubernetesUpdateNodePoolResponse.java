...
public final class KubernetesUpdateNodePoolResponse extends ResponseBase<KubernetesUpdateNodePoolHeaders, Object> {
     ...
     */
    public KubernetesUpdateNodePoolResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Object value, KubernetesUpdateNodePoolHeaders headers) {
