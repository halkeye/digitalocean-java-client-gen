...
/**
 * The DatabasesAddConnectionPoolHeaders model.
 */
@Fluent
public final class DatabasesAddConnectionPoolHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesAddConnectionPoolHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesAddConnectionPoolHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesAddConnectionPoolHeaders object itself.
     */
    public DatabasesAddConnectionPoolHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesAddConnectionPoolHeaders object itself.
     */
    public DatabasesAddConnectionPoolHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesAddConnectionPoolHeaders object itself.
     */
    public DatabasesAddConnectionPoolHeaders setRatelimitReset(Integer ratelimitReset) {
