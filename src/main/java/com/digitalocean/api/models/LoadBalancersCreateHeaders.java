...
/** The LoadBalancersCreateHeaders model. */
@Fluent
public final class LoadBalancersCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of LoadBalancersCreateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public LoadBalancersCreateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the LoadBalancersCreateHeaders object itself.
     */
    public LoadBalancersCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the LoadBalancersCreateHeaders object itself.
     */
    public LoadBalancersCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the LoadBalancersCreateHeaders object itself.
     */
    public LoadBalancersCreateHeaders setRatelimitReset(Integer ratelimitReset) {
