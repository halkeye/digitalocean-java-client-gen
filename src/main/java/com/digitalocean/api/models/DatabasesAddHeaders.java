...
/** The DatabasesAddHeaders model. */
@Fluent
public final class DatabasesAddHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesAddHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesAddHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesAddHeaders object itself.
     */
    public DatabasesAddHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesAddHeaders object itself.
     */
    public DatabasesAddHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesAddHeaders object itself.
     */
    public DatabasesAddHeaders setRatelimitReset(Integer ratelimitReset) {
