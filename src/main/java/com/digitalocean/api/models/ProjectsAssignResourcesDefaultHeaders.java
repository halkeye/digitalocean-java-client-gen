...
/** The ProjectsAssignResourcesDefaultHeaders model. */
@Fluent
public final class ProjectsAssignResourcesDefaultHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsAssignResourcesDefaultHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsAssignResourcesDefaultHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ProjectsAssignResourcesDefaultHeaders object itself.
     */
    public ProjectsAssignResourcesDefaultHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsAssignResourcesDefaultHeaders object itself.
     */
    public ProjectsAssignResourcesDefaultHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsAssignResourcesDefaultHeaders object itself.
     */
    public ProjectsAssignResourcesDefaultHeaders setRatelimitReset(Integer ratelimitReset) {
