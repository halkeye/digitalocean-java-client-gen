...
public final class AppRollbackValidationConditionCode extends ExpandableStringEnum<AppRollbackValidationConditionCode> {
     ...
     */
    public static final AppRollbackValidationConditionCode EXCEEDED_REVISION_LIMIT = fromString("exceeded_revision_limit");
     ...
     */
    public static final AppRollbackValidationConditionCode DATABASE_CONFIG_CONFLICT = fromString("database_config_conflict");
     ...
     */
    public static final AppRollbackValidationConditionCode STATIC_SITE_REQUIRES_REBUILD = fromString("static_site_requires_rebuild");

    /**
     * Static value image_source_missing_digest for AppRollbackValidationConditionCode.
     */
    public static final AppRollbackValidationConditionCode IMAGE_SOURCE_MISSING_DIGEST = fromString("image_source_missing_digest");
