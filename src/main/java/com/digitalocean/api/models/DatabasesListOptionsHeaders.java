...
/** The DatabasesListOptionsHeaders model. */
@Fluent
public final class DatabasesListOptionsHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesListOptionsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesListOptionsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesListOptionsHeaders object itself.
     */
    public DatabasesListOptionsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesListOptionsHeaders object itself.
     */
    public DatabasesListOptionsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesListOptionsHeaders object itself.
     */
    public DatabasesListOptionsHeaders setRatelimitReset(Integer ratelimitReset) {
