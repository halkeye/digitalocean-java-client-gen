...
/**
 * The AppsGetTierHeaders model.
 */
@Fluent
public final class AppsGetTierHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsGetTierHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsGetTierHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsGetTierHeaders object itself.
     */
    public AppsGetTierHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsGetTierHeaders object itself.
     */
    public AppsGetTierHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsGetTierHeaders object itself.
     */
    public AppsGetTierHeaders setRatelimitReset(Integer ratelimitReset) {
