...
/** The ProjectsUpdateHeaders model. */
@Fluent
public final class ProjectsUpdateHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsUpdateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     */
    public ProjectsUpdateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsUpdateHeaders object itself.
     */
    public ProjectsUpdateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsUpdateHeaders object itself.
     */
    public ProjectsUpdateHeaders setRatelimitReset(Integer ratelimitReset) {
