...
/** The DropletActionsListHeaders model. */
@Fluent
public final class DropletActionsListHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletActionsListHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletActionsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletActionsListHeaders object itself.
     */
    public DropletActionsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletActionsListHeaders object itself.
     */
    public DropletActionsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletActionsListHeaders object itself.
     */
    public DropletActionsListHeaders setRatelimitReset(Integer ratelimitReset) {
