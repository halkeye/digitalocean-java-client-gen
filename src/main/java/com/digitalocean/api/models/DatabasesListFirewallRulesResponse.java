...
public final class DatabasesListFirewallRulesResponse extends ResponseBase<DatabasesListFirewallRulesHeaders, Object> {
     ...
     */
    public DatabasesListFirewallRulesResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Object value, DatabasesListFirewallRulesHeaders headers) {
