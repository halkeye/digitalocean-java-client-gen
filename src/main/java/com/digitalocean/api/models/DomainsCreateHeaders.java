...
/**
 * The DomainsCreateHeaders model.
 */
@Fluent
public final class DomainsCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of DomainsCreateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DomainsCreateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DomainsCreateHeaders object itself.
     */
    public DomainsCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DomainsCreateHeaders object itself.
     */
    public DomainsCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DomainsCreateHeaders object itself.
     */
    public DomainsCreateHeaders setRatelimitReset(Integer ratelimitReset) {
