...
/** The SnapshotsGetHeaders model. */
@Fluent
public final class SnapshotsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of SnapshotsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public SnapshotsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the SnapshotsGetHeaders object itself.
     */
    public SnapshotsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the SnapshotsGetHeaders object itself.
     */
    public SnapshotsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the SnapshotsGetHeaders object itself.
     */
    public SnapshotsGetHeaders setRatelimitReset(Integer ratelimitReset) {
