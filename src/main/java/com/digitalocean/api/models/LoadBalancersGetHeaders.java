...
/**
 * The LoadBalancersGetHeaders model.
 */
@Fluent
public final class LoadBalancersGetHeaders {
    /*
    ...
    /**
     * Creates an instance of LoadBalancersGetHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public LoadBalancersGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the LoadBalancersGetHeaders object itself.
     */
    public LoadBalancersGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the LoadBalancersGetHeaders object itself.
     */
    public LoadBalancersGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the LoadBalancersGetHeaders object itself.
     */
    public LoadBalancersGetHeaders setRatelimitReset(Integer ratelimitReset) {
