...
/**
 * The LoadBalancersAddForwardingRulesHeaders model.
 */
@Fluent
public final class LoadBalancersAddForwardingRulesHeaders {
    /*
    ...
    /**
     * Creates an instance of LoadBalancersAddForwardingRulesHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public LoadBalancersAddForwardingRulesHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the LoadBalancersAddForwardingRulesHeaders object itself.
     */
    public LoadBalancersAddForwardingRulesHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the LoadBalancersAddForwardingRulesHeaders object itself.
     */
    public LoadBalancersAddForwardingRulesHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the LoadBalancersAddForwardingRulesHeaders object itself.
     */
    public LoadBalancersAddForwardingRulesHeaders setRatelimitReset(Integer ratelimitReset) {
