...
/**
 * The KubernetesGetClusterLintResultsHeaders model.
 */
@Fluent
public final class KubernetesGetClusterLintResultsHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesGetClusterLintResultsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesGetClusterLintResultsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesGetClusterLintResultsHeaders object itself.
     */
    public KubernetesGetClusterLintResultsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesGetClusterLintResultsHeaders object itself.
     */
    public KubernetesGetClusterLintResultsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesGetClusterLintResultsHeaders object itself.
     */
    public KubernetesGetClusterLintResultsHeaders setRatelimitReset(Integer ratelimitReset) {
