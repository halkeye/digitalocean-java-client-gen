...
/** The ProjectsAssignResourcesHeaders model. */
@Fluent
public final class ProjectsAssignResourcesHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsAssignResourcesHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsAssignResourcesHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ProjectsAssignResourcesHeaders object itself.
     */
    public ProjectsAssignResourcesHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsAssignResourcesHeaders object itself.
     */
    public ProjectsAssignResourcesHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsAssignResourcesHeaders object itself.
     */
    public ProjectsAssignResourcesHeaders setRatelimitReset(Integer ratelimitReset) {
