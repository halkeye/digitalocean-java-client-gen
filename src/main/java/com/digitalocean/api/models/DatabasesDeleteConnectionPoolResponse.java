...
public final class DatabasesDeleteConnectionPoolResponse
        extends ResponseBase<DatabasesDeleteConnectionPoolHeaders, Error> {
    /**
     ...
     */
    public DatabasesDeleteConnectionPoolResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Error value,
            DatabasesDeleteConnectionPoolHeaders headers) {
