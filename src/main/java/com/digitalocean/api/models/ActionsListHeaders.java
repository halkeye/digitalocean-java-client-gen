...
/**
 * The ActionsListHeaders model.
 */
@Fluent
public final class ActionsListHeaders {
    /*
    ...
    /**
     * Creates an instance of ActionsListHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ActionsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ActionsListHeaders object itself.
     */
    public ActionsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ActionsListHeaders object itself.
     */
    public ActionsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ActionsListHeaders object itself.
     */
    public ActionsListHeaders setRatelimitReset(Integer ratelimitReset) {
