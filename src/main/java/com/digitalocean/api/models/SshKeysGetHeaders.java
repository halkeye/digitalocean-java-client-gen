...
/**
 * The SshKeysGetHeaders model.
 */
@Fluent
public final class SshKeysGetHeaders {
    /*
    ...
    /**
     * Creates an instance of SshKeysGetHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public SshKeysGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the SshKeysGetHeaders object itself.
     */
    public SshKeysGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the SshKeysGetHeaders object itself.
     */
    public SshKeysGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the SshKeysGetHeaders object itself.
     */
    public SshKeysGetHeaders setRatelimitReset(Integer ratelimitReset) {
