...
/** The AppsValidateRollbackHeaders model. */
@Fluent
public final class AppsValidateRollbackHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsValidateRollbackHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsValidateRollbackHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsValidateRollbackHeaders object itself.
     */
    public AppsValidateRollbackHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsValidateRollbackHeaders object itself.
     */
    public AppsValidateRollbackHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsValidateRollbackHeaders object itself.
     */
    public AppsValidateRollbackHeaders setRatelimitReset(Integer ratelimitReset) {
