...
public final class DatabasesUpdateEvictionPolicyResponse
        extends ResponseBase<DatabasesUpdateEvictionPolicyHeaders, Error> {
    /**
     ...
     */
    public DatabasesUpdateEvictionPolicyResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Error value,
            DatabasesUpdateEvictionPolicyHeaders headers) {
