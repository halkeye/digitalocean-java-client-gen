...
public final class VolumeSnapshotsGetByIdHeaders {
     ...
     */
    public VolumeSnapshotsGetByIdHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the VolumeSnapshotsGetByIdHeaders object itself.
     */
    public VolumeSnapshotsGetByIdHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the VolumeSnapshotsGetByIdHeaders object itself.
     */
    public VolumeSnapshotsGetByIdHeaders setRatelimitReset(Integer ratelimitReset) {
