...
/** The DatabasesGetEvictionPolicyHeaders model. */
@Fluent
public final class DatabasesGetEvictionPolicyHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetEvictionPolicyHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetEvictionPolicyHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetEvictionPolicyHeaders object itself.
     */
    public DatabasesGetEvictionPolicyHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetEvictionPolicyHeaders object itself.
     */
    public DatabasesGetEvictionPolicyHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetEvictionPolicyHeaders object itself.
     */
    public DatabasesGetEvictionPolicyHeaders setRatelimitReset(Integer ratelimitReset) {
