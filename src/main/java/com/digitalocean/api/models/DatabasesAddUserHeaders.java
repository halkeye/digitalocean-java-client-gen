...
/** The DatabasesAddUserHeaders model. */
@Fluent
public final class DatabasesAddUserHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesAddUserHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesAddUserHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesAddUserHeaders object itself.
     */
    public DatabasesAddUserHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesAddUserHeaders object itself.
     */
    public DatabasesAddUserHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesAddUserHeaders object itself.
     */
    public DatabasesAddUserHeaders setRatelimitReset(Integer ratelimitReset) {
