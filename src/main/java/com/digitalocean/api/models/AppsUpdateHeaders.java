...
/** The AppsUpdateHeaders model. */
@Fluent
public final class AppsUpdateHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsUpdateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsUpdateHeaders object itself.
     */
    public AppsUpdateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsUpdateHeaders object itself.
     */
    public AppsUpdateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsUpdateHeaders object itself.
     */
    public AppsUpdateHeaders setRatelimitReset(Integer ratelimitReset) {
