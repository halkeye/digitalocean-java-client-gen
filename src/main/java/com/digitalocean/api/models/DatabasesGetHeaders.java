...
/** The DatabasesGetHeaders model. */
@Fluent
public final class DatabasesGetHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetHeaders object itself.
     */
    public DatabasesGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetHeaders object itself.
     */
    public DatabasesGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetHeaders object itself.
     */
    public DatabasesGetHeaders setRatelimitReset(Integer ratelimitReset) {
