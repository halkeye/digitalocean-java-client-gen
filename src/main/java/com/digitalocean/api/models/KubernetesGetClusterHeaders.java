...
/** The KubernetesGetClusterHeaders model. */
@Fluent
public final class KubernetesGetClusterHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesGetClusterHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesGetClusterHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesGetClusterHeaders object itself.
     */
    public KubernetesGetClusterHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesGetClusterHeaders object itself.
     */
    public KubernetesGetClusterHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesGetClusterHeaders object itself.
     */
    public KubernetesGetClusterHeaders setRatelimitReset(Integer ratelimitReset) {
