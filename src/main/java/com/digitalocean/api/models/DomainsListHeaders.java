...
/**
 * The DomainsListHeaders model.
 */
@Fluent
public final class DomainsListHeaders {
    /*
    ...
    /**
     * Creates an instance of DomainsListHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DomainsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DomainsListHeaders object itself.
     */
    public DomainsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DomainsListHeaders object itself.
     */
    public DomainsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DomainsListHeaders object itself.
     */
    public DomainsListHeaders setRatelimitReset(Integer ratelimitReset) {
