...
/** The AppsCancelDeploymentHeaders model. */
@Fluent
public final class AppsCancelDeploymentHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsCancelDeploymentHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsCancelDeploymentHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsCancelDeploymentHeaders object itself.
     */
    public AppsCancelDeploymentHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsCancelDeploymentHeaders object itself.
     */
    public AppsCancelDeploymentHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsCancelDeploymentHeaders object itself.
     */
    public AppsCancelDeploymentHeaders setRatelimitReset(Integer ratelimitReset) {
