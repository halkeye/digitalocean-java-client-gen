...
public final class CertificatesGetHeaders {
    ...
    /**
     * Creates an instance of CertificatesGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public CertificatesGetHeaders(HttpHeaders rawHeaders) {
     ...
     */
    public CertificatesGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the CertificatesGetHeaders object itself.
     */
    public CertificatesGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the CertificatesGetHeaders object itself.
     */
    public CertificatesGetHeaders setRatelimitReset(Integer ratelimitReset) {
