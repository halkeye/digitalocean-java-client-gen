...
/**
 * The FirewallsUpdateHeaders model.
 */
@Fluent
public final class FirewallsUpdateHeaders {
    /*
    ...
    /**
     * Creates an instance of FirewallsUpdateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public FirewallsUpdateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the FirewallsUpdateHeaders object itself.
     */
    public FirewallsUpdateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the FirewallsUpdateHeaders object itself.
     */
    public FirewallsUpdateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the FirewallsUpdateHeaders object itself.
     */
    public FirewallsUpdateHeaders setRatelimitReset(Integer ratelimitReset) {
