...
/** The FirewallsCreateHeaders model. */
@Fluent
public final class FirewallsCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of FirewallsCreateHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public FirewallsCreateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the FirewallsCreateHeaders object itself.
     */
    public FirewallsCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the FirewallsCreateHeaders object itself.
     */
    public FirewallsCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the FirewallsCreateHeaders object itself.
     */
    public FirewallsCreateHeaders setRatelimitReset(Integer ratelimitReset) {
