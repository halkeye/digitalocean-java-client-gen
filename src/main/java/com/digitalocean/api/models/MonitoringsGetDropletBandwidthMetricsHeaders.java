...
/**
 * The MonitoringsGetDropletBandwidthMetricsHeaders model.
 */
@Fluent
public final class MonitoringsGetDropletBandwidthMetricsHeaders {
    /*
    ...
    /**
     * Creates an instance of MonitoringsGetDropletBandwidthMetricsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public MonitoringsGetDropletBandwidthMetricsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the MonitoringsGetDropletBandwidthMetricsHeaders object itself.
     */
    public MonitoringsGetDropletBandwidthMetricsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the MonitoringsGetDropletBandwidthMetricsHeaders object itself.
     */
    public MonitoringsGetDropletBandwidthMetricsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the MonitoringsGetDropletBandwidthMetricsHeaders object itself.
     */
    public MonitoringsGetDropletBandwidthMetricsHeaders setRatelimitReset(Integer ratelimitReset) {
