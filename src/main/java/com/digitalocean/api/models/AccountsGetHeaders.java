...
/** The AccountsGetHeaders model. */
@Fluent
public final class AccountsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of AccountsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AccountsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AccountsGetHeaders object itself.
     */
    public AccountsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AccountsGetHeaders object itself.
     */
    public AccountsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AccountsGetHeaders object itself.
     */
    public AccountsGetHeaders setRatelimitReset(Integer ratelimitReset) {
