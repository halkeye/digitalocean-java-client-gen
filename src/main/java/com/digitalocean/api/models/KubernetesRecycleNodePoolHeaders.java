...
/** The KubernetesRecycleNodePoolHeaders model. */
@Fluent
public final class KubernetesRecycleNodePoolHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesRecycleNodePoolHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesRecycleNodePoolHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesRecycleNodePoolHeaders object itself.
     */
    public KubernetesRecycleNodePoolHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesRecycleNodePoolHeaders object itself.
     */
    public KubernetesRecycleNodePoolHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesRecycleNodePoolHeaders object itself.
     */
    public KubernetesRecycleNodePoolHeaders setRatelimitReset(Integer ratelimitReset) {
