...
/** The DatabasesGetSqlModeHeaders model. */
@Fluent
public final class DatabasesGetSqlModeHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetSqlModeHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetSqlModeHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetSqlModeHeaders object itself.
     */
    public DatabasesGetSqlModeHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetSqlModeHeaders object itself.
     */
    public DatabasesGetSqlModeHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetSqlModeHeaders object itself.
     */
    public DatabasesGetSqlModeHeaders setRatelimitReset(Integer ratelimitReset) {
