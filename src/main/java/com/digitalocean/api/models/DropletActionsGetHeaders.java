...
/**
 * The DropletActionsGetHeaders model.
 */
@Fluent
public final class DropletActionsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletActionsGetHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletActionsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletActionsGetHeaders object itself.
     */
    public DropletActionsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletActionsGetHeaders object itself.
     */
    public DropletActionsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletActionsGetHeaders object itself.
     */
    public DropletActionsGetHeaders setRatelimitReset(Integer ratelimitReset) {
