...
/** The KubernetesUpdateNodePoolHeaders model. */
@Fluent
public final class KubernetesUpdateNodePoolHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesUpdateNodePoolHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesUpdateNodePoolHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesUpdateNodePoolHeaders object itself.
     */
    public KubernetesUpdateNodePoolHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesUpdateNodePoolHeaders object itself.
     */
    public KubernetesUpdateNodePoolHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesUpdateNodePoolHeaders object itself.
     */
    public KubernetesUpdateNodePoolHeaders setRatelimitReset(Integer ratelimitReset) {
