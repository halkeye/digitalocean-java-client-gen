 ...
 */
@Fluent
public final class AssignDropletsByID extends ComponentsKhgghzSchemasLoadBalancerCreateOneof0Allof0 {
    /*
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setRegion(RegionSlug region) {
        this.region = region;
        return this;
    }
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setSizeUnit(Integer sizeUnit) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setSize(LoadBalancerBaseSize size) {
        this.size = size;
        return this;
    }
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setAlgorithm(LoadBalancerBaseAlgorithm algorithm) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setForwardingRules(List<ForwardingRule> forwardingRules) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setHealthCheck(HealthCheck healthCheck) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setStickySessions(StickySessions stickySessions) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setRedirectHttpToHttps(Boolean redirectHttpToHttps) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setEnableProxyProtocol(Boolean enableProxyProtocol) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setEnableBackendKeepalive(Boolean enableBackendKeepalive) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setVpcUuid(UUID vpcUuid) {
     ...
     * @return the AssignDropletsByID object itself.
     */
    public AssignDropletsByID setDisableLetsEncryptDnsRecords(Boolean disableLetsEncryptDnsRecords) {
     ...
     */
    @Override
    public AssignDropletsByID setDropletIds(List<Integer> dropletIds) {
