...
public final class DatabasesDeleteOnlineMigrationResponse
        extends ResponseBase<DatabasesDeleteOnlineMigrationHeaders, Error> {
    /**
     ...
     */
    public DatabasesDeleteOnlineMigrationResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Error value,
            DatabasesDeleteOnlineMigrationHeaders headers) {
