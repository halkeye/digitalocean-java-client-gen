...
public final class LoadBalancersRemoveDropletsResponse extends ResponseBase<LoadBalancersRemoveDropletsHeaders, Error> {
     ...
     */
    public LoadBalancersRemoveDropletsResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Error value, LoadBalancersRemoveDropletsHeaders headers) {
