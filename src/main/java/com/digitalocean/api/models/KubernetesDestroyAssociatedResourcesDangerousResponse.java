...
public final class KubernetesDestroyAssociatedResourcesDangerousResponse
        extends ResponseBase<KubernetesDestroyAssociatedResourcesDangerousHeaders, Error> {
    /**
     ...
     */
    public KubernetesDestroyAssociatedResourcesDangerousResponse(
            HttpRequest request,
            int statusCode,
            HttpHeaders rawHeaders,
            Error value,
            KubernetesDestroyAssociatedResourcesDangerousHeaders headers) {
