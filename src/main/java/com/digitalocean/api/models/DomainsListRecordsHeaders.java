...
/** The DomainsListRecordsHeaders model. */
@Fluent
public final class DomainsListRecordsHeaders {
    /*
    ...
    /**
     * Creates an instance of DomainsListRecordsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DomainsListRecordsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DomainsListRecordsHeaders object itself.
     */
    public DomainsListRecordsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DomainsListRecordsHeaders object itself.
     */
    public DomainsListRecordsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DomainsListRecordsHeaders object itself.
     */
    public DomainsListRecordsHeaders setRatelimitReset(Integer ratelimitReset) {
