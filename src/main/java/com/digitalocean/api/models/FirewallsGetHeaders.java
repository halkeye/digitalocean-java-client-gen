...
/** The FirewallsGetHeaders model. */
@Fluent
public final class FirewallsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of FirewallsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public FirewallsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the FirewallsGetHeaders object itself.
     */
    public FirewallsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the FirewallsGetHeaders object itself.
     */
    public FirewallsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the FirewallsGetHeaders object itself.
     */
    public FirewallsGetHeaders setRatelimitReset(Integer ratelimitReset) {
