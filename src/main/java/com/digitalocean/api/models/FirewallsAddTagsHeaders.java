...
/** The FirewallsAddTagsHeaders model. */
@Fluent
public final class FirewallsAddTagsHeaders {
    /*
    ...
    /**
     * Creates an instance of FirewallsAddTagsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public FirewallsAddTagsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the FirewallsAddTagsHeaders object itself.
     */
    public FirewallsAddTagsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the FirewallsAddTagsHeaders object itself.
     */
    public FirewallsAddTagsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the FirewallsAddTagsHeaders object itself.
     */
    public FirewallsAddTagsHeaders setRatelimitReset(Integer ratelimitReset) {
