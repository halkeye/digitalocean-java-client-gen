...
/** The RegistriesListRepositoryManifestsHeaders model. */
@Fluent
public final class RegistriesListRepositoryManifestsHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesListRepositoryManifestsHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesListRepositoryManifestsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesListRepositoryManifestsHeaders object itself.
     */
    public RegistriesListRepositoryManifestsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesListRepositoryManifestsHeaders object itself.
     */
    public RegistriesListRepositoryManifestsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesListRepositoryManifestsHeaders object itself.
     */
    public RegistriesListRepositoryManifestsHeaders setRatelimitReset(Integer ratelimitReset) {
