...
/**
 * The AppsListHeaders model.
 */
@Fluent
public final class AppsListHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsListHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsListHeaders object itself.
     */
    public AppsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsListHeaders object itself.
     */
    public AppsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsListHeaders object itself.
     */
    public AppsListHeaders setRatelimitReset(Integer ratelimitReset) {
