...
/** The DatabasesListReplicasHeaders model. */
@Fluent
public final class DatabasesListReplicasHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesListReplicasHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesListReplicasHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesListReplicasHeaders object itself.
     */
    public DatabasesListReplicasHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesListReplicasHeaders object itself.
     */
    public DatabasesListReplicasHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesListReplicasHeaders object itself.
     */
    public DatabasesListReplicasHeaders setRatelimitReset(Integer ratelimitReset) {
