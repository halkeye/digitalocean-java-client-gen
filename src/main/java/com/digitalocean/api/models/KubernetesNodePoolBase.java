...
/**
 * The KubernetesNodePoolBase model.
 */
@Fluent
public class KubernetesNodePoolBase {
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setCount(Integer count) {
        this.count = count;
        return this;
    }
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setTags(List<String> tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setLabels(Object labels) {
        this.labels = labels;
        return this;
    }
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setTaints(List<KubernetesNodePoolTaint> taints) {
        this.taints = taints;
        return this;
    }
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setAutoScale(Boolean autoScale) {
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setMinNodes(Integer minNodes) {
     ...
     * @return the KubernetesNodePoolBase object itself.
     */
    public KubernetesNodePoolBase setMaxNodes(Integer maxNodes) {
