...
/** The ProjectsListHeaders model. */
@Fluent
public final class ProjectsListHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsListHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsListHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ProjectsListHeaders object itself.
     */
    public ProjectsListHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsListHeaders object itself.
     */
    public ProjectsListHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsListHeaders object itself.
     */
    public ProjectsListHeaders setRatelimitReset(Integer ratelimitReset) {
