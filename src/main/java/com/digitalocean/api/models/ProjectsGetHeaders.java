...
/** The ProjectsGetHeaders model. */
@Fluent
public final class ProjectsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ProjectsGetHeaders object itself.
     */
    public ProjectsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsGetHeaders object itself.
     */
    public ProjectsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsGetHeaders object itself.
     */
    public ProjectsGetHeaders setRatelimitReset(Integer ratelimitReset) {
