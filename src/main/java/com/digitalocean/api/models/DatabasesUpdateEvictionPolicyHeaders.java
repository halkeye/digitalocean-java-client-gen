...
/**
 * The DatabasesUpdateEvictionPolicyHeaders model.
 */
@Fluent
public final class DatabasesUpdateEvictionPolicyHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesUpdateEvictionPolicyHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesUpdateEvictionPolicyHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesUpdateEvictionPolicyHeaders object itself.
     */
    public DatabasesUpdateEvictionPolicyHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesUpdateEvictionPolicyHeaders object itself.
     */
    public DatabasesUpdateEvictionPolicyHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesUpdateEvictionPolicyHeaders object itself.
     */
    public DatabasesUpdateEvictionPolicyHeaders setRatelimitReset(Integer ratelimitReset) {
