...
/**
 * The MonitoringsGetDropletLoad5MetricsHeaders model.
 */
@Fluent
public final class MonitoringsGetDropletLoad5MetricsHeaders {
    /*
    ...
    /**
     * Creates an instance of MonitoringsGetDropletLoad5MetricsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public MonitoringsGetDropletLoad5MetricsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the MonitoringsGetDropletLoad5MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad5MetricsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the MonitoringsGetDropletLoad5MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad5MetricsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the MonitoringsGetDropletLoad5MetricsHeaders object itself.
     */
    public MonitoringsGetDropletLoad5MetricsHeaders setRatelimitReset(Integer ratelimitReset) {
