...
public class LoadBalancerBase {
     ...
     */
    public LoadBalancerBase setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setSizeUnit(Integer sizeUnit) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setSize(LoadBalancerBaseSize size) {
        this.size = size;
        return this;
    }
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setAlgorithm(LoadBalancerBaseAlgorithm algorithm) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setForwardingRules(List<ForwardingRule> forwardingRules) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setHealthCheck(HealthCheck healthCheck) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setStickySessions(StickySessions stickySessions) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setRedirectHttpToHttps(Boolean redirectHttpToHttps) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setEnableProxyProtocol(Boolean enableProxyProtocol) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setEnableBackendKeepalive(Boolean enableBackendKeepalive) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setVpcUuid(UUID vpcUuid) {
     ...
     * @return the LoadBalancerBase object itself.
     */
    public LoadBalancerBase setDisableLetsEncryptDnsRecords(Boolean disableLetsEncryptDnsRecords) {
