...
/**
 * The DatabasesGetMigrationStatusHeaders model.
 */
@Fluent
public final class DatabasesGetMigrationStatusHeaders {
    /*
    ...
    /**
     * Creates an instance of DatabasesGetMigrationStatusHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DatabasesGetMigrationStatusHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DatabasesGetMigrationStatusHeaders object itself.
     */
    public DatabasesGetMigrationStatusHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DatabasesGetMigrationStatusHeaders object itself.
     */
    public DatabasesGetMigrationStatusHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DatabasesGetMigrationStatusHeaders object itself.
     */
    public DatabasesGetMigrationStatusHeaders setRatelimitReset(Integer ratelimitReset) {
