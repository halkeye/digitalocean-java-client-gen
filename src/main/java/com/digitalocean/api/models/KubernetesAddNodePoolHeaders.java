...
/** The KubernetesAddNodePoolHeaders model. */
@Fluent
public final class KubernetesAddNodePoolHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesAddNodePoolHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesAddNodePoolHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesAddNodePoolHeaders object itself.
     */
    public KubernetesAddNodePoolHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesAddNodePoolHeaders object itself.
     */
    public KubernetesAddNodePoolHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesAddNodePoolHeaders object itself.
     */
    public KubernetesAddNodePoolHeaders setRatelimitReset(Integer ratelimitReset) {
