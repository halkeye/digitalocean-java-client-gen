...
/**
 * The ActionsGetHeaders model.
 */
@Fluent
public final class ActionsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of ActionsGetHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ActionsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ActionsGetHeaders object itself.
     */
    public ActionsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ActionsGetHeaders object itself.
     */
    public ActionsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ActionsGetHeaders object itself.
     */
    public ActionsGetHeaders setRatelimitReset(Integer ratelimitReset) {
