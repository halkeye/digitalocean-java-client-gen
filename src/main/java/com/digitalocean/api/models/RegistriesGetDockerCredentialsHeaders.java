...
/**
 * The RegistriesGetDockerCredentialsHeaders model.
 */
@Fluent
public final class RegistriesGetDockerCredentialsHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesGetDockerCredentialsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesGetDockerCredentialsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesGetDockerCredentialsHeaders object itself.
     */
    public RegistriesGetDockerCredentialsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesGetDockerCredentialsHeaders object itself.
     */
    public RegistriesGetDockerCredentialsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesGetDockerCredentialsHeaders object itself.
     */
    public RegistriesGetDockerCredentialsHeaders setRatelimitReset(Integer ratelimitReset) {
