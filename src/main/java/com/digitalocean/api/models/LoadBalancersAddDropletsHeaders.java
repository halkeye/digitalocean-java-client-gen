...
/**
 * The LoadBalancersAddDropletsHeaders model.
 */
@Fluent
public final class LoadBalancersAddDropletsHeaders {
    /*
    ...
    /**
     * Creates an instance of LoadBalancersAddDropletsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public LoadBalancersAddDropletsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the LoadBalancersAddDropletsHeaders object itself.
     */
    public LoadBalancersAddDropletsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the LoadBalancersAddDropletsHeaders object itself.
     */
    public LoadBalancersAddDropletsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the LoadBalancersAddDropletsHeaders object itself.
     */
    public LoadBalancersAddDropletsHeaders setRatelimitReset(Integer ratelimitReset) {
