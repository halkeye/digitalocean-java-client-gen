...
/**
 * The RegistriesListRepositoriesHeaders model.
 */
@Fluent
public final class RegistriesListRepositoriesHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesListRepositoriesHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesListRepositoriesHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesListRepositoriesHeaders object itself.
     */
    public RegistriesListRepositoriesHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesListRepositoriesHeaders object itself.
     */
    public RegistriesListRepositoriesHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesListRepositoriesHeaders object itself.
     */
    public RegistriesListRepositoriesHeaders setRatelimitReset(Integer ratelimitReset) {
