...
/** The DropletsDestroyByTagHeaders model. */
@Fluent
public final class DropletsDestroyByTagHeaders {
    /*
    ...
    /**
     * Creates an instance of DropletsDestroyByTagHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DropletsDestroyByTagHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DropletsDestroyByTagHeaders object itself.
     */
    public DropletsDestroyByTagHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DropletsDestroyByTagHeaders object itself.
     */
    public DropletsDestroyByTagHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DropletsDestroyByTagHeaders object itself.
     */
    public DropletsDestroyByTagHeaders setContentType(String contentType) {
     ...
     * @return the DropletsDestroyByTagHeaders object itself.
     */
    public DropletsDestroyByTagHeaders setRatelimitReset(Integer ratelimitReset) {
