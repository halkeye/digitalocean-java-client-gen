...
/** The VpcsPatchHeaders model. */
@Fluent
public final class VpcsPatchHeaders {
    /*
    ...
    /**
     * Creates an instance of VpcsPatchHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public VpcsPatchHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the VpcsPatchHeaders object itself.
     */
    public VpcsPatchHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the VpcsPatchHeaders object itself.
     */
    public VpcsPatchHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the VpcsPatchHeaders object itself.
     */
    public VpcsPatchHeaders setRatelimitReset(Integer ratelimitReset) {
