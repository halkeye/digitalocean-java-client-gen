...
public final class FloatingIp {
    ...
    /**
     * Get the droplet property: The Droplet that the floating IP has been assigned to. When you query a floating IP, if
    ...
    /**
     * Set the droplet property: The Droplet that the floating IP has been assigned to. When you query a floating IP, if
     * it is assigned to a Droplet, the entire Droplet object will be returned. If it is not assigned, the value will be
     * null.
     *
    ...
    /**
     * Get the locked property: A boolean value indicating whether or not the floating IP has pending actions preventing
    ...
    /**
     * Set the locked property: A boolean value indicating whether or not the floating IP has pending actions preventing
     * new ones from being submitted.
     *
