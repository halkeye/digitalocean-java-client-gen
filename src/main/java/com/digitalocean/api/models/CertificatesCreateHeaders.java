...
public final class CertificatesCreateHeaders {
     ...
     */
    public CertificatesCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the CertificatesCreateHeaders object itself.
     */
    public CertificatesCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the CertificatesCreateHeaders object itself.
     */
    public CertificatesCreateHeaders setRatelimitReset(Integer ratelimitReset) {
