...
/** The ProjectsPatchHeaders model. */
@Fluent
public final class ProjectsPatchHeaders {
    /*
    ...
    /**
     * Creates an instance of ProjectsPatchHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public ProjectsPatchHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the ProjectsPatchHeaders object itself.
     */
    public ProjectsPatchHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the ProjectsPatchHeaders object itself.
     */
    public ProjectsPatchHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the ProjectsPatchHeaders object itself.
     */
    public ProjectsPatchHeaders setRatelimitReset(Integer ratelimitReset) {
