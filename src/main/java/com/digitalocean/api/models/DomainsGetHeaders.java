...
/** The DomainsGetHeaders model. */
@Fluent
public final class DomainsGetHeaders {
    /*
    ...
    /**
     * Creates an instance of DomainsGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public DomainsGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the DomainsGetHeaders object itself.
     */
    public DomainsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the DomainsGetHeaders object itself.
     */
    public DomainsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the DomainsGetHeaders object itself.
     */
    public DomainsGetHeaders setRatelimitReset(Integer ratelimitReset) {
