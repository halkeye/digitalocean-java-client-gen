...
/** The AppsValidateAppSpecHeaders model. */
@Fluent
public final class AppsValidateAppSpecHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsValidateAppSpecHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsValidateAppSpecHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsValidateAppSpecHeaders object itself.
     */
    public AppsValidateAppSpecHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsValidateAppSpecHeaders object itself.
     */
    public AppsValidateAppSpecHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsValidateAppSpecHeaders object itself.
     */
    public AppsValidateAppSpecHeaders setRatelimitReset(Integer ratelimitReset) {
