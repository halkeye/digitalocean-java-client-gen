...
/** The RegistriesGetHeaders model. */
@Fluent
public final class RegistriesGetHeaders {
    /*
    ...
    /**
     * Creates an instance of RegistriesGetHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public RegistriesGetHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the RegistriesGetHeaders object itself.
     */
    public RegistriesGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the RegistriesGetHeaders object itself.
     */
    public RegistriesGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the RegistriesGetHeaders object itself.
     */
    public RegistriesGetHeaders setRatelimitReset(Integer ratelimitReset) {
