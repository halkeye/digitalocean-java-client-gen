...
/** The VolumeActionsPostByIdHeaders model. */
@Fluent
public final class VolumeActionsPostByIdHeaders {
    /*
    ...
    /**
     * Creates an instance of VolumeActionsPostByIdHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public VolumeActionsPostByIdHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the VolumeActionsPostByIdHeaders object itself.
     */
    public VolumeActionsPostByIdHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the VolumeActionsPostByIdHeaders object itself.
     */
    public VolumeActionsPostByIdHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the VolumeActionsPostByIdHeaders object itself.
     */
    public VolumeActionsPostByIdHeaders setRatelimitReset(Integer ratelimitReset) {
