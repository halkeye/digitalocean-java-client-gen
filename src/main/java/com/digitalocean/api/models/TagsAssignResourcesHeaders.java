...
/**
 * The TagsAssignResourcesHeaders model.
 */
@Fluent
public final class TagsAssignResourcesHeaders {
    /*
    ...
    /**
     * Creates an instance of TagsAssignResourcesHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public TagsAssignResourcesHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the TagsAssignResourcesHeaders object itself.
     */
    public TagsAssignResourcesHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the TagsAssignResourcesHeaders object itself.
     */
    public TagsAssignResourcesHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the TagsAssignResourcesHeaders object itself.
     */
    public TagsAssignResourcesHeaders setRatelimitReset(Integer ratelimitReset) {
