...
public final class TagsGetHeaders {
     ...
     */
    public TagsGetHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the TagsGetHeaders object itself.
     */
    public TagsGetHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the TagsGetHeaders object itself.
     */
    public TagsGetHeaders setRatelimitReset(Integer ratelimitReset) {
