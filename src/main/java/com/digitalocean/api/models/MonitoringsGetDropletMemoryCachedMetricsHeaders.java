...
/**
 * The MonitoringsGetDropletMemoryCachedMetricsHeaders model.
 */
@Fluent
public final class MonitoringsGetDropletMemoryCachedMetricsHeaders {
    /*
    ...
    /**
     * Creates an instance of MonitoringsGetDropletMemoryCachedMetricsHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public MonitoringsGetDropletMemoryCachedMetricsHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the MonitoringsGetDropletMemoryCachedMetricsHeaders object itself.
     */
    public MonitoringsGetDropletMemoryCachedMetricsHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the MonitoringsGetDropletMemoryCachedMetricsHeaders object itself.
     */
    public MonitoringsGetDropletMemoryCachedMetricsHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the MonitoringsGetDropletMemoryCachedMetricsHeaders object itself.
     */
    public MonitoringsGetDropletMemoryCachedMetricsHeaders setRatelimitReset(Integer ratelimitReset) {
