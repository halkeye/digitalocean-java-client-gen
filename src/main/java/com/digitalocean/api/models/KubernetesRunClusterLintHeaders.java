...
/** The KubernetesRunClusterLintHeaders model. */
@Fluent
public final class KubernetesRunClusterLintHeaders {
    /*
    ...
    /**
     * Creates an instance of KubernetesRunClusterLintHeaders class.
     *
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public KubernetesRunClusterLintHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the KubernetesRunClusterLintHeaders object itself.
     */
    public KubernetesRunClusterLintHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the KubernetesRunClusterLintHeaders object itself.
     */
    public KubernetesRunClusterLintHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the KubernetesRunClusterLintHeaders object itself.
     */
    public KubernetesRunClusterLintHeaders setRatelimitReset(Integer ratelimitReset) {
