...
/**
 * The AppsCreateHeaders model.
 */
@Fluent
public final class AppsCreateHeaders {
    /*
    ...
    /**
     * Creates an instance of AppsCreateHeaders class.
     * 
     * @param rawHeaders The raw HttpHeaders that will be used to create the property values.
     */
    public AppsCreateHeaders(HttpHeaders rawHeaders) {
     ...
     * @return the AppsCreateHeaders object itself.
     */
    public AppsCreateHeaders setRatelimitLimit(Integer ratelimitLimit) {
     ...
     * @return the AppsCreateHeaders object itself.
     */
    public AppsCreateHeaders setRatelimitRemaining(Integer ratelimitRemaining) {
     ...
     * @return the AppsCreateHeaders object itself.
     */
    public AppsCreateHeaders setRatelimitReset(Integer ratelimitReset) {
