...
public final class DatabaseBackupTests {
    ...
    public void testDeserialize() {
        DatabaseBackup model =
                BinaryData.fromString("{\"database_name\":\"v\",\"backup_created_at\":\"2021-06-08T16:49:51Z\"}")
                        .toObject(DatabaseBackup.class);
    ...
    public void testSerialize() {
        DatabaseBackup model =
                new DatabaseBackup()
                        .setDatabaseName("v")
                        .setBackupCreatedAt(OffsetDateTime.parse("2021-06-08T16:49:51Z"));
