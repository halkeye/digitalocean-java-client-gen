...
public final class RepositoryTagTests {
    ...
    public void testDeserialize() {
        RepositoryTag model = BinaryData.fromString("{\"registry_name\":\"uaj\",\"repository\":\"nacgdnx\",\"tag\":\"onmzrjjaojpzn\",\"manifest_digest\":\"rz\",\"compressed_size_bytes\":1361930532,\"size_bytes\":2099090141,\"updated_at\":\"2021-07-19T10:14:40Z\"}").toObject(RepositoryTag.class);
    ...
    public void testSerialize() {
        RepositoryTag model = new RepositoryTag().setRegistryName("uaj").setRepository("nacgdnx").setTag("onmzrjjaojpzn").setManifestDigest("rz").setCompressedSizeBytes(1361930532).setSizeBytes(2099090141).setUpdatedAt(OffsetDateTime.parse("2021-07-19T10:14:40Z"));
