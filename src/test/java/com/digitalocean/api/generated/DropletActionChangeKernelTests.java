...
public final class DropletActionChangeKernelTests {
    ...
    public void testDeserialize() {
        DropletActionChangeKernel model = BinaryData.fromString("{\"kernel\":1884703702,\"type\":\"snapshot\"}").toObject(DropletActionChangeKernel.class);
    ...
    public void testSerialize() {
        DropletActionChangeKernel model = new DropletActionChangeKernel().setType(DropletActionType.SNAPSHOT).setKernel(1884703702);
