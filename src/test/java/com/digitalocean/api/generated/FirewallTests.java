    ...
    public void testDeserialize() {
        Firewall model =
                BinaryData.fromString(
                                "{\"id\":\"mtsdixchwk\",\"status\":\"failed\",\"created_at\":\"2021-08-08T03:56:34Z\",\"pending_changes\":[{\"droplet_id\":653289494,\"removing\":false,\"status\":\"gair\"}],\"name\":\"qzoof\",\"droplet_ids\":[1617198604,1634501666],\"inbound_rules\":[{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"berpyljeknf\"},{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"udp\",\"ports\":\"owkdnjr\"},{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"icmp\",\"ports\":\"ehycpn\"}],\"outbound_rules\":[{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"udp\",\"ports\":\"r\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"udp\",\"ports\":\"afbjzmpy\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"bko\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"rmxkbcjwwdxom\"}]}")
                        .toObject(Firewall.class);
                                        ...
                                        new FirewallRulesOutboundRulesItem()
                                                ...
                                                .setDestinations(
                                                        new FirewallRulesOutboundRulesAllOfProperties()
                                                                ...
                                                                .setKubernetesIds(Arrays.asList()))))
                        .setName("qzoof")
                        .setDropletIds(Arrays.asList(1617198604, 1634501666));
