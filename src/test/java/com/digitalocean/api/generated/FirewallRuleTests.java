...
public final class FirewallRuleTests {
    ...
    public void testDeserialize() {
        FirewallRule model = BinaryData.fromString("{\"uuid\":\"igvjrktp\",\"cluster_uuid\":\"eukyaw\",\"type\":\"ip_addr\",\"value\":\"pmwhqnuc\",\"created_at\":\"2021-05-02T03:10:04Z\"}").toObject(FirewallRule.class);
    ...
    public void testSerialize() {
        FirewallRule model = new FirewallRule().setUuid("igvjrktp").setClusterUuid("eukyaw").setType(FirewallRuleType.IP_ADDR).setValue("pmwhqnuc");
