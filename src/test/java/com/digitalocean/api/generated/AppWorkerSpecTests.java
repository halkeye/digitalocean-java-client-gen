...
public final class AppWorkerSpecTests {
    ...
    public void testDeserialize() {
        AppWorkerSpec model =
                BinaryData.fromString(
                                "{\"instance_count\":7993985710285219031,\"instance_size_slug\":\"professional-s\",\"name\":\"f\",\"git\":{\"branch\":\"vvmu\",\"repo_clone_url\":\"pmuneqsx\"},\"github\":{\"branch\":\"fbuzjyihs\",\"deploy_on_push\":false,\"repo\":\"udypohyuems\"},\"gitlab\":{\"branch\":\"sqy\",\"deploy_on_push\":true,\"repo\":\"obrltt\"},\"image\":{\"registry\":\"jnygq\",\"registry_type\":\"DOCKER_HUB\",\"repository\":\"qzdz\",\"tag\":\"ilaxhn\"},\"dockerfile_path\":\"qlyvijo\",\"build_command\":\"iv\",\"run_command\":\"oyzunbixxr\",\"source_dir\":\"kvcpwpgclr\",\"envs\":[{\"key\":\"tso\",\"scope\":\"RUN_TIME\",\"type\":\"SECRET\",\"value\":\"xpmyyefrpmpdnq\"},{\"key\":\"skawaoqvmmb\",\"scope\":\"UNSET\",\"type\":\"GENERAL\",\"value\":\"qlkzme\"}],\"environment_slug\":\"itgvkx\",\"log_destinations\":{\"name\":\"yqdrf\",\"papertrail\":{\"endpoint\":\"cealzxwh\"},\"datadog\":{\"endpoint\":\"symoyq\",\"api_key\":\"lwigdivbkbx\"},\"logtail\":{\"token\":\"fajuwas\"}}}")
                        .toObject(AppWorkerSpec.class);
    ...
    public void testSerialize() {
        AppWorkerSpec model =
                new AppWorkerSpec()
                        .setName("f")
                        .setGit(new AppsGitSourceSpec().setBranch("vvmu").setRepoCloneUrl("pmuneqsx"))
                        .setGithub(
                                new AppsGithubSourceSpec()
                                        .setBranch("fbuzjyihs")
                                        .setDeployOnPush(false)
                                        .setRepo("udypohyuems"))
                        .setGitlab(new AppsGitlabSourceSpec().setBranch("sqy").setDeployOnPush(true).setRepo("obrltt"))
                        .setImage(
                                new AppsImageSourceSpec()
                                        ...
                                        .setRepository("qzdz")
                                        .setTag("ilaxhn"))
                        .setDockerfilePath("qlyvijo")
                        .setBuildCommand("iv")
                        .setRunCommand("oyzunbixxr")
                        .setSourceDir("kvcpwpgclr")
                        .setEnvs(
                                Arrays.asList(
                                        new AppVariableDefinition()
                                                ...
                                                .setValue("xpmyyefrpmpdnq"),
                                        new AppVariableDefinition()
                                                .setKey("skawaoqvmmb")
                                                .setScope(AppVariableDefinitionScope.UNSET)
                                                .setType(AppVariableDefinitionType.GENERAL)
                                                .setValue("qlkzme")))
                        .setEnvironmentSlug("itgvkx")
                        .setLogDestinations(
                                new AppLogDestinationDefinition()
                                        .setName("yqdrf")
                                        .setPapertrail(new AppLogDestinationPapertrailSpec().setEndpoint("cealzxwh"))
                                        .setDatadog(
                                                new AppLogDestinationDatadogSpec()
                                                        .setEndpoint("symoyq")
                                                        .setApiKey("lwigdivbkbx"))
                                        .setLogtail(new AppLogDestinationLogtailSpec().setToken("fajuwas")))
                        .setInstanceCount(7993985710285219031L)
                        .setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.PROFESSIONALS);
