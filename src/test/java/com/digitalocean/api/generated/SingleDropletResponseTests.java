...
public final class SingleDropletResponseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-28T10:26:23Z"), model.getDroplet().getNextBackupWindow().getStart());
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-27T14:16:13Z"), model.getDroplet().getNextBackupWindow().getEnd());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-08-28T03:52:25Z"), model.getDroplet().getImage().getCreatedAt());
    ...
    public void testSerialize() {
        SingleDropletResponse model = new SingleDropletResponse().setDroplet(new Droplet().setId(1070259185).setName("nfczmnniixyxvq").setMemory(1330888938).setVcpus(1663163400).setDisk(514495514).setLocked(true).setStatus(DropletStatus.ACTIVE).setKernel(new Kernel().setId(967639569).setName("nbg").setVersion("m")).setCreatedAt(OffsetDateTime.parse("2021-08-11T21:04:11Z")).setFeatures(Arrays.asList("rgmyn", "twmp", "tmfoeajogsyxwet", "mfd")).setBackupIds(Arrays.asList(1835029542, 1515138527, 1936720238, 2084793017)).setNextBackupWindow(new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-09-28T10:26:23Z")).setEnd(OffsetDateTime.parse("2021-09-27T14:16:13Z"))).setSnapshotIds(Arrays.asList(680048255, 1695406450, 442608357)).setImage(new Image().setName("id").setType(ImageType.SNAPSHOT).setDistribution(Distribution.GENTOO).setSlug("hmjedbiuc").setPublicProperty(true).setRegions(Arrays.asList(RegionSlug.SFO2, RegionSlug.SFO2, RegionSlug.AMS2, RegionSlug.SFO3)).setCreatedAt(OffsetDateTime.parse("2021-08-28T03:52:25Z")).setMinDiskSize(1535648696).setSizeGigabytes(62.11141F).setDescription("qrrihufoihp").setTags(Arrays.asList("bxv", "nzuz")).setStatus(ImageStatus.NEW).setErrorMessage("zc")).setVolumeIds(Arrays.asList("piuzvk", "nhdimjuktirz")).setSize(new Size().setSlug("a").setMemory(22940441).setVcpus(1780435084).setDisk(136347046).setTransfer(48.820377f).setPriceMonthly(17.556555f).setPriceHourly(17.862976f).setRegions(Arrays.asList("fq")).setAvailable(false).setDescription("wgofmhx")).setSizeSlug("rjlvzklkvbgi").setNetworks(new DropletNetworks().setV4(Arrays.asList()).setV6(Arrays.asList())).setRegion(new Region().setName("akvlbishj").setSlug("pzaptuosk").setAvailable(true)).setTags(Arrays.asList("zjixwfgcdiyk", "c", "wnujvqynvav")).setVpcUuid("mdmuqoh")).setLinks(new DropletCreateApplicationJsonOneOfProperties().setActions(Arrays.asList(new ActionLink().setId(217041482).setRel("quddrwjclj").setHref("hlhpvzadb"), new ActionLink().setId(821839104).setRel("inafhxrzfrm").setHref("tiucwv"), new ActionLink().setId(1824245133).setRel("ukhk").setHref("qxgcbvzarmqcbpo"), new ActionLink().setId(892282285).setRel("invagovjyhd").setHref("brdvce"))));
