...
public final class BillingAddressTests {
    ...
    public void testDeserialize() {
        BillingAddress model =
                BinaryData.fromString(
                                "{\"address_line1\":\"sqdtiwlwxlbon\",\"address_line2\":\"bazqicqchygtvxby\",\"city\":\"nepubdpkxyqvgx\",\"region\":\"od\",\"postal_code\":\"vohkxdxuws\",\"country_iso2_code\":\"fmcwnosb\",\"created_at\":\"ehgcvkbcknjo\",\"updated_at\":\"jy\"}")
                        .toObject(BillingAddress.class);
    ...
    public void testSerialize() {
        BillingAddress model =
                new BillingAddress()
                        .setAddressLine1("sqdtiwlwxlbon")
                        .setAddressLine2("bazqicqchygtvxby")
                        .setCity("nepubdpkxyqvgx")
                        .setRegion("od")
                        .setPostalCode("vohkxdxuws")
                        .setCountryIso2Code("fmcwnosb")
                        .setCreatedAt("ehgcvkbcknjo")
                        .setUpdatedAt("jy");
