...
public final class AppComponentBaseTests {
    ...
    public void testSerialize() {
        AppComponentBase model =
                new AppComponentBase()
                        .setName("kzbrmsgeivsiy")
                        .setGit(new AppsGitSourceSpec().setBranch("dncj").setRepoCloneUrl("onbzoggculapzwy"))
                        .setGithub(
                                new AppsGithubSourceSpec()
                                        .setBranch("ogtqxepnylbf")
                                        .setDeployOnPush(true)
                                        .setRepo("yjt"))
                        .setGitlab(new AppsGitlabSourceSpec().setBranch("fqzhv").setDeployOnPush(false).setRepo("yfm"))
                        .setImage(
                                new AppsImageSourceSpec()
                                        .setRegistry("xrkjpvdw")
                                        .setRegistryType(AppsImageSourceSpecRegistryType.DOCR)
                                        .setRepository("iivwzjbhyzsxjrka")
                                        .setTag("trnegvmnvuqeqvld"))
                        .setDockerfilePath("astjbkkdmflvestm")
                        .setBuildCommand("xrrilozapee")
                        .setRunCommand("hpxlktwkuziycs")
                        .setSourceDir("vu")
                        .setEnvs(
                                Arrays.asList(
                                        new AppVariableDefinition()
                                                .setKey("tcktyhjtqedcgzu")
                                        ...
                                        new AppVariableDefinition()
                                                ...
                                                .setType(AppVariableDefinitionType.GENERAL)
                                                .setValue("dzgkr")))
                        .setEnvironmentSlug("eevt")
                        .setLogDestinations(
                                new AppLogDestinationDefinition()
                                        .setName("pryu")
                                        .setPapertrail(new AppLogDestinationPapertrailSpec().setEndpoint("wytpzdmovz"))
                                        .setDatadog(
                                                new AppLogDestinationDatadogSpec()
                                                        .setEndpoint("aawzqadfl")
                                                        .setApiKey("z"))
                                        .setLogtail(new AppLogDestinationLogtailSpec().setToken("glae")));
