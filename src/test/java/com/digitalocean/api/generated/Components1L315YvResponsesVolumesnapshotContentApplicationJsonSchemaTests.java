...
public final class Components1L315YvResponsesVolumesnapshotContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1L315YvResponsesVolumesnapshotContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"snapshot\":{\"resource_id\":\"jgeecwtfmabvbmn\",\"resource_type\":\"volume\",\"tags\":[\"ofxfmhlvyqnslbq\",\"mlqkiekhj\",\"qqrugwespscvs\"],\"name\":\"spt\",\"created_at\":\"2021-04-03T01:19:25Z\",\"regions\":[\"ozfvza\",\"upcvq\"],\"min_disk_size\":50031632,\"size_gigabytes\":31.270206}}")
                        .toObject(Components1L315YvResponsesVolumesnapshotContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1L315YvResponsesVolumesnapshotContentApplicationJsonSchema model =
                new Components1L315YvResponsesVolumesnapshotContentApplicationJsonSchema()
                        .setSnapshot(
                                new Snapshots()
                                        .setName("spt")
                                        .setCreatedAt(OffsetDateTime.parse("2021-04-03T01:19:25Z"))
                                        .setRegions(Arrays.asList("ozfvza", "upcvq"))
                                        .setMinDiskSize(50031632)
                                        .setSizeGigabytes(31.270206f)
                                        .setResourceId("jgeecwtfmabvbmn")
                                        .setResourceType(SnapshotsResourceType.VOLUME)
                                        .setTags(Arrays.asList("ofxfmhlvyqnslbq", "mlqkiekhj", "qqrugwespscvs")));
        model =
