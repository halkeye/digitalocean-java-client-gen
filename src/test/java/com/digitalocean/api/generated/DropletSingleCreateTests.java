...
public final class DropletSingleCreateTests {
    ...
    public void testDeserialize() {
        DropletSingleCreate model =
                BinaryData.fromString(
                                "{\"name\":\"gpterdiu\",\"region\":\"kirkskw\",\"size\":\"tsdetjygowifcq\",\"ssh_keys\":[],\"backups\":false,\"ipv6\":false,\"monitoring\":true,\"tags\":[\"yybzoxlvoc\",\"tvdxxhe\"],\"user_data\":\"mlil\",\"private_networking\":true,\"vpc_uuid\":\"jhjvmabzzbw\",\"with_droplet_agent\":false}")
                        .toObject(DropletSingleCreate.class);
    ...
    public void testSerialize() {
        DropletSingleCreate model =
                new DropletSingleCreate()
                        .setRegion("kirkskw")
                        .setSize("tsdetjygowifcq")
                        .setSshKeys(Arrays.asList())
                        .setBackups(false)
                        .setIpv6(false)
                        .setMonitoring(true)
                        .setTags(Arrays.asList("yybzoxlvoc", "tvdxxhe"))
                        .setUserData("mlil")
                        .setPrivateNetworking(true)
                        .setVpcUuid("jhjvmabzzbw")
