...
public final class Paths1F4Kj8QV2FirewallsFirewallIdPutRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Paths1F4Kj8QV2FirewallsFirewallIdPutRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"id\":\"tgs\",\"status\":\"failed\",\"created_at\":\"2021-11-14T18:27:58Z\",\"pending_changes\":[{\"droplet_id\":658482742,\"removing\":false,\"status\":\"glxkoikmtrawrqk\"}],\"name\":\"wb\",\"droplet_ids\":[1314097120],\"inbound_rules\":[{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"prnejzltkaszf\"},{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"udp\",\"ports\":\"uxapgrcqebmvrdjo\"},{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"vdlsflxkqesdfeds\"},{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"inm\"}],\"outbound_rules\":[{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"ltvdhqnufbx\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"icmp\",\"ports\":\"ojovfnybydh\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"udhuaorhjk\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"sqircamqprlobrug\"}]}")
                        .toObject(Paths1F4Kj8QV2FirewallsFirewallIdPutRequestbodyContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Paths1F4Kj8QV2FirewallsFirewallIdPutRequestbodyContentApplicationJsonSchema model =
                new Paths1F4Kj8QV2FirewallsFirewallIdPutRequestbodyContentApplicationJsonSchema()
                        .setInboundRules(
                                Arrays.asList(
                                        new FirewallRulesInboundRulesItem()
                                                .setProtocol(FirewallRuleBaseProtocol.TCP)
                                                .setPorts("prnejzltkaszf")
                                                .setSources(
                                        ...
                                        new FirewallRulesOutboundRulesItem()
                                                ...
                                                .setDestinations(
                                                        new FirewallRulesOutboundRulesAllOfProperties()
                                                                ...
                                                                .setKubernetesIds(Arrays.asList()))))
                        .setName("wb")
                        .setDropletIds(Arrays.asList(1314097120));
        model =
