...
public final class ConnectionPoolTests {
    ...
    public void testDeserialize() {
        ConnectionPool model =
                BinaryData.fromString(
                                "{\"name\":\"zg\",\"mode\":\"norbjgmnzjot\",\"size\":465871086,\"db\":\"rxkhlob\",\"user\":\"jbhvhdiqayflu\",\"connection\":{\"uri\":\"osnuudtelv\",\"database\":\"ibdrqrswhbuubpyr\",\"host\":\"tjoxztfw\",\"port\":1627091784,\"user\":\"vczevjn\",\"password\":\"tagfyvrtpqp\",\"ssl\":true},\"private_connection\":{\"uri\":\"gkrepdqhqyhw\",\"database\":\"e\",\"host\":\"xqabckmzeoxi\",\"port\":1529406778,\"user\":\"eoh\",\"password\":\"h\",\"ssl\":false}}")
                        .toObject(ConnectionPool.class);
    ...
    public void testSerialize() {
        ConnectionPool model =
                new ConnectionPool()
                        .setName("zg")
                        .setMode("norbjgmnzjot")
                        .setSize(465871086)
                        .setDb("rxkhlob")
                        .setUser("jbhvhdiqayflu")
