...
public final class Components171RlqzResponsesInvoicesContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        Components171RlqzResponsesInvoicesContentApplicationJsonSchemaAllof0 model =
                BinaryData.fromString(
                                "{\"invoices\":[{\"invoice_uuid\":\"bqsdtcjbctvi\",\"amount\":\"zqymtuowogtgits\",\"invoice_period\":\"zvbrzcdbanfzndsc\",\"updated_at\":\"xeatkd\"}],\"invoice_preview\":{\"invoice_uuid\":\"nrd\",\"amount\":\"ibqbnaomhjrm\",\"invoice_period\":\"hmaxljalfi\",\"updated_at\":\"jmobca\"}}")
                        .toObject(Components171RlqzResponsesInvoicesContentApplicationJsonSchemaAllof0.class);
    ...
    public void testSerialize() {
        Components171RlqzResponsesInvoicesContentApplicationJsonSchemaAllof0 model =
                new Components171RlqzResponsesInvoicesContentApplicationJsonSchemaAllof0()
                        .setInvoices(
                                Arrays.asList(
                                        new InvoicePreview()
                                                .setInvoiceUuid("bqsdtcjbctvi")
                                                .setAmount("zqymtuowogtgits")
                                                .setInvoicePeriod("zvbrzcdbanfzndsc")
                                                .setUpdatedAt("xeatkd")))
                        .setInvoicePreview(
                                new InvoicePreview()
                                        .setInvoiceUuid("nrd")
                                        .setAmount("ibqbnaomhjrm")
                                        .setInvoicePeriod("hmaxljalfi")
                                        .setUpdatedAt("jmobca"));
        model =
