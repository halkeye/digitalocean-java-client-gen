...
public final class DomainRecordTxtTests {
    ...
    public void testDeserialize() {
        DomainRecordTxt model =
                BinaryData.fromString(
                                "{\"id\":1203432151,\"type\":\"nrbctbhpjhxpcvrd\",\"name\":\"eitaneqadynzjahw\",\"data\":\"uomzczfki\",\"priority\":1238351045,\"port\":9296318,\"ttl\":2097914392,\"weight\":1864136114,\"flags\":34596520,\"tag\":\"axikhfjqebglcxk\"}")
                        .toObject(DomainRecordTxt.class);
    ...
    public void testSerialize() {
        DomainRecordTxt model =
                new DomainRecordTxt()
                        .setType("nrbctbhpjhxpcvrd")
                        .setName("eitaneqadynzjahw")
                        .setData("uomzczfki")
                        .setPriority(1238351045)
                        .setPort(9296318)
                        .setTtl(2097914392)
                        .setWeight(1864136114)
                        .setFlags(34596520)
                        .setTag("axikhfjqebglcxk");
