...
public final class ClusterTests {
    ...
    public void testSerialize() {
        Cluster model = new Cluster().setName("geupcknece").setRegion("kgrvfpsjd").setVersion("ngsy").setTags(Arrays.asList("dwdrpazqjkrfmbwo", "fcuuugtjigpg", "yiawohfmhnnz", "ecjjkmq")).setNodePools(Arrays.asList(new KubernetesNodePool().setSize("khcyoaqxuk").setName("idzr").setCount(1078210995).setTags(Arrays.asList("oiovslvivq")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(2035745663).setMaxNodes(1771574336), new KubernetesNodePool().setSize("zuaixcdckixspsa").setName("juf").setCount(615875297).setTags(Arrays.asList("oanduewfhvpxjhx")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(1175768129).setMaxNodes(1919209295), new KubernetesNodePool().setSize("ecgihzbpemnrr").setName("vkmvyxzerejrkp").setCount(1748610259).setTags(Arrays.asList("tjx")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(931200749).setMaxNodes(1579451655), new KubernetesNodePool().setSize("uqvcmlaexbzbqufp").setName("vrwwx").setCount(1460970309).setTags(Arrays.asList("spboxhifp", "skpeswyhhmifjua")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(220302704).setMaxNodes(1261334026))).setMaintenancePolicy(new MaintenancePolicy().setStartTime("sjzaymldrorhyog").setDay(MaintenancePolicyDay.SUNDAY)).setAutoUpgrade(true).setSurgeUpgrade(true).setHa(true);
