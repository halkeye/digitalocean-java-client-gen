...
public final class RegistryOptionsResponseApplicationJsonPropertiesTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                ...
                model.getSubscriptionTiers().get(0).getEligibilityReasons().get(0));
    }
    ...
    public void testSerialize() {
        RegistryOptionsResponseApplicationJsonProperties model =
                new RegistryOptionsResponseApplicationJsonProperties()
                        .setAvailableRegions(Arrays.asList("xhmewyaol", "lzxkrdpuyyt", "pkrpkhqetpoe"))
                        .setSubscriptionTiers(
                                Arrays.asList(
                                        new Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems()
                                                .setName("nrxiyrxow")
                                                .setSlug("ufcmuajwblxp")
                                                .setIncludedRepositories(942163314)
                                                .setIncludedStorageBytes(989975634)
                                                .setAllowStorageOverage(false)
                                                .setIncludedBandwidthBytes(1270563817)
                                                .setMonthlyPriceInCents(1556184463)
                                                .setStorageOveragePriceInCents(556988146)
                                                .setEligible(false)
                                                .setEligibilityReasons(
                                                        Arrays.asList(
                                                                SubscriptionTierExtendedEligibilityReasonsItem
                                                                        .OVER_REPOSITORY_LIMIT)),
                                        new Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems()
                                                .setName("htibufgz")
                                                .setSlug("h")
                                                .setIncludedRepositories(1919382389)
                                                .setIncludedStorageBytes(2109140215)
                                                .setAllowStorageOverage(false)
                                                .setIncludedBandwidthBytes(2018719493)
                                                .setMonthlyPriceInCents(737774627)
                                                .setStorageOveragePriceInCents(352932012)
                                                .setEligible(false)
                                                .setEligibilityReasons(
                                                        Arrays.asList(
                                                                SubscriptionTierExtendedEligibilityReasonsItem
                                                                ...
                                                                SubscriptionTierExtendedEligibilityReasonsItem
                                                                        .OVER_REPOSITORY_LIMIT)),
                                        new Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems()
                                                .setName("jxdumhycxonebld")
                                                .setSlug("gmdfjwc")
                                                .setIncludedRepositories(792135044)
                                                .setIncludedStorageBytes(1501932061)
                                                .setAllowStorageOverage(false)
                                                .setIncludedBandwidthBytes(1493112239)
                                                .setMonthlyPriceInCents(1797900196)
                                                .setStorageOveragePriceInCents(76327917)
                                                .setEligible(true)
                                                .setEligibilityReasons(
                                                        Arrays.asList(
                                                                SubscriptionTierExtendedEligibilityReasonsItem
                                        ...
                                        new Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems()
                                                .setName("rpjuvgzacr")
                                                .setSlug("nsbylgmgbh")
                                                .setIncludedRepositories(1378560905)
                                                .setIncludedStorageBytes(1050376390)
                                                .setAllowStorageOverage(false)
                                                .setIncludedBandwidthBytes(1651287638)
                                                .setMonthlyPriceInCents(254771931)
                                                .setStorageOveragePriceInCents(275550546)
                                                .setEligible(true)
                                                .setEligibilityReasons(
                                                        Arrays.asList(
                                                                SubscriptionTierExtendedEligibilityReasonsItem
