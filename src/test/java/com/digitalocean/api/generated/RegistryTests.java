...
public final class RegistryTests {
    ...
    public void testSerialize() {
        Registry model = new Registry().setName("fkvg").setRegion("tuxlbpxrhrfjen").setSubscription(new RegistrySubscription().setTier(new SubscriptionTierBase().setName("tlhqas").setSlug("ostjixyz").setIncludedRepositories(963766917).setIncludedStorageBytes(1671356692).setAllowStorageOverage(true).setIncludedBandwidthBytes(2130673798).setMonthlyPriceInCents(819938698).setStorageOveragePriceInCents(1089497944)));
