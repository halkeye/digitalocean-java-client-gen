...
public final class AppsDeploymentProgressStepTests {
    ...
    public void testDeserialize() {
        AppsDeploymentProgressStep model =
                BinaryData.fromString(
                                "{\"component_name\":\"mokzhjjklf\",\"ended_at\":\"2021-12-06T20:15:09Z\",\"message_base\":\"uwqlgzrfzeey\",\"name\":\"izikayuhq\",\"reason\":{\"code\":\"bs\",\"message\":\"bqwrvtldgm\"},\"started_at\":\"2021-08-05T07:24:51Z\",\"status\":\"PENDING\",\"steps\":[]}")
                        .toObject(AppsDeploymentProgressStep.class);
    ...
    public void testSerialize() {
        AppsDeploymentProgressStep model =
                new AppsDeploymentProgressStep()
                        ...
                        .setEndedAt(OffsetDateTime.parse("2021-12-06T20:15:09Z"))
                        .setMessageBase("uwqlgzrfzeey")
                        .setName("izikayuhq")
                        .setReason(new AppsDeploymentProgressStepReason().setCode("bs").setMessage("bqwrvtldgm"))
                        .setStartedAt(OffsetDateTime.parse("2021-08-05T07:24:51Z"))
