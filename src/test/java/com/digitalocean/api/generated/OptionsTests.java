    ...
    public void testDeserialize() {
        Options model =
                BinaryData.fromString(
                                "{\"options\":{\"mongodb\":{\"versions\":[\"tlgflwfgz\",\"iucijjcea\",\"lijjjrtvam\"],\"layouts\":[],\"regions\":[\"nxkvccxetyvku\",\"mignohikkg\",\"ogjwpindedvabbxb\",\"medeil\"]},\"pg\":{\"versions\":[\"fcfxzirzzihvwy\",\"usuv\",\"slczwciidjsllf\"],\"layouts\":[],\"regions\":[\"vxadqacfrgnawbab\",\"fbktyjmfczlf\"]},\"mysql\":{\"versions\":[\"frbzgowo\",\"qmje\",\"jcx\",\"yqgxhlus\"],\"layouts\":[],\"regions\":[\"i\",\"jceagb\",\"qvlsumywzas\",\"xgo\"]},\"redis\":{\"versions\":[\"fq\",\"puby\",\"nclkfkeeb\",\"vop\"],\"layouts\":[],\"regions\":[\"qujlyegqa\",\"nigflqqbtnyj\",\"ylxd\"]}}}")
                        .toObject(Options.class);
    }
