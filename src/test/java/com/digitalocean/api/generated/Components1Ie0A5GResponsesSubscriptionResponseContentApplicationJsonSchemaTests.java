...
public final class Components1Ie0A5GResponsesSubscriptionResponseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Ie0A5GResponsesSubscriptionResponseContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"subscription\":{\"tier\":{\"name\":\"pstizsyqagqllcb\",\"slug\":\"aidyl\",\"included_repositories\":2106525612,\"included_storage_bytes\":536739646,\"allow_storage_overage\":true,\"included_bandwidth_bytes\":112409200,\"monthly_price_in_cents\":1838829901,\"storage_overage_price_in_cents\":1600689171},\"created_at\":\"2020-12-26T15:03:15Z\",\"updated_at\":\"2021-09-13T10:05:41Z\"}}")
                        .toObject(Components1Ie0A5GResponsesSubscriptionResponseContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Ie0A5GResponsesSubscriptionResponseContentApplicationJsonSchema model =
                new Components1Ie0A5GResponsesSubscriptionResponseContentApplicationJsonSchema()
                        .setSubscription(
                                new Subscription()
                                        .setTier(
                                                new SubscriptionTierBase()
                                                        .setName("pstizsyqagqllcb")
                                                        .setSlug("aidyl")
                                                        .setIncludedRepositories(2106525612)
                                                        .setIncludedStorageBytes(536739646)
                                                        .setAllowStorageOverage(true)
                                                        .setIncludedBandwidthBytes(112409200)
                                                        .setMonthlyPriceInCents(1838829901)
                                                        .setStorageOveragePriceInCents(1600689171)));
        model =
