...
public final class AlertPolicyTests {
    ...
    public void testDeserialize() {
        AlertPolicy model = BinaryData.fromString("{\"alerts\":{\"email\":[\"iigeeu\"],\"slack\":[{\"channel\":\"rn\",\"url\":\"yxfedqnetd\"}]},\"compare\":\"LessThan\",\"description\":\"yn\",\"enabled\":true,\"entities\":[\"gvbzpg\",\"pw\",\"eyobqaj\"],\"tags\":[\"irv\",\"vrvkgpogplb\",\"uvlnhxnrnjhinaeg\"],\"type\":\"v1/insights/droplet/cpu\",\"uuid\":\"bx\",\"value\":87.99935,\"window\":\"5m\"}").toObject(AlertPolicy.class);
    ...
    public void testSerialize() {
        AlertPolicy model = new AlertPolicy().setAlerts(new Alerts().setEmail(Arrays.asList("iigeeu")).setSlack(Arrays.asList(new SlackDetails().setChannel("rn").setUrl("yxfedqnetd")))).setCompare(AlertPolicyCompare.LESS_THAN).setDescription("yn").setEnabled(true).setEntities(Arrays.asList("gvbzpg", "pw", "eyobqaj")).setTags(Arrays.asList("irv", "vrvkgpogplb", "uvlnhxnrnjhinaeg")).setType(AlertPolicyType.V1INSIGHTS_DROPLET_CPU).setUuid("bx").setValue(87.99935f).setWindow(AlertPolicyWindow.FIVEM);
