...
public final class ComponentsYfiiqgResponsesAllFirewallsContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testSerialize() {
        ComponentsYfiiqgResponsesAllFirewallsContentApplicationJsonSchemaAllof0 model =
                new ComponentsYfiiqgResponsesAllFirewallsContentApplicationJsonSchemaAllof0()
                        .setFirewalls(
                                Arrays.asList(
                                        new Firewall()
                                                ...
                                                .setName("rkjg")
                                                .setDropletIds(
                                                        Arrays.asList(715641821, 1803427824, 745319010, 1919720488)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("laqrwyam")
                                                .setDropletIds(Arrays.asList(320025450, 1553710393)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("rvrk")
                                                .setDropletIds(Arrays.asList(1274004293)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("ixqbolxvhhyqqeg")
                                                .setDropletIds(Arrays.asList(935452411, 1542919185))));
        model =
