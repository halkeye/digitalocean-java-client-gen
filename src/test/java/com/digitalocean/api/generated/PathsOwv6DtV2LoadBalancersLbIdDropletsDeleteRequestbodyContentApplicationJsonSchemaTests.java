...
public final class PathsOwv6DtV2LoadBalancersLbIdDropletsDeleteRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        PathsOwv6DtV2LoadBalancersLbIdDropletsDeleteRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString("{\"droplet_ids\":[1663871632,688475668,126960416,428114220]}")
                        .toObject(
    ...
    public void testSerialize() {
        PathsOwv6DtV2LoadBalancersLbIdDropletsDeleteRequestbodyContentApplicationJsonSchema model =
                new PathsOwv6DtV2LoadBalancersLbIdDropletsDeleteRequestbodyContentApplicationJsonSchema()
                        .setDropletIds(Arrays.asList(1663871632, 688475668, 126960416, 428114220));
        model =
