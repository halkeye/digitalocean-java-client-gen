...
public final class Components19Fq60GResponsesDatabaseReplicaContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components19Fq60GResponsesDatabaseReplicaContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"replica\":{\"name\":\"lyotg\",\"region\":\"sxnsrqorcge\",\"size\":\"vcebxeetqujxcxxq\",\"status\":\"online\",\"tags\":[\"kedwqurcgojmrv\",\"xwjongzse\",\"qqrsil\",\"chskxxka\"],\"created_at\":\"2021-12-04T06:38:55Z\",\"private_network_uuid\":\"ia\",\"connection\":{\"uri\":\"tojrulfucte\",\"database\":\"thcfj\",\"host\":\"xlyubqjrostv\",\"port\":632993810,\"user\":\"mtzzbeq\",\"password\":\"trx\",\"ssl\":false},\"private_connection\":{\"uri\":\"habsrwrsnrh\",\"database\":\"a\",\"host\":\"wk\",\"port\":134052535,\"user\":\"nxkvvcsemsv\",\"password\":\"djkqxetqmm\",\"ssl\":false}}}")
                        .toObject(Components19Fq60GResponsesDatabaseReplicaContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components19Fq60GResponsesDatabaseReplicaContentApplicationJsonSchema model =
                new Components19Fq60GResponsesDatabaseReplicaContentApplicationJsonSchema()
                        .setReplica(
                                new DatabaseReplica()
                                        .setName("lyotg")
                                        .setRegion("sxnsrqorcge")
                                        .setSize("vcebxeetqujxcxxq")
                                        .setTags(Arrays.asList("kedwqurcgojmrv", "xwjongzse", "qqrsil", "chskxxka"))
                                        .setPrivateNetworkUuid("ia")
