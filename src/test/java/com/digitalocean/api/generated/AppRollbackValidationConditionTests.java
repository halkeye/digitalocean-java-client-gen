...
public final class AppRollbackValidationConditionTests {
    ...
    public void testDeserialize() {
        AppRollbackValidationCondition model =
                BinaryData.fromString(
                                "{\"code\":\"exceeded_revision_limit\",\"message\":\"zvoaikna\",\"components\":[\"uwiguyxlyk\",\"phvxz\",\"wxh\",\"pejtl\"]}")
                        .toObject(AppRollbackValidationCondition.class);
    ...
    public void testSerialize() {
        AppRollbackValidationCondition model =
                new AppRollbackValidationCondition()
                        ...
                        .setMessage("zvoaikna")
                        .setComponents(Arrays.asList("uwiguyxlyk", "phvxz", "wxh", "pejtl"));
