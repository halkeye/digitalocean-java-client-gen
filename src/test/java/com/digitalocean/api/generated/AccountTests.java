...
public final class AccountTests {
    ...
    public void testDeserialize() {
        Account model = BinaryData.fromString("{\"droplet_limit\":1933182137,\"floating_ip_limit\":1823577017,\"email\":\"jpsq\",\"uuid\":\"cmpoyfdkfogkny\",\"email_verified\":false,\"status\":\"locked\",\"status_message\":\"fjddeqs\",\"team\":{\"uuid\":\"upewnwreitjzy\",\"name\":\"usarhmofc\"}}").toObject(Account.class);
    ...
    public void testSerialize() {
        Account model = new Account().setDropletLimit(1933182137).setFloatingIpLimit(1823577017).setEmail("jpsq").setUuid("cmpoyfdkfogkny").setEmailVerified(false).setStatus(AccountStatus.LOCKED).setStatusMessage("fjddeqs").setTeam(new AccountTeam().setUuid("upewnwreitjzy").setName("usarhmofc"));
