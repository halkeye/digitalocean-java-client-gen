...
public final class NodeTests {
    ...
    public void testDeserialize() {
        Node model =
                BinaryData.fromString(
                                "{\"name\":\"tpfcudvafnbfbqv\",\"status\":{\"state\":\"running\"},\"droplet_id\":\"hgko\",\"created_at\":\"2021-09-24T21:54:57Z\",\"updated_at\":\"2021-11-17T19:07:05Z\"}")
                        .toObject(Node.class);
    ...
    public void testSerialize() {
        Node model =
                new Node()
                        .setName("tpfcudvafnbfbqv")
                        .setStatus(new NodeStatus().setState(NodeStatusState.RUNNING))
                        .setDropletId("hgko")
                        .setCreatedAt(OffsetDateTime.parse("2021-09-24T21:54:57Z"))
                        .setUpdatedAt(OffsetDateTime.parse("2021-11-17T19:07:05Z"));
