...
public final class OneClicksCreateTests {
    ...
    public void testDeserialize() {
        OneClicksCreate model = BinaryData.fromString("{\"addon_slugs\":[\"oqijgkdmbpaz\",\"obcu\"],\"cluster_uuid\":\"pdznrbtcqqjnqgl\"}").toObject(OneClicksCreate.class);
    ...
    public void testSerialize() {
        OneClicksCreate model = new OneClicksCreate().setAddonSlugs(Arrays.asList("oqijgkdmbpaz", "obcu")).setClusterUuid("pdznrbtcqqjnqgl");
