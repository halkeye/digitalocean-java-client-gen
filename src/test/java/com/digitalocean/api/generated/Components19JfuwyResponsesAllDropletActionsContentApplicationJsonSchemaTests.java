...
public final class Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":817826430},\"actions\":[{\"id\":1699420866,\"status\":\"errored\",\"type\":\"szrbwtdrcwg\",\"started_at\":\"2021-10-16T13:26:22Z\",\"completed_at\":\"2021-03-27T20:10:13Z\",\"resource_id\":1078640782,\"resource_type\":\"hfixa\",\"region\":{\"name\":\"c\",\"slug\":\"lzjrmhpfy\",\"available\":true}}]}")
                        .toObject(Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-03-27T20:10:13Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema model =
                new Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(1699420866)
                                                ...
                                                .setType("szrbwtdrcwg")
                                                .setStartedAt(OffsetDateTime.parse("2021-10-16T13:26:22Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-03-27T20:10:13Z"))
                                                .setResourceId(1078640782)
                                                .setResourceType("hfixa")
                                                .setRegion(
                                                        new Region()
                                                                .setName("c")
                                                                .setSlug("lzjrmhpfy")
                        ...
                        .setMeta(new MetaMeta().setTotal(817826430));
        model =
