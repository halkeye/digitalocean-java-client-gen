...
public final class AppsDeploymentProgressTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-05-18T05:36:02Z"), model.getSummarySteps().get(0).getEndedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-05-03T06:31:18Z"), model.getSummarySteps().get(0).getStartedAt());
    ...
    public void testSerialize() {
        AppsDeploymentProgress model = new AppsDeploymentProgress().setErrorSteps(767551661).setPendingSteps(1720208183).setRunningSteps(670463751).setSteps(Arrays.asList(new AppsDeploymentProgressStep().setComponentName("h").setEndedAt(OffsetDateTime.parse("2021-05-15T13:33:35Z")).setMessageBase("p").setName("cstwity").setReason(new AppsDeploymentProgressStepReason().setCode("vxccedcp").setMessage("dyodnwzxltj")).setStartedAt(OffsetDateTime.parse("2021-10-06T13:51:27Z")).setStatus(AppsDeploymentProgressStepStatus.UNKNOWN).setSteps(Arrays.asList()))).setSuccessSteps(841084025).setSummarySteps(Arrays.asList(new AppsDeploymentProgressStep().setComponentName("avvwxqi").setEndedAt(OffsetDateTime.parse("2021-05-18T05:36:02Z")).setMessageBase("nyowxwlmdjrkvfg").setName("fvpdbo").setReason(new AppsDeploymentProgressStepReason().setCode("izsjqlhkrr").setMessage("deibqip")).setStartedAt(OffsetDateTime.parse("2021-05-03T06:31:18Z")).setStatus(AppsDeploymentProgressStepStatus.RUNNING).setSteps(Arrays.asList()), new AppsDeploymentProgressStep().setComponentName("zwmk").setEndedAt(OffsetDateTime.parse("2021-01-17T19:32:36Z")).setMessageBase("jpjorwkqnyhgb").setName("tjivfxzsjabib").setReason(new AppsDeploymentProgressStepReason().setCode("tawfsdjpvkvp").setMessage("xbkzbzkdvncj")).setStartedAt(OffsetDateTime.parse("2021-03-23T01:16:39Z")).setStatus(AppsDeploymentProgressStepStatus.ERROR).setSteps(Arrays.asList()))).setTotalSteps(888866053);
