...
public final class Components1XhigaoResponsesVolumesnapshotsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1XhigaoResponsesVolumesnapshotsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1362070044},\"snapshots\":[{\"resource_id\":\"mzjrit\",\"resource_type\":\"volume\",\"tags\":[\"ym\",\"bfex\"],\"name\":\"izzjxwj\",\"created_at\":\"2021-11-09T19:33:54Z\",\"regions\":[\"zwanduhduwdvolxt\",\"m\",\"ic\"],\"min_disk_size\":128732663,\"size_gigabytes\":30.732853}]}")
                        .toObject(Components1XhigaoResponsesVolumesnapshotsContentApplicationJsonSchema.class);
        Assertions.assertEquals("izzjxwj", model.getSnapshots().get(0).getName());
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-11-09T19:33:54Z"), model.getSnapshots().get(0).getCreatedAt());
    ...
    public void testSerialize() {
        Components1XhigaoResponsesVolumesnapshotsContentApplicationJsonSchema model =
                new Components1XhigaoResponsesVolumesnapshotsContentApplicationJsonSchema()
                        .setSnapshots(
                                Arrays.asList(
                                        new Snapshots()
                                                .setName("izzjxwj")
                                                .setCreatedAt(OffsetDateTime.parse("2021-11-09T19:33:54Z"))
                                                .setRegions(Arrays.asList("zwanduhduwdvolxt", "m", "ic"))
                                                .setMinDiskSize(128732663)
                                                .setSizeGigabytes(30.732853f)
                                                .setResourceId("mzjrit")
                                                .setResourceType(SnapshotsResourceType.VOLUME)
                                                .setTags(Arrays.asList("ym", "bfex"))))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1362070044));
        model =
