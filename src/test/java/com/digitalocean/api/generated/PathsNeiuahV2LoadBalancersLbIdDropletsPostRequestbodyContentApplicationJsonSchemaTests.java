...
public final class PathsNeiuahV2LoadBalancersLbIdDropletsPostRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        PathsNeiuahV2LoadBalancersLbIdDropletsPostRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString("{\"droplet_ids\":[1755553996,867784580,569973171,1547486643]}")
                        .toObject(
    ...
    public void testSerialize() {
        PathsNeiuahV2LoadBalancersLbIdDropletsPostRequestbodyContentApplicationJsonSchema model =
                new PathsNeiuahV2LoadBalancersLbIdDropletsPostRequestbodyContentApplicationJsonSchema()
                        .setDropletIds(Arrays.asList(1755553996, 867784580, 569973171, 1547486643));
        model =
