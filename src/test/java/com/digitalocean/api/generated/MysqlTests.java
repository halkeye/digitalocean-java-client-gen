...
public final class MysqlTests {
    ...
    public void testSerialize() {
        Mysql model =
                new Mysql()
                        .setBackupHour(99360377)
                        .setBackupMinute(206783599)
                        .setSqlMode("lctaeb")
                        .setConnectTimeout(807583540)
                        .setDefaultTimeZone("ledjcustbvtqigd")
                        .setGroupConcatMaxLen(1899435614)
                        .setInformationSchemaStatsExpiry(2021179432)
                        .setInnodbFtMinTokenSize(2098110857)
                        .setInnodbFtServerStopwordTable("gfosehxlzsxez")
                        .setInnodbLockWaitTimeout(911230871)
                        .setInnodbLogBufferSize(346065093)
                        .setInnodbOnlineAlterLogMaxSize(1228290805)
                        .setInnodbPrintAllDeadlocks(true)
                        .setInnodbRollbackOnTimeout(true)
                        .setInteractiveTimeout(725661338)
                        .setInternalTmpMemStorageEngine(MysqlInternalTmpMemStorageEngine.TEMP_TABLE)
                        .setNetReadTimeout(2091230179)
                        .setNetWriteTimeout(1259059473)
                        .setSqlRequirePrimaryKey(false)
                        .setWaitTimeout(1119997590)
                        .setMaxAllowedPacket(2092040078)
                        .setMaxHeapTableSize(1825702886)
                        .setSortBufferSize(1803184216)
                        .setTmpTableSize(951853917)
                        .setSlowQueryLog(false)
                        .setLongQueryTime(46.941013F)
                        .setBinlogRetentionPeriod(10.291165F);
