...
public final class AppComponentInstanceBaseTests {
    ...
    public void testDeserialize() {
        AppComponentInstanceBase model = BinaryData.fromString("{\"instance_count\":3555735761282593799,\"instance_size_slug\":\"professional-1l\"}").toObject(AppComponentInstanceBase.class);
    ...
    public void testSerialize() {
        AppComponentInstanceBase model = new AppComponentInstanceBase().setInstanceCount(3555735761282593799L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.PROFESSIONAL1L);
