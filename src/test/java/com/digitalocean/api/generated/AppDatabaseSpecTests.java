...
public final class AppDatabaseSpecTests {
    ...
    public void testDeserialize() {
        AppDatabaseSpec model =
                BinaryData.fromString(
                                "{\"cluster_name\":\"fnwmbtmvpdvj\",\"db_name\":\"ttzaefed\",\"db_user\":\"hchrphkmcrjdqn\",\"engine\":\"PG\",\"name\":\"zpbgtgkylkdg\",\"production\":false,\"version\":\"uutlwxezwzhok\"}")
                        .toObject(AppDatabaseSpec.class);
    ...
    public void testSerialize() {
        AppDatabaseSpec model =
                new AppDatabaseSpec()
                        .setClusterName("fnwmbtmvpdvj")
                        .setDbName("ttzaefed")
                        .setDbUser("hchrphkmcrjdqn")
                        .setEngine(AppDatabaseSpecEngine.PG)
                        .setName("zpbgtgkylkdg")
                        .setProduction(false)
                        .setVersion("uutlwxezwzhok");
