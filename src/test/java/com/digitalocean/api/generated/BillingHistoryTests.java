...
public final class BillingHistoryTests {
    ...
    public void testDeserialize() {
        BillingHistory model =
                BinaryData.fromString(
                                "{\"description\":\"ifdf\",\"amount\":\"fyzyzeyuub\",\"invoice_id\":\"ds\",\"invoice_uuid\":\"fytoi\",\"date\":\"2021-06-27T18:12:19Z\",\"type\":\"Credit\"}")
                        .toObject(BillingHistory.class);
    ...
    public void testSerialize() {
        BillingHistory model =
                new BillingHistory()
                        .setDescription("ifdf")
                        .setAmount("fyzyzeyuub")
                        .setInvoiceId("ds")
                        .setInvoiceUuid("fytoi")
                        .setDate(OffsetDateTime.parse("2021-06-27T18:12:19Z"))
                        .setType(BillingHistoryType.CREDIT);
