...
public final class ComponentsW0Qp6KResponsesExistingLoadBalancerContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsW0Qp6KResponsesExistingLoadBalancerContentApplicationJsonSchema model =
                new ComponentsW0Qp6KResponsesExistingLoadBalancerContentApplicationJsonSchema()
                        .setLoadBalancer(
                                new LoadBalancer()
                                        .setName("axsqcomji")
                                        .setSizeUnit(676319251)
                                        ...
                                        .setForwardingRules(
                                                Arrays.asList(
                                                        new ForwardingRule()
                                                                ...
                                                                .setEntryPort(305599752)
                                                                .setTargetProtocol(ForwardingRuleTargetProtocol.HTTPS)
                                                                .setTargetPort(2033817605)
                                                                .setCertificateId("mduvtvodqxxp")
                                                                .setTlsPassthrough(false)))
                                        .setHealthCheck(
                                                new HealthCheck()
                                                        .setProtocol(HealthCheckProtocol.HTTP)
                                                        .setPort(799929731)
                                                        .setPath("lmcvrjaznotdofq")
                                                        .setCheckIntervalSeconds(484759838)
                                                        .setResponseTimeoutSeconds(620120625)
                                                        .setUnhealthyThreshold(2077416906)
                                                        .setHealthyThreshold(1779009385))
                                        .setStickySessions(
                                                new StickySessions()
                                                        .setType(StickySessionsType.COOKIES)
                                                        .setCookieName("bbmitaftaz")
                                                        .setCookieTtlSeconds(953956672))
