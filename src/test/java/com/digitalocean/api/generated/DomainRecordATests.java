...
public final class DomainRecordATests {
    ...
    public void testDeserialize() {
        DomainRecordA model = BinaryData.fromString("{\"id\":1572850968,\"type\":\"mgmqfmef\",\"name\":\"qcpdwjgquxwey\",\"data\":\"andkd\",\"priority\":27796894,\"port\":654444535,\"ttl\":1274109411,\"weight\":1603371705,\"flags\":527155493,\"tag\":\"wnrrnquoxso\"}").toObject(DomainRecordA.class);
    ...
    public void testSerialize() {
        DomainRecordA model = new DomainRecordA().setType("mgmqfmef").setName("qcpdwjgquxwey").setData("andkd").setPriority(27796894).setPort(654444535).setTtl(1274109411).setWeight(1603371705).setFlags(527155493).setTag("wnrrnquoxso");
