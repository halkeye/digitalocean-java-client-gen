...
public final class ComponentsAplp5ResponsesAllDropletsContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-10-26T03:48:13Z"), model.getDroplets().get(0).getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-13T09:46:11Z"), model.getDroplets().get(0).getNextBackupWindow().getStart());
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-30T19:08:33Z"), model.getDroplets().get(0).getNextBackupWindow().getEnd());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-05-10T15:05:44Z"), model.getDroplets().get(0).getImage().getCreatedAt());
    ...
    public void testSerialize() {
        ComponentsAplp5ResponsesAllDropletsContentApplicationJsonSchemaAllof0 model = new ComponentsAplp5ResponsesAllDropletsContentApplicationJsonSchemaAllof0().setDroplets(Arrays.asList(new Droplet().setId(1478084634).setName("lcgctjchfjv").setMemory(1976746044).setVcpus(573789553).setDisk(11816420).setLocked(false).setStatus(DropletStatus.OFF).setKernel(new Kernel().setId(269781052).setName("vlbefvwclj").setVersion("pylrwoxzgwpsy")).setCreatedAt(OffsetDateTime.parse("2021-10-26T03:48:13Z")).setFeatures(Arrays.asList("jeypdvrbkerdk", "kgawqwjxil", "fkcefeygz", "pjois")).setBackupIds(Arrays.asList(214582888, 1669352778, 868542301, 2068548608)).setNextBackupWindow(new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-03-13T09:46:11Z")).setEnd(OffsetDateTime.parse("2021-09-30T19:08:33Z"))).setSnapshotIds(Arrays.asList(1595603452, 858331369, 490885393, 2021126302)).setImage(new Image().setName("tw").setType(ImageType.SNAPSHOT).setDistribution(Distribution.ROCKY_LINUX).setSlug("ulwivqtowlhlsy").setPublicProperty(true).setRegions(Arrays.asList()).setCreatedAt(OffsetDateTime.parse("2021-05-10T15:05:44Z")).setMinDiskSize(667027013).setSizeGigabytes(35.856266F).setDescription("fajcywhjqwm").setTags(Arrays.asList()).setStatus(ImageStatus.DELETED).setErrorMessage("tfxcpupuk")).setVolumeIds(Arrays.asList("mjzpwdlvwtiwsm", "sa", "nhqnampp", "ltassaekewna")).setSize(new Size().setSlug("eajbkajlcyizyddc").setMemory(497254411).setVcpus(450716443).setDisk(534444200).setTransfer(70.845085f).setPriceMonthly(73.6286f).setPriceHourly(31.178444f).setRegions(Arrays.asList()).setAvailable(false).setDescription("sxxb")).setSizeSlug("desqlvg").setNetworks(new DropletNetworks().setV4(Arrays.asList()).setV6(Arrays.asList())).setRegion(new Region().setName("wgoljtzx").setSlug("mxsdobygoog").setAvailable(false)).setTags(Arrays.asList("pjxvazyjf", "csa", "djnosdkvibf", "sgm")).setVpcUuid("rnzpducdaak"), new Droplet().setId(1573814203).setName("jktzboimyfpq").setMemory(683522354).setVcpus(1020650753).setDisk(774305524).setLocked(true).setStatus(DropletStatus.NEW).setKernel(new Kernel().setId(1987908200).setName("tfvpctfjikff").setVersion("g")).setCreatedAt(OffsetDateTime.parse("2021-05-20T19:51:44Z")).setFeatures(Arrays.asList("znwhvu", "dbkkejjkjigawgaz", "xjqifhujjsbc")).setBackupIds(Arrays.asList(2032053398, 1525953234, 630961760, 855142861)).setNextBackupWindow(new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-01-17T05:07:29Z")).setEnd(OffsetDateTime.parse("2021-04-15T18:23:21Z"))).setSnapshotIds(Arrays.asList(648783991, 605503525, 658928456)).setImage(new Image().setName("irhhmo").setType(ImageType.SNAPSHOT).setDistribution(Distribution.GENTOO).setSlug("fjzc").setPublicProperty(true).setRegions(Arrays.asList()).setCreatedAt(OffsetDateTime.parse("2021-07-20T02:06:46Z")).setMinDiskSize(1269569576).setSizeGigabytes(52.973156F).setDescription("xw").setTags(Arrays.asList()).setStatus(ImageStatus.RETIRED).setErrorMessage("xkukm")).setVolumeIds(Arrays.asList("zynuh")).setSize(new Size().setSlug("oq").setMemory(1712631448).setVcpus(260585009).setDisk(1004791045).setTransfer(28.053015f).setPriceMonthly(10.554332f).setPriceHourly(92.77746f).setRegions(Arrays.asList()).setAvailable(false).setDescription("q")).setSizeSlug("xyrqo").setNetworks(new DropletNetworks().setV4(Arrays.asList()).setV6(Arrays.asList())).setRegion(new Region().setName("hbbnkgzuk").setSlug("drnzkjthf").setAvailable(true)).setTags(Arrays.asList("jncjmlfuyfjbp", "iddhlrufzc")).setVpcUuid("jmqrfuiocuselq")));
        model = BinaryData.fromObject(model).toObject(ComponentsAplp5ResponsesAllDropletsContentApplicationJsonSchemaAllof0.class);
        Assertions.assertEquals(1478084634, model.getDroplets().get(0).getId());
        Assertions.assertEquals("lcgctjchfjv", model.getDroplets().get(0).getName());
        Assertions.assertEquals(1976746044, model.getDroplets().get(0).getMemory());
        Assertions.assertEquals(573789553, model.getDroplets().get(0).getVcpus());
