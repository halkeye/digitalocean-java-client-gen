...
public final class VolumeActionPostAttachTests {
    ...
    public void testDeserialize() {
        VolumeActionPostAttach model = BinaryData.fromString("{\"droplet_id\":907339794,\"tags\":[\"zf\"],\"type\":\"resize\",\"region\":\"nyc3\"}").toObject(VolumeActionPostAttach.class);
    ...
    public void testSerialize() {
        VolumeActionPostAttach model = new VolumeActionPostAttach().setType(VolumeActionPostBaseType.RESIZE).setRegion(RegionSlug.NYC3).setDropletId(907339794).setTags(Arrays.asList("zf"));
