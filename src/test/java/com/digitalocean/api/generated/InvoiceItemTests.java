...
public final class InvoiceItemTests {
    ...
    public void testDeserialize() {
        InvoiceItem model = BinaryData.fromString("{\"product\":\"l\",\"resource_uuid\":\"rhuzgfxonjtpu\",\"resource_id\":\"l\",\"group_description\":\"pvti\",\"description\":\"zbpdbo\",\"amount\":\"gryfqiuasig\",\"duration\":\"wsocnequygdjbo\",\"duration_unit\":\"rmtqjkqevadr\",\"start_time\":\"wiu\",\"end_time\":\"vcmjzkxiidisczsk\",\"project_name\":\"woqiqazugamxzkrr\"}").toObject(InvoiceItem.class);
    ...
    public void testSerialize() {
        InvoiceItem model = new InvoiceItem().setProduct("l").setResourceUuid("rhuzgfxonjtpu").setResourceId("l").setGroupDescription("pvti").setDescription("zbpdbo").setAmount("gryfqiuasig").setDuration("wsocnequygdjbo").setDurationUnit("rmtqjkqevadr").setStartTime("wiu").setEndTime("vcmjzkxiidisczsk").setProjectName("woqiqazugamxzkrr");
