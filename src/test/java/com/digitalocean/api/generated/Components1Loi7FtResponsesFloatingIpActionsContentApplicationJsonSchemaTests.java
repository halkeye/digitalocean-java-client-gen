...
public final class Components1Loi7FtResponsesFloatingIpActionsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Loi7FtResponsesFloatingIpActionsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1528868635},\"actions\":[{\"id\":1727607651,\"status\":\"completed\",\"type\":\"kdywkszavuafane\",\"started_at\":\"2021-04-10T21:40:12Z\",\"completed_at\":\"2021-03-03T20:20:59Z\",\"resource_id\":896416210,\"resource_type\":\"kossjbzvxpzwdq\",\"region\":{\"name\":\"hfgtiaczhfjdcc\",\"slug\":\"nyuvbtcuhjcgjt\",\"available\":false}}]}")
                        .toObject(Components1Loi7FtResponsesFloatingIpActionsContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-03-03T20:20:59Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        Components1Loi7FtResponsesFloatingIpActionsContentApplicationJsonSchema model =
                new Components1Loi7FtResponsesFloatingIpActionsContentApplicationJsonSchema()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(1727607651)
                                                .setStatus(ActionStatus.COMPLETED)
                                                .setType("kdywkszavuafane")
                                                .setStartedAt(OffsetDateTime.parse("2021-04-10T21:40:12Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-03-03T20:20:59Z"))
                                                .setResourceId(896416210)
                                                .setResourceType("kossjbzvxpzwdq")
                                                .setRegion(
                                                        new Region()
                                                                .setName("hfgtiaczhfjdcc")
                                                                .setSlug("nyuvbtcuhjcgjt")
                                                                .setAvailable(false))))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1528868635));
        model =
