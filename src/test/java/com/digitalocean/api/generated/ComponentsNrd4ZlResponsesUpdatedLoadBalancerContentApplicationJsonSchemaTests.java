...
public final class ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchema model = BinaryData.fromString("{\"load_balancer\":{\"tag\":\"mxow\",\"name\":\"joyutehlkarvtipq\",\"ip\":\"sxiknsgofunsw\",\"size_unit\":784728990,\"size\":\"lb-medium\",\"algorithm\":\"round_robin\",\"status\":\"new\",\"created_at\":\"2021-09-21T21:17:39Z\",\"forwarding_rules\":[{\"entry_protocol\":\"udp\",\"entry_port\":563156651,\"target_protocol\":\"https\",\"target_port\":502583947,\"certificate_id\":\"dfkkedeetxtpwcv\",\"tls_passthrough\":true}],\"health_check\":{\"protocol\":\"tcp\",\"port\":1148527851,\"path\":\"ij\",\"check_interval_seconds\":2089228497,\"response_timeout_seconds\":306724333,\"unhealthy_threshold\":419396017,\"healthy_threshold\":233382899},\"sticky_sessions\":{\"type\":\"cookies\",\"cookie_name\":\"b\",\"cookie_ttl_seconds\":1597977030},\"redirect_http_to_https\":true,\"enable_proxy_protocol\":false,\"enable_backend_keepalive\":true,\"disable_lets_encrypt_dns_records\":true}}").toObject(ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals("dfkkedeetxtpwcv", model.getLoadBalancer().getForwardingRules().get(0).getCertificateId());
    ...
    public void testSerialize() {
        ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchema model = new ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchema().setLoadBalancer(new LoadBalancer().setName("joyutehlkarvtipq").setSizeUnit(784728990).setSize(LoadBalancerBaseSize.LB_MEDIUM).setAlgorithm(LoadBalancerBaseAlgorithm.ROUND_ROBIN).setForwardingRules(Arrays.asList(new ForwardingRule().setEntryProtocol(ForwardingRuleEntryProtocol.UDP).setEntryPort(563156651).setTargetProtocol(ForwardingRuleTargetProtocol.HTTPS).setTargetPort(502583947).setCertificateId("dfkkedeetxtpwcv").setTlsPassthrough(true))).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.TCP).setPort(1148527851).setPath("ij").setCheckIntervalSeconds(2089228497).setResponseTimeoutSeconds(306724333).setUnhealthyThreshold(419396017).setHealthyThreshold(233382899)).setStickySessions(new StickySessions().setType(StickySessionsType.COOKIES).setCookieName("b").setCookieTtlSeconds(1597977030)).setRedirectHttpToHttps(true).setEnableProxyProtocol(false).setEnableBackendKeepalive(true).setDisableLetsEncryptDnsRecords(true).setTag("mxow"));
        model = BinaryData.fromObject(model).toObject(ComponentsNrd4ZlResponsesUpdatedLoadBalancerContentApplicationJsonSchema.class);
        Assertions.assertEquals("joyutehlkarvtipq", model.getLoadBalancer().getName());
        Assertions.assertEquals(784728990, model.getLoadBalancer().getSizeUnit());
        Assertions.assertEquals(LoadBalancerBaseSize.LB_MEDIUM, model.getLoadBalancer().getSize());
        Assertions.assertEquals(LoadBalancerBaseAlgorithm.ROUND_ROBIN, model.getLoadBalancer().getAlgorithm());
