...
public final class AlertPolicyRequestTests {
    ...
    public void testDeserialize() {
        AlertPolicyRequest model =
                BinaryData.fromString(
                                "{\"alerts\":{\"email\":[\"zoszjg\"],\"slack\":[{\"channel\":\"nkfnyskwwunq\",\"url\":\"czavoj\"},{\"channel\":\"slhip\",\"url\":\"ukvbljpxpr\"},{\"channel\":\"vchyluqalpcufj\",\"url\":\"f\"}]},\"compare\":\"GreaterThan\",\"description\":\"izt\",\"enabled\":false,\"entities\":[\"tahhhsa\",\"xxsri\",\"rcwbaae\",\"yyefmxwoqotiiqb\"],\"tags\":[\"asrvrmtist\",\"ikjhorlxkpypkenn\"],\"type\":\"v1/insights/droplet/load_5\",\"value\":65.502754,\"window\":\"10m\"}")
                        .toObject(AlertPolicyRequest.class);
    ...
    public void testSerialize() {
        AlertPolicyRequest model =
                new AlertPolicyRequest()
                        .setAlerts(
                                new Alerts()
                                        .setEmail(Arrays.asList("zoszjg"))
                                        .setSlack(
                                                Arrays.asList(
                                                        new SlackDetails().setChannel("nkfnyskwwunq").setUrl("czavoj"),
                                                        new SlackDetails().setChannel("slhip").setUrl("ukvbljpxpr"),
                                                        new SlackDetails().setChannel("vchyluqalpcufj").setUrl("f"))))
                        .setCompare(AlertPolicyRequestCompare.GREATER_THAN)
                        .setDescription("izt")
                        .setEnabled(false)
                        .setEntities(Arrays.asList("tahhhsa", "xxsri", "rcwbaae", "yyefmxwoqotiiqb"))
                        .setTags(Arrays.asList("asrvrmtist", "ikjhorlxkpypkenn"))
                        .setType(AlertPolicyRequestType.V1INSIGHTS_DROPLET_LOAD5)
                        .setValue(65.502754f)
                        .setWindow(AlertPolicyRequestWindow.TENM);
