...
public final class AppsGitlabSourceSpecTests {
    ...
    public void testDeserialize() {
        AppsGitlabSourceSpec model = BinaryData.fromString("{\"branch\":\"zriykhy\",\"deploy_on_push\":true,\"repo\":\"jlb\"}").toObject(AppsGitlabSourceSpec.class);
    ...
    public void testSerialize() {
        AppsGitlabSourceSpec model = new AppsGitlabSourceSpec().setBranch("zriykhy").setDeployOnPush(true).setRepo("jlb");
