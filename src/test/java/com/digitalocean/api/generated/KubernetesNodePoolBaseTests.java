...
public final class KubernetesNodePoolBaseTests {
    ...
    public void testDeserialize() {
        KubernetesNodePoolBase model =
                BinaryData.fromString(
                                "{\"name\":\"caz\",\"count\":166681185,\"tags\":[\"zffzjwztsmp\",\"hggryelgf\",\"atig\",\"gfrrkdknczgoryw\"],\"taints\":[{\"key\":\"vmd\",\"value\":\"dlhqvbkarbpyhssr\",\"effect\":\"PreferNoSchedule\"}],\"auto_scale\":false,\"min_nodes\":308889962,\"max_nodes\":1950662560,\"nodes\":[{\"name\":\"ebxxopyic\",\"status\":{\"state\":\"running\"},\"droplet_id\":\"slhwyy\",\"created_at\":\"2021-11-09T19:03:16Z\",\"updated_at\":\"2021-11-27T19:09:11Z\"}]}")
                        .toObject(KubernetesNodePoolBase.class);
    ...
    public void testSerialize() {
        KubernetesNodePoolBase model =
                new KubernetesNodePoolBase()
                        .setName("caz")
                        .setCount(166681185)
                        .setTags(Arrays.asList("zffzjwztsmp", "hggryelgf", "atig", "gfrrkdknczgoryw"))
                        .setTaints(
                                Arrays.asList(
                                        new KubernetesNodePoolTaint()
                                                .setKey("vmd")
                                                .setValue("dlhqvbkarbpyhssr")
                                                .setEffect(KubernetesNodePoolTaintEffect.PREFER_NO_SCHEDULE)))
                        .setAutoScale(false)
                        .setMinNodes(308889962)
                        .setMaxNodes(1950662560);
