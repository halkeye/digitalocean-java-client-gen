...
public final class ComponentsKa40RcResponsesInvoiceContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testSerialize() {
        ComponentsKa40RcResponsesInvoiceContentApplicationJsonSchemaAllof0 model = new ComponentsKa40RcResponsesInvoiceContentApplicationJsonSchemaAllof0().setInvoiceItems(Arrays.asList(new InvoiceItem().setProduct("vawu").setResourceUuid("qjtiogqgdm").setResourceId("i").setGroupDescription("teajohiyg").setDescription("n").setAmount("n").setDuration("czykmktpvw").setDurationUnit("csehchkhufm").setStartTime("umqy").setEndTime("ydzulodsaeuzan").setProjectName("fnhsenwphp"), new InvoiceItem().setProduct("ngqjclidf").setResourceUuid("jwjj").setResourceId("wbeqrkuor").setGroupDescription("ssruqnmdvhazcvj").setDescription("iqswbqer").setAmount("xiytxtdgukvl").setDuration("ktg").setDurationUnit("tyouambewreswmow").setStartTime("mmuteyxeyguq").setEndTime("ijiitns").setProjectName("lz"), new InvoiceItem().setProduct("sygrijwa").setResourceUuid("fanraybfu").setResourceId("frojsydgr").setGroupDescription("dkygywezski").setDescription("afygzmxieqvds").setAmount("klixqcahyhxaly").setDuration("awoijp").setDurationUnit("tblxpkkwjdjodqhy").setStartTime("ncn").setEndTime("mehllizhceu").setProjectName("qodkadppyibngql"), new InvoiceItem().setProduct("ywrxw").setResourceUuid("dtluvvadswzsn").setResourceId("emlowuowhl").setGroupDescription("nwyrmouv").setDescription("gmokzkltrfowt").setAmount("rfmvlihcvjdrqcrj").setDuration("h").setDurationUnit("ukvhd").setStartTime("wyojbfqzdkfnjyi").setEndTime("afr").setProjectName("qxmbjroumzzn")));
        model = BinaryData.fromObject(model).toObject(ComponentsKa40RcResponsesInvoiceContentApplicationJsonSchemaAllof0.class);
        Assertions.assertEquals("vawu", model.getInvoiceItems().get(0).getProduct());
        Assertions.assertEquals("qjtiogqgdm", model.getInvoiceItems().get(0).getResourceUuid());
        Assertions.assertEquals("i", model.getInvoiceItems().get(0).getResourceId());
        Assertions.assertEquals("teajohiyg", model.getInvoiceItems().get(0).getGroupDescription());
