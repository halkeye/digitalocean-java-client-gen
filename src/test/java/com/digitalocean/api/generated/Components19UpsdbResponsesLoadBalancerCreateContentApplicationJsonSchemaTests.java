...
public final class Components19UpsdbResponsesLoadBalancerCreateContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                ForwardingRuleEntryProtocol.TCP,
        ...
        Assertions.assertEquals(
                ForwardingRuleTargetProtocol.HTTP2,
                                ...
                                new LoadBalancer()
                                        ...
                                        .setHealthCheck(
                                                new HealthCheck()
                                                        ...
                                                        .setPort(143583752)
                                                        .setPath("zuae")
                                                        .setCheckIntervalSeconds(1864326135)
                                                        .setResponseTimeoutSeconds(1800186951)
                                                        .setUnhealthyThreshold(645713420)
                                                        .setHealthyThreshold(1825942176))
                                        .setStickySessions(
                                                new StickySessions()
                                                        .setType(StickySessionsType.COOKIES)
                                                        .setCookieName("vxzzmiemqyf")
                                                        .setCookieTtlSeconds(161477512))
