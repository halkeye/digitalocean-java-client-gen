...
public final class GarbageCollectionTests {
    ...
    public void testDeserialize() {
        GarbageCollection model =
                BinaryData.fromString(
                                "{\"uuid\":\"xozqthkwxfugfziz\",\"registry_name\":\"duyjnqzbr\",\"status\":\"scanning manifests\",\"created_at\":\"2021-06-01T12:57:34Z\",\"updated_at\":\"2021-04-07T05:51:53Z\",\"blobs_deleted\":1874576933,\"freed_bytes\":214271972}")
                        .toObject(GarbageCollection.class);
    ...
    public void testSerialize() {
        GarbageCollection model =
                new GarbageCollection()
                        .setUuid("xozqthkwxfugfziz")
                        .setRegistryName("duyjnqzbr")
                        .setStatus(GarbageCollectionStatus.SCANNING_MANIFESTS)
                        .setCreatedAt(OffsetDateTime.parse("2021-06-01T12:57:34Z"))
                        .setUpdatedAt(OffsetDateTime.parse("2021-04-07T05:51:53Z"))
                        .setBlobsDeleted(1874576933)
                        .setFreedBytes(214271972);
