...
public final class Components1Fz7Dw2ResponsesActionsContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        Components1Fz7Dw2ResponsesActionsContentApplicationJsonSchemaAllof0 model =
                BinaryData.fromString(
                                "{\"actions\":[{\"id\":1419244382,\"status\":\"in-progress\",\"type\":\"wtnhxbnjbiksqr\",\"started_at\":\"2021-08-17T11:42:15Z\",\"completed_at\":\"2021-11-27T09:59:40Z\",\"resource_id\":1437691312,\"resource_type\":\"p\",\"region\":{\"name\":\"nzl\",\"slug\":\"jfm\",\"available\":false}}]}")
                        .toObject(Components1Fz7Dw2ResponsesActionsContentApplicationJsonSchemaAllof0.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-11-27T09:59:40Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        Components1Fz7Dw2ResponsesActionsContentApplicationJsonSchemaAllof0 model =
                new Components1Fz7Dw2ResponsesActionsContentApplicationJsonSchemaAllof0()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(1419244382)
                                                .setStatus(ActionStatus.IN_PROGRESS)
                                                .setType("wtnhxbnjbiksqr")
                                                .setStartedAt(OffsetDateTime.parse("2021-08-17T11:42:15Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-11-27T09:59:40Z"))
                                                .setResourceId(1437691312)
                                                .setResourceType("p")
                                                .setRegion(
                                                        new Region()
                                                                .setName("nzl")
