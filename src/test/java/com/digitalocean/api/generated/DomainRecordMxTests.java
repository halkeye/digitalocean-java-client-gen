...
public final class DomainRecordMxTests {
    ...
    public void testDeserialize() {
        DomainRecordMx model =
                BinaryData.fromString(
                                "{\"id\":1042017046,\"type\":\"s\",\"name\":\"iaieswhddzydi\",\"data\":\"uepy\",\"priority\":1970437533,\"port\":213451574,\"ttl\":1295638315,\"weight\":2079087223,\"flags\":1590298036,\"tag\":\"diiaocqibzji\"}")
                        .toObject(DomainRecordMx.class);
    ...
    public void testSerialize() {
        DomainRecordMx model =
                new DomainRecordMx()
                        .setType("s")
                        .setName("iaieswhddzydi")
                        .setData("uepy")
                        .setPriority(1970437533)
                        .setPort(213451574)
                        .setTtl(1295638315)
                        .setWeight(2079087223)
                        .setFlags(1590298036)
                        .setTag("diiaocqibzji");
