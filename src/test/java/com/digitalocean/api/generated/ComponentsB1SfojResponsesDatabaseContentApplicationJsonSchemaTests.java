...
public final class ComponentsB1SfojResponsesDatabaseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsB1SfojResponsesDatabaseContentApplicationJsonSchema model =
                BinaryData.fromString("{\"db\":{\"name\":\"djf\"}}")
                        .toObject(ComponentsB1SfojResponsesDatabaseContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsB1SfojResponsesDatabaseContentApplicationJsonSchema model =
                new ComponentsB1SfojResponsesDatabaseContentApplicationJsonSchema()
                        .setDb(new Database().setName("djf"));
        model =
