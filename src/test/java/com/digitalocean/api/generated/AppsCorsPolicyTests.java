...
public final class AppsCorsPolicyTests {
    ...
    public void testDeserialize() {
        AppsCorsPolicy model =
                BinaryData.fromString(
                                "{\"allow_origins\":[{\"exact\":\"azur\",\"prefix\":\"cbgoor\",\"regex\":\"eoybfhjxakvvjgs\"},{\"exact\":\"r\",\"prefix\":\"lmywwtkgkxnyed\",\"regex\":\"gyvudtjuewbc\"},{\"exact\":\"xuuwhcj\",\"prefix\":\"ccybvp\",\"regex\":\"akkud\"},{\"exact\":\"xgwjplmagstcyoh\",\"prefix\":\"kyrk\",\"regex\":\"dg\"}],\"allow_methods\":[\"sjkmnwqj\"],\"allow_headers\":[\"aiy\",\"ddviacegfnmntfpm\",\"memfnczdwvvbalxl\",\"lchpodbzevwrdn\"],\"expose_headers\":[\"kuvsjcswsm\"],\"max_age\":\"tuluq\",\"allow_credentials\":false}")
                        .toObject(AppsCorsPolicy.class);
                        ...
                        .setAllowOrigins(
                                Arrays.asList(
                                        new AppsStringMatch()
                                                .setExact("azur")
                                                .setPrefix("cbgoor")
                                                .setRegex("eoybfhjxakvvjgs"),
                                        new AppsStringMatch()
                                                .setExact("r")
                                                .setPrefix("lmywwtkgkxnyed")
                                                .setRegex("gyvudtjuewbc"),
                                        new AppsStringMatch().setExact("xuuwhcj").setPrefix("ccybvp").setRegex("akkud"),
                                        new AppsStringMatch()
                                                .setExact("xgwjplmagstcyoh")
                                                .setPrefix("kyrk")
                                                .setRegex("dg")))
                        .setAllowMethods(Arrays.asList("sjkmnwqj"))
                        .setAllowHeaders(Arrays.asList("aiy", "ddviacegfnmntfpm", "memfnczdwvvbalxl", "lchpodbzevwrdn"))
                        .setExposeHeaders(Arrays.asList("kuvsjcswsm"))
                        .setMaxAge("tuluq")
