...
public final class AppJobSpecTests {
    ...
    public void testSerialize() {
        AppJobSpec model =
                new AppJobSpec()
                        .setName("poaimlnwiaaomyl")
                        .setGit(new AppsGitSourceSpec().setBranch("z").setRepoCloneUrl("cse"))
                        .setGithub(
                                new AppsGithubSourceSpec()
                                        .setBranch("wnpjhlfzswpchwa")
                                        .setDeployOnPush(false)
                                        .setRepo("usnfepgfewet"))
                        .setGitlab(new AppsGitlabSourceSpec().setBranch("xgncxyk").setDeployOnPush(false).setRepo("h"))
                        .setImage(
                                new AppsImageSourceSpec()
                                        .setRegistry("mbcxfhbcp")
                                        .setRegistryType(AppsImageSourceSpecRegistryType.DOCKER_HUB)
                                        .setRepository("xcjzhqizxfpxt")
                                        .setTag("scjavftju"))
                        .setDockerfilePath("qaz")
                        .setBuildCommand("tgguwpijrajcivmm")
                        .setRunCommand("f")
                        .setSourceDir("iwrxgkn")
                        .setEnvs(
                                Arrays.asList(
                                        new AppVariableDefinition()
                                                ...
                                                .setValue("bpfgzdj")))
                        .setEnvironmentSlug("vzflbq")
                        .setLogDestinations(
                                new AppLogDestinationDefinition()
                                        .setName("aqvlgafcqusr")
                                        .setPapertrail(new AppLogDestinationPapertrailSpec().setEndpoint("etnwsdtutnw"))
                                        .setDatadog(
                                                new AppLogDestinationDatadogSpec()
                                                        .setEndpoint("ycvuzhyrmewipmv")
                                                        .setApiKey("k"))
                                        .setLogtail(new AppLogDestinationLogtailSpec().setToken("kuqgsjjxundxgket")))
                        .setKind(AppJobSpecKind.FAILED_DEPLOY)
                        .setInstanceCount(5505955768043549507L)
