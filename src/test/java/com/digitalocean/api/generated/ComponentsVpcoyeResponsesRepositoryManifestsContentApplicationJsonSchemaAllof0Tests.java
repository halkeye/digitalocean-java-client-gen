...
public final class ComponentsVpcoyeResponsesRepositoryManifestsContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        ComponentsVpcoyeResponsesRepositoryManifestsContentApplicationJsonSchemaAllof0 model =
                BinaryData.fromString(
                                "{\"manifests\":[{\"registry_name\":\"lxosgiht\",\"repository\":\"ueqb\",\"digest\":\"qfgvznjqswshe\",\"compressed_size_bytes\":998249084,\"size_bytes\":1308999133,\"updated_at\":\"2021-07-24T04:38:36Z\",\"tags\":[\"xlngouf\",\"izp\",\"mfxzspf\"],\"blobs\":[]}]}")
                        .toObject(ComponentsVpcoyeResponsesRepositoryManifestsContentApplicationJsonSchemaAllof0.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-07-24T04:38:36Z"), model.getManifests().get(0).getUpdatedAt());
    ...
    public void testSerialize() {
        ComponentsVpcoyeResponsesRepositoryManifestsContentApplicationJsonSchemaAllof0 model =
                new ComponentsVpcoyeResponsesRepositoryManifestsContentApplicationJsonSchemaAllof0()
                        .setManifests(
                                Arrays.asList(
                                        new RepositoryManifest()
                                                .setRegistryName("lxosgiht")
                                                .setRepository("ueqb")
                                                .setDigest("qfgvznjqswshe")
                                                .setCompressedSizeBytes(998249084)
                                                .setSizeBytes(1308999133)
                                                .setUpdatedAt(OffsetDateTime.parse("2021-07-24T04:38:36Z"))
                                                .setTags(Arrays.asList("xlngouf", "izp", "mfxzspf"))
