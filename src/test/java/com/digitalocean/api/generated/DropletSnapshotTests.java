...
public final class DropletSnapshotTests {
    ...
    public void testDeserialize() {
        DropletSnapshot model =
                BinaryData.fromString(
                                "{\"type\":\"backup\",\"name\":\"m\",\"created_at\":\"2021-04-09T03:39:28Z\",\"regions\":[\"jdrpizfulgycts\",\"btqgkujdsoox\"],\"min_disk_size\":1243480794,\"size_gigabytes\":1.56973}")
                        .toObject(DropletSnapshot.class);
    ...
    public void testSerialize() {
        DropletSnapshot model =
                new DropletSnapshot()
                        .setName("m")
                        .setCreatedAt(OffsetDateTime.parse("2021-04-09T03:39:28Z"))
                        .setRegions(Arrays.asList("jdrpizfulgycts", "btqgkujdsoox"))
                        .setMinDiskSize(1243480794)
                        .setSizeGigabytes(1.56973f)
