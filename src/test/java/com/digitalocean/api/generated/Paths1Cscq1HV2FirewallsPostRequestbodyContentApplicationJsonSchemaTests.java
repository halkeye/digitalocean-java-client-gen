...
public final class Paths1Cscq1HV2FirewallsPostRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Paths1Cscq1HV2FirewallsPostRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"id\":\"tnorwaigsioct\",\"status\":\"succeeded\",\"created_at\":\"2021-04-15T18:14:41Z\",\"pending_changes\":[{\"droplet_id\":1045792223,\"removing\":true,\"status\":\"f\"}],\"name\":\"jnwosst\",\"droplet_ids\":[615570355],\"inbound_rules\":[{\"sources\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"udp\",\"ports\":\"rr\"}],\"outbound_rules\":[{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"tcp\",\"ports\":\"hjmbji\"},{\"destinations\":{\"addresses\":[],\"droplet_ids\":[],\"load_balancer_uids\":[],\"kubernetes_ids\":[]},\"protocol\":\"icmp\",\"ports\":\"sohcwhpyvdkgd\"}]}")
                        .toObject(Paths1Cscq1HV2FirewallsPostRequestbodyContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Paths1Cscq1HV2FirewallsPostRequestbodyContentApplicationJsonSchema model =
                new Paths1Cscq1HV2FirewallsPostRequestbodyContentApplicationJsonSchema()
                        .setInboundRules(
                                Arrays.asList(
                                        ...
                                        new FirewallRulesOutboundRulesItem()
                                                ...
                                                .setDestinations(
                                                        new FirewallRulesOutboundRulesAllOfProperties()
                                                                ...
                                                                .setKubernetesIds(Arrays.asList()))))
                        .setName("jnwosst")
                        .setDropletIds(Arrays.asList(615570355));
        model =
