...
public final class ComponentsN31IopResponsesUpdatedClusterContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsN31IopResponsesUpdatedClusterContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"kubernetes_cluster\":{\"name\":\"ujybsrwz\",\"region\":\"mr\",\"version\":\"t\",\"cluster_subnet\":\"hmfppinmgi\",\"service_subnet\":\"smkw\",\"ipv4\":\"fragjhxerx\",\"endpoint\":\"bkdbtq\",\"tags\":[\"mniiqyholh\",\"nskbggicnqwl\",\"tmwpblxk\",\"kqgvxrktj\"],\"node_pools\":[{\"name\":\"cwt\",\"count\":1539742339,\"tags\":[],\"taints\":[],\"auto_scale\":false,\"min_nodes\":1618815780,\"max_nodes\":52591935,\"nodes\":[],\"size\":\"fp\"},{\"name\":\"d\",\"count\":1317989345,\"tags\":[],\"taints\":[],\"auto_scale\":false,\"min_nodes\":553712877,\"max_nodes\":1073521408,\"nodes\":[],\"size\":\"immrimaabsqqlonb\"},{\"name\":\"wcahdkmbjsmihr\",\"count\":1928815062,\"tags\":[],\"taints\":[],\"auto_scale\":false,\"min_nodes\":187514101,\"max_nodes\":2145710272,\"nodes\":[],\"size\":\"kvb\"}],\"maintenance_policy\":{\"start_time\":\"bsvbwyot\",\"duration\":\"nb\",\"day\":\"friday\"},\"auto_upgrade\":true,\"status\":{\"state\":\"error\",\"message\":\"xwc\"},\"created_at\":\"2021-06-28T00:32:03Z\",\"updated_at\":\"2021-09-29T08:54:58Z\",\"surge_upgrade\":true,\"ha\":false,\"registry_enabled\":true}}")
                        .toObject(ComponentsN31IopResponsesUpdatedClusterContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                MaintenancePolicyDay.FRIDAY, model.getKubernetesCluster().getMaintenancePolicy().getDay());
    ...
    public void testSerialize() {
        ComponentsN31IopResponsesUpdatedClusterContentApplicationJsonSchema model =
                new ComponentsN31IopResponsesUpdatedClusterContentApplicationJsonSchema()
                        .setKubernetesCluster(
                                new Cluster()
                                        .setName("ujybsrwz")
                                        .setRegion("mr")
                                        .setVersion("t")
                                        .setTags(Arrays.asList("mniiqyholh", "nskbggicnqwl", "tmwpblxk", "kqgvxrktj"))
                                        .setNodePools(
                                                Arrays.asList(
                                                        new KubernetesNodePool()
                                                                ...
                                                                .setAutoScale(false)
                                                                .setMinNodes(1618815780)
                                                                .setMaxNodes(52591935),
                                                        new KubernetesNodePool()
                                                                .setSize("immrimaabsqqlonb")
                                                                .setName("d")
                                                                .setCount(1317989345)
                                                                .setTags(Arrays.asList())
                                                                .setTaints(Arrays.asList())
                                                                .setAutoScale(false)
                                                                .setMinNodes(553712877)
                                                                .setMaxNodes(1073521408),
                                                        new KubernetesNodePool()
                                                                .setSize("kvb")
                                                                .setName("wcahdkmbjsmihr")
                                                                .setCount(1928815062)
                                                                .setTags(Arrays.asList())
                                                                .setTaints(Arrays.asList())
                                                                .setAutoScale(false)
                                                                .setMinNodes(187514101)
                                                                .setMaxNodes(2145710272)))
                                        .setMaintenancePolicy(
                                                new MaintenancePolicy()
                                                        .setStartTime("bsvbwyot")
                                                        .setDay(MaintenancePolicyDay.FRIDAY))
                                        .setAutoUpgrade(true)
