...
public final
class Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItemsTests {
    @Test
    public void testDeserialize() {
        Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems
                model =
                        BinaryData.fromString(
                                        "{\"eligible\":true,\"eligibility_reasons\":[\"OverStorageLimit\"],\"name\":\"qwbztilqbzbwb\",\"slug\":\"zhbhfl\",\"included_repositories\":1273666613,\"included_storage_bytes\":1203342325,\"allow_storage_overage\":true,\"included_bandwidth_bytes\":506949252,\"monthly_price_in_cents\":1646695807,\"storage_overage_price_in_cents\":1614061530}")
                                .toObject(
                                        Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems
                                                .class);
        ...
        Assertions.assertEquals(
                SubscriptionTierExtendedEligibilityReasonsItem.OVER_STORAGE_LIMIT,
        ...
        Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems
                model =
                        new Components1Vh7GehResponsesRegistryOptionsResponseContentApplicationJsonSchemaPropertiesOptionsPropertiesSubscriptionTiersItems()
                                .setName("qwbztilqbzbwb")
                                .setSlug("zhbhfl")
                                .setIncludedRepositories(1273666613)
                                .setIncludedStorageBytes(1203342325)
                                .setAllowStorageOverage(true)
                                .setIncludedBandwidthBytes(506949252)
                                .setMonthlyPriceInCents(1646695807)
                                .setStorageOveragePriceInCents(1614061530)
                                .setEligible(true)
