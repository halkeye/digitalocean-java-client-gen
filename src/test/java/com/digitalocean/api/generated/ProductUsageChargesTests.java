...
public final class ProductUsageChargesTests {
    ...
    public void testDeserialize() {
        ProductUsageCharges model =
                BinaryData.fromString(
                                "{\"name\":\"tqjfgxxsaet\",\"amount\":\"dgvpyig\",\"items\":[{\"amount\":\"ilzdcduwj\",\"name\":\"dxngucaif\",\"count\":\"urwwgilfjq\"}]}")
                        .toObject(ProductUsageCharges.class);
