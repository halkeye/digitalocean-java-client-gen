...
public final class FloatingIpCreatedApplicationJsonPropertiesTests {
    ...
    public void testDeserialize() {
        FloatingIpCreatedApplicationJsonProperties model =
                BinaryData.fromString(
                                "{\"droplets\":[{\"id\":1118769120,\"rel\":\"lvvkswurx\",\"href\":\"hvhauimnntfkqp\"},{\"id\":1796542988,\"rel\":\"bnwivlqcwyzhn\",\"href\":\"kzstzpzecdlc\"},{\"id\":170340264,\"rel\":\"aht\",\"href\":\"cimtcaumviud\"},{\"id\":990093995,\"rel\":\"qrmlujmtunl\",\"href\":\"wuzebfqvm\"}],\"actions\":[{\"id\":78518066,\"rel\":\"enfspetxeu\",\"href\":\"khdlckd\"}]}")
                        .toObject(FloatingIpCreatedApplicationJsonProperties.class);
                        ...
                        .setDroplets(
                                Arrays.asList(
                                        new ActionLink()
                                                .setId(1118769120)
                                                .setRel("lvvkswurx")
                                                .setHref("hvhauimnntfkqp"),
                                        new ActionLink()
                                                .setId(1796542988)
                                                .setRel("bnwivlqcwyzhn")
                                                .setHref("kzstzpzecdlc"),
                                        new ActionLink().setId(170340264).setRel("aht").setHref("cimtcaumviud"),
                                        new ActionLink().setId(990093995).setRel("qrmlujmtunl").setHref("wuzebfqvm")))
                        .setActions(
                                Arrays.asList(
                                        new ActionLink().setId(78518066).setRel("enfspetxeu").setHref("khdlckd")));
