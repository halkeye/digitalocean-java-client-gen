...
public final class AppsDeploymentsResponseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-04-28T18:22:28Z"), model.getDeployments().get(0).getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-02-09T06:58:59Z"), model.getDeployments().get(0).getPhaseLastUpdatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2020-12-20T06:52:39Z"), model.getDeployments().get(0).getUpdatedAt());
        Assertions.assertEquals(1099901211, model.getMeta().getTotal());
    }

    @Test
    public void testSerialize() {
        AppsDeploymentsResponse model = new AppsDeploymentsResponse().setLinks(new PageLinks()).setDeployments(Arrays.asList(new AppsDeployment().setCause("fcaabe").setClonedFrom("hbhlvbm").setCreatedAt(OffsetDateTime.parse("2021-04-28T18:22:28Z")).setId("bsxtkcudfbsfarfs").setJobs(Arrays.asList()).setFunctions(Arrays.asList()).setPhase(AppsDeploymentPhase.DEPLOYING).setPhaseLastUpdatedAt(OffsetDateTime.parse("2021-02-09T06:58:59Z")).setProgress(new AppsDeploymentProgress().setErrorSteps(1173279607).setPendingSteps(1994631745).setRunningSteps(1896459173).setSteps(Arrays.asList()).setSuccessSteps(970859098).setSummarySteps(Arrays.asList()).setTotalSteps(1864942425)).setServices(Arrays.asList()).setSpec(new AppSpec().setName("ksaoafcluqvox").setRegion(AppSpecRegion.AMS).setDomains(Arrays.asList()).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setJobs(Arrays.asList()).setWorkers(Arrays.asList()).setFunctions(Arrays.asList()).setDatabases(Arrays.asList())).setStaticSites(Arrays.asList()).setUpdatedAt(OffsetDateTime.parse("2020-12-20T06:52:39Z")).setWorkers(Arrays.asList()))).setMeta(new MetaMeta().setTotal(1099901211));
