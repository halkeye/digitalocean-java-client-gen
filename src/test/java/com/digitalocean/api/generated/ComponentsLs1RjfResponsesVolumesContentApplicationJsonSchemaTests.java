...
public final class ComponentsLs1RjfResponsesVolumesContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsLs1RjfResponsesVolumesContentApplicationJsonSchema model =
                new ComponentsLs1RjfResponsesVolumesContentApplicationJsonSchema()
                        .setVolumes(
                                Arrays.asList(
                                        new VolumeFull()
                                                .setName("vvoydwedggwg")
                                                .setDescription("vbwa")
                                                .setSizeGigabytes(2042529839)
                                                .setTags(Arrays.asList("i", "mzc", "niapypi"))
                                                .setFilesystemType("umkq")
                                                .setFilesystemLabel("zvptriysj"),
                                        new VolumeFull()
                                                .setName("j")
                                                .setDescription("mpwyv")
                                                .setSizeGigabytes(1740957154)
                                                .setTags(Arrays.asList("jgylsac", "giflr", "ygotoh", "wtoi"))
                                                .setFilesystemType("nytkmlfupjzc")
                                                .setFilesystemLabel("vzjoyxjgahxue")))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1118640339));
        model =
