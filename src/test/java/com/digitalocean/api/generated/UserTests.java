...
public final class UserTests {
    ...
    public void testDeserialize() {
        User model = BinaryData.fromString("{\"kubernetes_cluster_user\":{\"username\":\"ytdxmlynz\",\"groups\":[\"apbkrbuoggtdl\",\"lcuhaizi\",\"vaylz\",\"ohlpsftqkr\"]}}").toObject(User.class);
    ...
    public void testSerialize() {
        User model = new User().setKubernetesClusterUser(new UserKubernetesClusterUser().setUsername("ytdxmlynz").setGroups(Arrays.asList("apbkrbuoggtdl", "lcuhaizi", "vaylz", "ohlpsftqkr")));
