...
public final class Components1Utru1ASchemasLoadBalancerCreateOneof1Allof0Tests {
    ...
    public void testDeserialize() {
        Components1Utru1ASchemasLoadBalancerCreateOneof1Allof0 model = BinaryData.fromString("{\"tag\":\"uszxacdwukokgoo\"}").toObject(Components1Utru1ASchemasLoadBalancerCreateOneof1Allof0.class);
        Assertions.assertEquals("uszxacdwukokgoo", model.getTag());
    }

    @Test
    public void testSerialize() {
        Components1Utru1ASchemasLoadBalancerCreateOneof1Allof0 model = new Components1Utru1ASchemasLoadBalancerCreateOneof1Allof0().setTag("uszxacdwukokgoo");
