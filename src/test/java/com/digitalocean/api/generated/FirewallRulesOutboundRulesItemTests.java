...
public final class FirewallRulesOutboundRulesItemTests {
    ...
    public void testDeserialize() {
        FirewallRulesOutboundRulesItem model =
                BinaryData.fromString(
                                "{\"destinations\":{\"addresses\":[\"xvsc\"],\"droplet_ids\":[699693500,1422207579],\"load_balancer_uids\":[\"ky\",\"kgaf\",\"czvfcc\"],\"kubernetes_ids\":[\"twlety\",\"eszr\",\"lhpdhwynctaczcnj\"]},\"protocol\":\"icmp\",\"ports\":\"b\"}")
                        .toObject(FirewallRulesOutboundRulesItem.class);
                ...
                new FirewallRulesOutboundRulesItem()
                        ...
                        .setDestinations(
                                new FirewallRulesOutboundRulesAllOfProperties()
                                        .setAddresses(Arrays.asList("xvsc"))
                                        .setDropletIds(Arrays.asList(699693500, 1422207579))
                                        .setLoadBalancerUids(Arrays.asList("ky", "kgaf", "czvfcc"))
                                        .setKubernetesIds(Arrays.asList("twlety", "eszr", "lhpdhwynctaczcnj")));
