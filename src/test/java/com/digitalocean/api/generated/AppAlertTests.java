...
public final class AppAlertTests {
    ...
    public void testDeserialize() {
        AppAlert model = BinaryData.fromString("{\"id\":\"oytehqpuvjm\",\"component_name\":\"mtdwcky\",\"spec\":{\"rule\":\"FUNCTIONS_ERROR_RATE_PER_MINUTE\",\"disabled\":false,\"operator\":\"LESS_THAN\",\"value\":35.76125,\"window\":\"THIRTY_MINUTES\"},\"emails\":[\"kb\",\"req\",\"n\"],\"slack_webhooks\":[{\"url\":\"sfaq\",\"channel\":\"pl\"},{\"url\":\"ysh\",\"channel\":\"d\"},{\"url\":\"bxgkqusy\",\"channel\":\"ptdacarvvl\"}],\"phase\":\"ERROR\",\"progress\":{\"steps\":[{\"name\":\"oiwenazerohzrsq\",\"status\":\"ERROR\",\"started_at\":\"2020-12-24T05:18:03Z\",\"ended_at\":\"2021-09-29T20:04:11Z\"}]}}").toObject(AppAlert.class);
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2020-12-24T05:18:03Z"), model.getProgress().getSteps().get(0).getStartedAt());
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-29T20:04:11Z"), model.getProgress().getSteps().get(0).getEndedAt());
    }

    @Test
    public void testSerialize() {
        AppAlert model = new AppAlert().setComponentName("mtdwcky").setSpec(new AppAlertSpec().setRule(AppAlertSpecRule.FUNCTIONS_ERROR_RATE_PERMINUTE).setDisabled(false).setOperator(AppAlertSpecOperator.LESS_THAN).setValue(35.76125F).setWindow(AppAlertSpecWindow.THIRTY_MINUTES)).setEmails(Arrays.asList("kb", "req", "n")).setSlackWebhooks(Arrays.asList(new AppAlertSlackWebhook().setUrl("sfaq").setChannel("pl"), new AppAlertSlackWebhook().setUrl("ysh").setChannel("d"), new AppAlertSlackWebhook().setUrl("bxgkqusy").setChannel("ptdacarvvl"))).setPhase(AppAlertPhase.ERROR).setProgress(new AppAlertProgress().setSteps(Arrays.asList(new AppAlertProgressStep().setName("oiwenazerohzrsq").setStatus(AppAlertProgressStepStatus.ERROR).setStartedAt(OffsetDateTime.parse("2020-12-24T05:18:03Z")).setEndedAt(OffsetDateTime.parse("2021-09-29T20:04:11Z")))));
