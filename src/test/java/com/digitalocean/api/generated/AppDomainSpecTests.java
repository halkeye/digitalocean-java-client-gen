...
public final class AppDomainSpecTests {
    ...
    public void testDeserialize() {
        AppDomainSpec model = BinaryData.fromString("{\"domain\":\"fgslqubkwdl\",\"type\":\"UNSPECIFIED\",\"wildcard\":false,\"zone\":\"tujbazpju\",\"minimum_tls_version\":\"1.3\"}").toObject(AppDomainSpec.class);
    ...
    public void testSerialize() {
        AppDomainSpec model = new AppDomainSpec().setDomain("fgslqubkwdl").setType(AppDomainSpecType.UNSPECIFIED).setWildcard(false).setZone("tujbazpju").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE3);
