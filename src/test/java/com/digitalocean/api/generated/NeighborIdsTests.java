...
public final class NeighborIdsTests {
    ...
    public void testDeserialize() {
        NeighborIds model =
                BinaryData.fromString("{\"neighbor_ids\":[[707987603,1784459849,162803375,1822413913]]}")
                        .toObject(NeighborIds.class);
    ...
    public void testSerialize() {
        NeighborIds model =
                new NeighborIds()
                        .setNeighborIds(Arrays.asList(Arrays.asList(707987603, 1784459849, 162803375, 1822413913)));
