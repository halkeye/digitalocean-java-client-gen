...
public final class Components1UmkrblResponsesProjectsListContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        Components1UmkrblResponsesProjectsListContentApplicationJsonSchema model =
                new Components1UmkrblResponsesProjectsListContentApplicationJsonSchema()
                        .setProjects(
                                Arrays.asList(
                                        new Project()
                                                .setName("vguy")
                                                .setDescription("nxelrjkfzcde")
                                                .setPurpose("wwezhyfkdilb")
                                                .setEnvironment(ProjectBaseEnvironment.DEVELOPMENT)
                                                .setIsDefault(true),
                                        new Project()
                                                .setName("odnjyhzfaxskdv")
                                                .setDescription("lumodpegqxsorc")
                                                .setPurpose("zrqoxzyhlbeqvh")
                                                .setEnvironment(ProjectBaseEnvironment.STAGING)
                                                .setIsDefault(false),
                                        new Project()
                                                .setName("ibuydwiurnicu")
                                                .setDescription("y")
                                                .setPurpose("qmiuvjpl")
                                                .setEnvironment(ProjectBaseEnvironment.STAGING)
                                                .setIsDefault(true),
                                        new Project()
                                                .setName("exhnkingi")
                                                .setDescription("dolrpgup")
                                                .setPurpose("lbsm")
                                                .setEnvironment(ProjectBaseEnvironment.STAGING)
                                                .setIsDefault(true)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(125308373));
        model =
