...
public final class KubernetesOptionsOptionsTests {
    ...
    public void testSerialize() {
        KubernetesOptionsOptions model =
                new KubernetesOptionsOptions()
                        .setRegions(
                                Arrays.asList(
                                        new KubernetesRegion().setName("vwryvd").setSlug("kiikgpruccwmecbt"),
                                        new KubernetesRegion().setName("ytrtexegwmrq").setSlug("wi"),
                                        new KubernetesRegion().setName("vycfjncindi").setSlug("q")))
                        .setVersions(
                                Arrays.asList(
                                        new KubernetesVersion()
                                                .setSlug("juriarsbcl")
                                                .setKubernetesVersion("nhzcknjxizb")
                                                .setSupportedFeatures(
                                                        Arrays.asList(
                                                                "ygzkztxfexwacyy", "mlxppdndzkfevuii", "iib", "kcj")),
                                        new KubernetesVersion()
                                                .setSlug("qdcizeqqfopvnopm")
                                                .setKubernetesVersion("ds")
                                                .setSupportedFeatures(Arrays.asList("xqlyoazyfbkmvl")),
                                        new KubernetesVersion()
                                                .setSlug("mxojzsvmaigbqk")
                                                .setKubernetesVersion("yejthgeecb")
                                                .setSupportedFeatures(Arrays.asList("gwlckihbamyqs", "kknpugzjw"))))
                        .setSizes(
                                Arrays.asList(
                                        new KubernetesSize().setName("rjixiujzkcsexg").setSlug("sw"),
                                        new KubernetesSize().setName("ykkbxktxbbwl").setSlug("wzoknvu"),
                                        new KubernetesSize().setName("d").setSlug("gbq")));
