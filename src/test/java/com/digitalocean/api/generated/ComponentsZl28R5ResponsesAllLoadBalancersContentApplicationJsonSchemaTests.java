...
public final class ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchema model = BinaryData.fromString("{\"links\":{},\"meta\":{\"total\":1504015182},\"load_balancers\":[{\"tag\":\"qxtoiyygktsrjyxx\",\"name\":\"fzbkvec\",\"ip\":\"fxphsowbebsnbwut\",\"size_unit\":1167734194,\"size\":\"lb-medium\",\"algorithm\":\"round_robin\",\"status\":\"active\",\"created_at\":\"2021-08-04T02:13:04Z\",\"forwarding_rules\":[],\"health_check\":{\"protocol\":\"https\",\"port\":1474193251,\"path\":\"jajvkyxmmjczvo\",\"check_interval_seconds\":186095639,\"response_timeout_seconds\":1337388892,\"unhealthy_threshold\":999951623,\"healthy_threshold\":1626752894},\"sticky_sessions\":{\"type\":\"none\",\"cookie_name\":\"e\",\"cookie_ttl_seconds\":1826638704},\"redirect_http_to_https\":true,\"enable_proxy_protocol\":false,\"enable_backend_keepalive\":true,\"disable_lets_encrypt_dns_records\":true}]}").toObject(ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(1337388892, model.getLoadBalancers().get(0).getHealthCheck().getResponseTimeoutSeconds());
    ...
    public void testSerialize() {
        ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchema model = new ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchema().setLoadBalancers(Arrays.asList(new LoadBalancer().setName("fzbkvec").setSizeUnit(1167734194).setSize(LoadBalancerBaseSize.LB_MEDIUM).setAlgorithm(LoadBalancerBaseAlgorithm.ROUND_ROBIN).setForwardingRules(Arrays.asList()).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.HTTPS).setPort(1474193251).setPath("jajvkyxmmjczvo").setCheckIntervalSeconds(186095639).setResponseTimeoutSeconds(1337388892).setUnhealthyThreshold(999951623).setHealthyThreshold(1626752894)).setStickySessions(new StickySessions().setType(StickySessionsType.NONE).setCookieName("e").setCookieTtlSeconds(1826638704)).setRedirectHttpToHttps(true).setEnableProxyProtocol(false).setEnableBackendKeepalive(true).setDisableLetsEncryptDnsRecords(true).setTag("qxtoiyygktsrjyxx"))).setLinks(new PageLinks()).setMeta(new MetaMeta().setTotal(1504015182));
        model = BinaryData.fromObject(model).toObject(ComponentsZl28R5ResponsesAllLoadBalancersContentApplicationJsonSchema.class);
        Assertions.assertEquals("fzbkvec", model.getLoadBalancers().get(0).getName());
        Assertions.assertEquals(1167734194, model.getLoadBalancers().get(0).getSizeUnit());
        Assertions.assertEquals(LoadBalancerBaseSize.LB_MEDIUM, model.getLoadBalancers().get(0).getSize());
        Assertions.assertEquals(LoadBalancerBaseAlgorithm.ROUND_ROBIN, model.getLoadBalancers().get(0).getAlgorithm());
