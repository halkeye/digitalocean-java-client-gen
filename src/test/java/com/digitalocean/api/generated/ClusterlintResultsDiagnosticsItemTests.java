...
public final class ClusterlintResultsDiagnosticsItemTests {
    ...
    public void testDeserialize() {
        ClusterlintResultsDiagnosticsItem model =
                BinaryData.fromString(
                                "{\"check_name\":\"hmpmhef\",\"severity\":\"aphqeofytl\",\"message\":\"lowmcm\",\"object\":{\"name\":\"xuanccqvjfdgfq\",\"kind\":\"quxpjhcfaara\",\"namespace\":\"iovmufzgugrblwal\"}}")
                        .toObject(ClusterlintResultsDiagnosticsItem.class);
    ...
    public void testSerialize() {
        ClusterlintResultsDiagnosticsItem model =
                new ClusterlintResultsDiagnosticsItem()
                        .setCheckName("hmpmhef")
                        .setSeverity("aphqeofytl")
                        .setMessage("lowmcm")
                        .setObject(
                                new ClusterlintResultsDiagnosticsItemObject()
                                        .setName("xuanccqvjfdgfq")
                                        .setKind("quxpjhcfaara")
                                        .setNamespace("iovmufzgugrblwal"));
