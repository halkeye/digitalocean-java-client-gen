...
public final class Components11RtrfgResponsesExistingVpcContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components11RtrfgResponsesExistingVpcContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"vpc\":{\"region\":\"neli\",\"ip_range\":\"tibtkqjqjcaj\",\"default\":true,\"urn\":\"khhk\",\"created_at\":\"2021-05-12T08:19:46Z\",\"name\":\"kxeojtdyulglhel\",\"description\":\"uklfqfxspxgogy\"}}")
                        .toObject(Components11RtrfgResponsesExistingVpcContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components11RtrfgResponsesExistingVpcContentApplicationJsonSchema model =
                new Components11RtrfgResponsesExistingVpcContentApplicationJsonSchema()
                        .setVpc(
                                new Vpc()
                                        .setName("kxeojtdyulglhel")
                                        .setDescription("uklfqfxspxgogy")
                                        .setRegion("neli")
                                        .setIpRange("tibtkqjqjcaj")
