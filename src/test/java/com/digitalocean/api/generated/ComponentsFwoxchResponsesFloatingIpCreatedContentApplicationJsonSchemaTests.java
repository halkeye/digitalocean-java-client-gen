...
public final class ComponentsFwoxchResponsesFloatingIpCreatedContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsFwoxchResponsesFloatingIpCreatedContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"floating_ip\":{\"ip\":\"sesboynpytporr\",\"region\":{\"name\":\"xtfctanetinqxdhn\",\"slug\":\"jne\",\"available\":false},\"locked\":true},\"links\":{\"droplets\":[{\"id\":999286702,\"rel\":\"mrzwvwetqffux\",\"href\":\"huqhngqq\"},{\"id\":1440809986,\"rel\":\"o\",\"href\":\"clmr\"}],\"actions\":[{\"id\":2108091407,\"rel\":\"eatwxpxb\",\"href\":\"dhxbboceksramqc\"}]}}")
                        .toObject(ComponentsFwoxchResponsesFloatingIpCreatedContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsFwoxchResponsesFloatingIpCreatedContentApplicationJsonSchema model =
                new ComponentsFwoxchResponsesFloatingIpCreatedContentApplicationJsonSchema()
                        .setFloatingIp(
                                new FloatingIp()
                                        .setIp("sesboynpytporr")
                                        .setRegion(
                                                new FloatingIpRegion()
                                                        .setName("xtfctanetinqxdhn")
                                                        .setSlug("jne")
                                                        .setAvailable(false))
                                        .setLocked(true))
                        .setLinks(
                                new FloatingIpCreatedApplicationJsonProperties()
                                        .setDroplets(
                                                Arrays.asList(
                                                        new ActionLink()
                                                                .setId(999286702)
                                                                .setRel("mrzwvwetqffux")
                                                                .setHref("huqhngqq"),
                                                        new ActionLink().setId(1440809986).setRel("o").setHref("clmr")))
                                        .setActions(
                                                Arrays.asList(
                                                        new ActionLink()
                                                                .setId(2108091407)
                                                                .setRel("eatwxpxb")
                                                                .setHref("dhxbboceksramqc"))));
        model =
