...
public final class DomainRecordNsTests {
    ...
    public void testDeserialize() {
        DomainRecordNs model = BinaryData.fromString("{\"id\":331811785,\"type\":\"ebiphryvcjwqwoq\",\"name\":\"atjhdhzybspijhf\",\"data\":\"gdkkagvwukh\",\"priority\":136799145,\"port\":410918688,\"ttl\":239027728,\"weight\":713274939,\"flags\":1320194875,\"tag\":\"ilz\"}").toObject(DomainRecordNs.class);
    ...
    public void testSerialize() {
        DomainRecordNs model = new DomainRecordNs().setType("ebiphryvcjwqwoq").setName("atjhdhzybspijhf").setData("gdkkagvwukh").setPriority(136799145).setPort(410918688).setTtl(239027728).setWeight(713274939).setFlags(1320194875).setTag("ilz");
