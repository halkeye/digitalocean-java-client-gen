...
public final class DatabaseReplicaConnectionTests {
    ...
    public void testDeserialize() {
        DatabaseReplicaConnection model = BinaryData.fromString("{\"uri\":\"wl\",\"database\":\"rcigtzjcvbxq\",\"host\":\"psnssovyxp\",\"port\":632493022,\"user\":\"nievwffc\",\"password\":\"yezslpu\",\"ssl\":true}").toObject(DatabaseReplicaConnection.class);
    }
