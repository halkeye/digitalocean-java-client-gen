...
public final class AppsListAlertsResponseTests {
    ...
    public void testDeserialize() {
        AppsListAlertsResponse model =
                BinaryData.fromString(
                                "{\"alerts\":[{\"id\":\"a\",\"component_name\":\"d\",\"spec\":{\"rule\":\"MEM_UTILIZATION\",\"disabled\":true,\"operator\":\"LESS_THAN\",\"value\":32.852657,\"window\":\"ONE_HOUR\"},\"emails\":[\"sch\",\"cgqyhleseyq\",\"hvyeldotj\"],\"slack_webhooks\":[],\"phase\":\"CONFIGURING\",\"progress\":{\"steps\":[]}},{\"id\":\"kukjtasb\",\"component_name\":\"ispkxkdtx\",\"spec\":{\"rule\":\"FUNCTIONS_GB_RATE_PER_SECOND\",\"disabled\":true,\"operator\":\"GREATER_THAN\",\"value\":81.96614,\"window\":\"ONE_HOUR\"},\"emails\":[\"mb\",\"gtywatmqaqkue\",\"tgroesh\",\"ygzc\"],\"slack_webhooks\":[],\"phase\":\"ACTIVE\",\"progress\":{\"steps\":[]}}]}")
                        .toObject(AppsListAlertsResponse.class);
                        ...
                        .setAlerts(
                                Arrays.asList(
                                        new AppAlert()
                                                ...
                                                .setSpec(
                                                        new AppAlertSpec()
                                                                .setRule(AppAlertSpecRule.MEMUTILIZATION)
                                                                .setDisabled(true)
                                                                .setOperator(AppAlertSpecOperator.LESS_THAN)
                                                                .setValue(32.852657F)
                                                                .setWindow(AppAlertSpecWindow.ONEHOUR))
                                                .setEmails(Arrays.asList("sch", "cgqyhleseyq", "hvyeldotj"))
                                                .setSlackWebhooks(Arrays.asList())
                                                .setPhase(AppAlertPhase.CONFIGURING)
                                                .setProgress(new AppAlertProgress().setSteps(Arrays.asList())),
                                        new AppAlert()
                                                .setComponentName("ispkxkdtx")
                                                .setSpec(
                                                        new AppAlertSpec()
                                                                ...
                                                                .setValue(81.96614F)
                                                                .setWindow(AppAlertSpecWindow.ONEHOUR))
                                                .setEmails(Arrays.asList("mb", "gtywatmqaqkue", "tgroesh", "ygzc"))
                                                .setSlackWebhooks(Arrays.asList())
                                                .setPhase(AppAlertPhase.ACTIVE)
                                                .setProgress(new AppAlertProgress().setSteps(Arrays.asList()))));
