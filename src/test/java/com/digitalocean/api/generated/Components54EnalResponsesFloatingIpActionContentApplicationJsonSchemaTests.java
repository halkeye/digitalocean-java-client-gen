...
public final class Components54EnalResponsesFloatingIpActionContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components54EnalResponsesFloatingIpActionContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"action\":{\"id\":773330116,\"status\":\"in-progress\",\"type\":\"mkdhwqcqweba\",\"started_at\":\"2021-08-27T16:53:34Z\",\"completed_at\":\"2021-03-10T20:23:37Z\",\"resource_id\":581179024,\"resource_type\":\"ujeucosvkkeer\",\"region\":{\"name\":\"ypaxpjp\",\"slug\":\"illgnu\",\"available\":true}}}")
                        .toObject(Components54EnalResponsesFloatingIpActionContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components54EnalResponsesFloatingIpActionContentApplicationJsonSchema model =
                new Components54EnalResponsesFloatingIpActionContentApplicationJsonSchema()
                        .setAction(
                                new Action()
                                        .setId(773330116)
                                        .setStatus(ActionStatus.IN_PROGRESS)
                                        .setType("mkdhwqcqweba")
                                        .setStartedAt(OffsetDateTime.parse("2021-08-27T16:53:34Z"))
                                        .setCompletedAt(OffsetDateTime.parse("2021-03-10T20:23:37Z"))
                                        .setResourceId(581179024)
                                        .setResourceType("ujeucosvkkeer")
                                        .setRegion(
                                                new Region().setName("ypaxpjp").setSlug("illgnu").setAvailable(true)));
        model =
