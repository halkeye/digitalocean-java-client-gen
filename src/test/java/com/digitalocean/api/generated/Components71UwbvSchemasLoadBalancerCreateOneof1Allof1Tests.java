...
public final class Components71UwbvSchemasLoadBalancerCreateOneof1Allof1Tests {
    ...
    public void testDeserialize() {
        Components71UwbvSchemasLoadBalancerCreateOneof1Allof1 model =
                BinaryData.fromString("{\"region\":\"sfo3\"}")
                        .toObject(Components71UwbvSchemasLoadBalancerCreateOneof1Allof1.class);
    ...
    public void testSerialize() {
        Components71UwbvSchemasLoadBalancerCreateOneof1Allof1 model =
                new Components71UwbvSchemasLoadBalancerCreateOneof1Allof1().setRegion(RegionSlug.SFO3);
