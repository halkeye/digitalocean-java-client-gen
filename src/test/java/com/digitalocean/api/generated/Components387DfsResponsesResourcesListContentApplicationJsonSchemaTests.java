...
public final class Components387DfsResponsesResourcesListContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components387DfsResponsesResourcesListContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":88448219},\"resources\":[{\"urn\":\"skh\",\"assigned_at\":\"2021-08-04T18:01:56Z\",\"links\":{\"self\":\"ykrsm\"},\"status\":\"not_found\"}]}")
                        .toObject(Components387DfsResponsesResourcesListContentApplicationJsonSchema.class);
        Assertions.assertEquals("skh", model.getResources().get(0).getUrn());
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-08-04T18:01:56Z"), model.getResources().get(0).getAssignedAt());
    ...
    public void testSerialize() {
        Components387DfsResponsesResourcesListContentApplicationJsonSchema model =
                new Components387DfsResponsesResourcesListContentApplicationJsonSchema()
                        .setResources(
                                Arrays.asList(
                                        new Resource()
                                                .setUrn("skh")
                                                .setAssignedAt(OffsetDateTime.parse("2021-08-04T18:01:56Z"))
                                                .setLinks(new ResourceLinks().setSelf("ykrsm"))
                                                .setStatus(ResourceStatus.NOT_FOUND)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(88448219));
        model =
