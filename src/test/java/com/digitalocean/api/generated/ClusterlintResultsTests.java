...
public final class ClusterlintResultsTests {
    ...
    public void testDeserialize() {
        ClusterlintResults model = BinaryData.fromString("{\"run_id\":\"cqksaaapxjh\",\"requested_at\":\"2021-08-15T21:30:36Z\",\"completed_at\":\"2020-12-24T02:07:16Z\",\"diagnostics\":[{\"check_name\":\"sdfpvdaahlf\",\"severity\":\"qklpmvzp\",\"message\":\"eszyaqgomlbmfgge\",\"object\":{\"name\":\"e\",\"kind\":\"jjl\",\"namespace\":\"yeahhhutpulnrfcq\"}},{\"check_name\":\"m\",\"severity\":\"hpi\",\"message\":\"wrerj\",\"object\":{\"name\":\"tchdw\",\"kind\":\"qid\",\"namespace\":\"mlgbbfjmdgjv\"}}]}").toObject(ClusterlintResults.class);
    ...
    public void testSerialize() {
        ClusterlintResults model = new ClusterlintResults().setRunId("cqksaaapxjh").setRequestedAt(OffsetDateTime.parse("2021-08-15T21:30:36Z")).setCompletedAt(OffsetDateTime.parse("2020-12-24T02:07:16Z")).setDiagnostics(Arrays.asList(new ClusterlintResultsDiagnosticsItem().setCheckName("sdfpvdaahlf").setSeverity("qklpmvzp").setMessage("eszyaqgomlbmfgge").setObject(new ClusterlintResultsDiagnosticsItemObject().setName("e").setKind("jjl").setNamespace("yeahhhutpulnrfcq")), new ClusterlintResultsDiagnosticsItem().setCheckName("m").setSeverity("hpi").setMessage("wrerj").setObject(new ClusterlintResultsDiagnosticsItemObject().setName("tchdw").setKind("qid").setNamespace("mlgbbfjmdgjv"))));
