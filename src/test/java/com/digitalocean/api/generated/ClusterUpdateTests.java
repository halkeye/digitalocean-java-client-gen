...
public final class ClusterUpdateTests {
    ...
    public void testDeserialize() {
        ClusterUpdate model = BinaryData.fromString("{\"name\":\"ofmex\",\"tags\":[\"mas\",\"manydscdkxwdpw\",\"cbhaah\"],\"maintenance_policy\":{\"start_time\":\"felfh\",\"duration\":\"ixo\",\"day\":\"tuesday\"},\"auto_upgrade\":true,\"surge_upgrade\":false}").toObject(ClusterUpdate.class);
    ...
    public void testSerialize() {
        ClusterUpdate model = new ClusterUpdate().setName("ofmex").setTags(Arrays.asList("mas", "manydscdkxwdpw", "cbhaah")).setMaintenancePolicy(new MaintenancePolicy().setStartTime("felfh").setDay(MaintenancePolicyDay.TUESDAY)).setAutoUpgrade(true).setSurgeUpgrade(false);
