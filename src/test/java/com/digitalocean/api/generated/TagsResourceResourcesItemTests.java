...
public final class TagsResourceResourcesItemTests {
    ...
    public void testDeserialize() {
        TagsResourceResourcesItem model = BinaryData.fromString("{\"resource_id\":\"pjcxbjgfm\",\"resource_type\":\"droplet\"}").toObject(TagsResourceResourcesItem.class);
    ...
    public void testSerialize() {
        TagsResourceResourcesItem model = new TagsResourceResourcesItem().setResourceId("pjcxbjgfm").setResourceType(TagsResourceResourcesItemResourceType.DROPLET);
