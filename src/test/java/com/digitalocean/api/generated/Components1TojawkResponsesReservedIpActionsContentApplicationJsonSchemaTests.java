...
public final class Components1TojawkResponsesReservedIpActionsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1TojawkResponsesReservedIpActionsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":244418639},\"actions\":[{\"id\":896661587,\"status\":\"completed\",\"type\":\"x\",\"started_at\":\"2021-05-14T06:19:55Z\",\"completed_at\":\"2021-06-03T18:02:41Z\",\"resource_id\":1928136431,\"resource_type\":\"pksywicklktgkdp\",\"region\":{\"name\":\"qj\",\"slug\":\"tdcf\",\"available\":true}},{\"id\":571263434,\"status\":\"errored\",\"type\":\"vjsbgmlamoaxc\",\"started_at\":\"2021-09-15T15:44Z\",\"completed_at\":\"2020-12-20T00:28:57Z\",\"resource_id\":1148311029,\"resource_type\":\"pbltc\",\"region\":{\"name\":\"exheeocnqo\",\"slug\":\"bvepvlryszfhd\",\"available\":true}}]}")
                        .toObject(Components1TojawkResponsesReservedIpActionsContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-06-03T18:02:41Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        Components1TojawkResponsesReservedIpActionsContentApplicationJsonSchema model =
                new Components1TojawkResponsesReservedIpActionsContentApplicationJsonSchema()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(896661587)
                                                ...
                                                .setType("x")
                                                .setStartedAt(OffsetDateTime.parse("2021-05-14T06:19:55Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-06-03T18:02:41Z"))
                                                .setResourceId(1928136431)
                                                .setResourceType("pksywicklktgkdp")
                                                .setRegion(
                                                        new Region().setName("qj").setSlug("tdcf").setAvailable(true)),
                                        new Action()
                                                .setId(571263434)
                                                .setStatus(ActionStatus.ERRORED)
                                                .setType("vjsbgmlamoaxc")
                                                .setStartedAt(OffsetDateTime.parse("2021-09-15T15:44Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2020-12-20T00:28:57Z"))
                                                .setResourceId(1148311029)
                                                .setResourceType("pbltc")
                                                .setRegion(
                                                        new Region()
                                                                .setName("exheeocnqo")
                                                                .setSlug("bvepvlryszfhd")
                                                                .setAvailable(true))))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(244418639));
        model =
