...
public final class ComponentsHbo49GSchemasTagsPropertiesResourcesAllof1Tests {
    ...
    public void testDeserialize() {
        ComponentsHbo49GSchemasTagsPropertiesResourcesAllof1 model =
                BinaryData.fromString(
                                "{\"droplets\":{\"count\":2069188464,\"last_tagged_uri\":\"ifdyfaoex\"},\"imgages\":{\"count\":1169202881,\"last_tagged_uri\":\"rd\"},\"volumes\":{\"count\":1361978410,\"last_tagged_uri\":\"ihsujtg\"},\"volume_snapshots\":{\"count\":794612499,\"last_tagged_uri\":\"am\"},\"databases\":{\"count\":1546437070,\"last_tagged_uri\":\"pdcliqwzutiyelrn\"}}")
                        .toObject(ComponentsHbo49GSchemasTagsPropertiesResourcesAllof1.class);
    ...
    public void testSerialize() {
        ComponentsHbo49GSchemasTagsPropertiesResourcesAllof1 model =
                new ComponentsHbo49GSchemasTagsPropertiesResourcesAllof1()
                        .setDroplets(new TagsMetadata().setCount(2069188464).setLastTaggedUri("ifdyfaoex"))
                        .setImgages(new TagsMetadata().setCount(1169202881).setLastTaggedUri("rd"))
                        .setVolumes(new TagsMetadata().setCount(1361978410).setLastTaggedUri("ihsujtg"))
                        .setVolumeSnapshots(new TagsMetadata().setCount(794612499).setLastTaggedUri("am"))
                        .setDatabases(new TagsMetadata().setCount(1546437070).setLastTaggedUri("pdcliqwzutiyelrn"));
