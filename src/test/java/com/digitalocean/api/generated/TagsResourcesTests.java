...
public final class TagsResourcesTests {
    ...
    public void testDeserialize() {
        TagsResources model =
                BinaryData.fromString(
                                "{\"droplets\":{\"count\":2029108862,\"last_tagged_uri\":\"fhrmtenfdvdoe\"},\"imgages\":{\"count\":115903449,\"last_tagged_uri\":\"srjzhdtrsyfezfs\"},\"volumes\":{\"count\":1001675218,\"last_tagged_uri\":\"zyyrwnmwtqiljknn\"},\"volume_snapshots\":{\"count\":99976059,\"last_tagged_uri\":\"tdt\"},\"databases\":{\"count\":936362951,\"last_tagged_uri\":\"phfxaq\"},\"count\":1440744289,\"last_tagged_uri\":\"jcwwvaosckf\"}")
                        .toObject(TagsResources.class);
    ...
    public void testSerialize() {
        TagsResources model =
                new TagsResources()
                        .setCount(1440744289)
                        .setLastTaggedUri("jcwwvaosckf")
                        .setDroplets(new TagsMetadata().setCount(2029108862).setLastTaggedUri("fhrmtenfdvdoe"))
                        .setImgages(new TagsMetadata().setCount(115903449).setLastTaggedUri("srjzhdtrsyfezfs"))
                        .setVolumes(new TagsMetadata().setCount(1001675218).setLastTaggedUri("zyyrwnmwtqiljknn"))
                        .setVolumeSnapshots(new TagsMetadata().setCount(99976059).setLastTaggedUri("tdt"))
                        .setDatabases(new TagsMetadata().setCount(936362951).setLastTaggedUri("phfxaq"));
