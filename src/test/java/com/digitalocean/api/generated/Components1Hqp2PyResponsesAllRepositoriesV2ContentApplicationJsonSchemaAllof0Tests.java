...
public final class Components1Hqp2PyResponsesAllRepositoriesV2ContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                1837408279, model.getRepositories().get(0).getLatestManifest().getCompressedSizeBytes());
        Assertions.assertEquals(360005173, model.getRepositories().get(0).getLatestManifest().getSizeBytes());
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-10-26T16:13:24Z"),
    ...
    public void testSerialize() {
        Components1Hqp2PyResponsesAllRepositoriesV2ContentApplicationJsonSchemaAllof0 model =
                new Components1Hqp2PyResponsesAllRepositoriesV2ContentApplicationJsonSchemaAllof0()
                        .setRepositories(
                                Arrays.asList(
                                        new RepositoryV2()
                                                .setRegistryName("rmdtacntjnaffhv")
                                                .setName("ia")
                                                .setLatestManifest(
                                                        new RepositoryManifest()
                                                                ...
                                                                .setRepository("fku")
                                                                .setDigest("kmxhhqsx")
                                                                .setCompressedSizeBytes(1837408279)
                                                                .setSizeBytes(360005173)
                                                                .setUpdatedAt(
                                                                        OffsetDateTime.parse("2021-10-26T16:13:24Z"))
                                                                .setTags(Arrays.asList())
                                                                .setBlobs(Arrays.asList()))
                                                .setTagCount(1123699666)
                                                .setManifestCount(45686585),
                                        new RepositoryV2()
                                                .setRegistryName("efeclflxcj")
                                                .setName("zwncvdefxonz")
                                                .setLatestManifest(
                                                        new RepositoryManifest()
                                                                .setRegistryName("jptnnt")
                                                                .setRepository("cjqpzjvnpjr")
                                                                .setDigest("pgsjbioagwviqehm")
                                                                .setCompressedSizeBytes(1720561500)
                                                                .setSizeBytes(1313379393)
                                                                .setUpdatedAt(
                                                                        OffsetDateTime.parse("2021-11-25T22:30:45Z"))
                                                                .setTags(Arrays.asList())
                                                                .setBlobs(Arrays.asList()))
                                                .setTagCount(1340180227)
                                                .setManifestCount(1547198289),
                                        new RepositoryV2()
                                                .setRegistryName("k")
                                                .setName("imbr")
                                                .setLatestManifest(
                                                        new RepositoryManifest()
                                                                .setRegistryName("phtjnh")
                                                                .setRepository("jl")
                                                                .setDigest("dcyzhimmydtd")
                                                                .setCompressedSizeBytes(2024787866)
                                                                .setSizeBytes(1520186432)
                                                                .setUpdatedAt(
                                                                        OffsetDateTime.parse("2021-09-24T08:39:55Z"))
                                                                .setTags(Arrays.asList())
                                                                .setBlobs(Arrays.asList()))
                                                .setTagCount(661540187)
                                                .setManifestCount(978084338)));
        model =
