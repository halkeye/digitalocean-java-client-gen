...
public final class Components1Ytaq4GResponsesFloatingIpListContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Ytaq4GResponsesFloatingIpListContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":235719823},\"floating_ips\":[{\"ip\":\"rsbgailjqovqmxq\",\"region\":{\"name\":\"ofx\",\"slug\":\"nkiu\",\"available\":true},\"locked\":true},{\"ip\":\"xooi\",\"region\":{\"name\":\"hiebruptls\",\"slug\":\"vqzgaqsosrnj\",\"available\":false},\"locked\":false}]}")
                        .toObject(Components1Ytaq4GResponsesFloatingIpListContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Ytaq4GResponsesFloatingIpListContentApplicationJsonSchema model =
                new Components1Ytaq4GResponsesFloatingIpListContentApplicationJsonSchema()
                        .setFloatingIps(
                                Arrays.asList(
                                        new FloatingIp()
                                                .setIp("rsbgailjqovqmxq")
                                                .setRegion(
                                        ...
                                        new FloatingIp()
                                                ...
                                                .setRegion(
                                                        new FloatingIpRegion()
                                                                .setName("hiebruptls")
                                                                .setSlug("vqzgaqsosrnj")
                                                                .setAvailable(false))
                                                .setLocked(false)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(235719823));
        model =
