...
public final class Components1Ijqzy9ResponsesAllKernelsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Ijqzy9ResponsesAllKernelsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1796482206},\"kernels\":[{\"id\":29169727,\"name\":\"jsqy\",\"version\":\"moxfablq\"},{\"id\":1071274522,\"name\":\"mwh\",\"version\":\"ali\"}]}")
                        .toObject(Components1Ijqzy9ResponsesAllKernelsContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Ijqzy9ResponsesAllKernelsContentApplicationJsonSchema model =
                new Components1Ijqzy9ResponsesAllKernelsContentApplicationJsonSchema()
                        .setKernels(
                                Arrays.asList(
                                        new Kernel().setId(29169727).setName("jsqy").setVersion("moxfablq"),
                                        new Kernel().setId(1071274522).setName("mwh").setVersion("ali")))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1796482206));
        model =
