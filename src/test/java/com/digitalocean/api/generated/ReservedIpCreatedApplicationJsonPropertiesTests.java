...
public final class ReservedIpCreatedApplicationJsonPropertiesTests {
    ...
    public void testDeserialize() {
        ReservedIpCreatedApplicationJsonProperties model =
                BinaryData.fromString(
                                "{\"droplets\":[{\"id\":749853791,\"rel\":\"momggewd\",\"href\":\"xexfyznv\"},{\"id\":536239457,\"rel\":\"qkslw\",\"href\":\"xayzqbyeyw\"},{\"id\":1079382720,\"rel\":\"nrtlikffy\",\"href\":\"tkqrfbgyn\"},{\"id\":1574772690,\"rel\":\"zdteqjmyqxuhg\",\"href\":\"xnyprijyoxxj\"}],\"actions\":[{\"id\":346483180,\"rel\":\"rlcck\",\"href\":\"fpjmspau\"}]}")
                        .toObject(ReservedIpCreatedApplicationJsonProperties.class);
    ...
    public void testSerialize() {
        ReservedIpCreatedApplicationJsonProperties model =
                new ReservedIpCreatedApplicationJsonProperties()
                        .setDroplets(
                                Arrays.asList(
                                        new ActionLink().setId(749853791).setRel("momggewd").setHref("xexfyznv"),
                                        new ActionLink().setId(536239457).setRel("qkslw").setHref("xayzqbyeyw"),
                                        new ActionLink().setId(1079382720).setRel("nrtlikffy").setHref("tkqrfbgyn"),
                                        new ActionLink()
                                                .setId(1574772690)
                                                .setRel("zdteqjmyqxuhg")
                                                .setHref("xnyprijyoxxj")))
                        .setActions(
                                Arrays.asList(new ActionLink().setId(346483180).setRel("rlcck").setHref("fpjmspau")));
