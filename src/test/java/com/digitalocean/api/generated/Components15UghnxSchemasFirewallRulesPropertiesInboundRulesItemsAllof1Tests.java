...
public final class Components15UghnxSchemasFirewallRulesPropertiesInboundRulesItemsAllof1Tests {
    ...
    public void testDeserialize() {
        Components15UghnxSchemasFirewallRulesPropertiesInboundRulesItemsAllof1 model =
                BinaryData.fromString(
                                "{\"sources\":{\"addresses\":[\"ttuxvzfqayopbt\",\"ixhg\"],\"droplet_ids\":[2099170935],\"load_balancer_uids\":[\"dztgsqja\",\"qm\"],\"kubernetes_ids\":[\"neibpgbrhbjdq\"]}}")
                        .toObject(Components15UghnxSchemasFirewallRulesPropertiesInboundRulesItemsAllof1.class);
    ...
    public void testSerialize() {
        Components15UghnxSchemasFirewallRulesPropertiesInboundRulesItemsAllof1 model =
                new Components15UghnxSchemasFirewallRulesPropertiesInboundRulesItemsAllof1()
                        .setSources(
                                new FirewallRulesInboundRulesAllOfProperties()
                                        .setAddresses(Arrays.asList("ttuxvzfqayopbt", "ixhg"))
                                        .setDropletIds(Arrays.asList(2099170935))
                                        .setLoadBalancerUids(Arrays.asList("dztgsqja", "qm"))
                                        .setKubernetesIds(Arrays.asList("neibpgbrhbjdq")));
        model =
