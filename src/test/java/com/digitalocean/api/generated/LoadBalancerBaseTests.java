...
public final class LoadBalancerBaseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                ForwardingRuleTargetProtocol.UDP, model.getForwardingRules().get(0).getTargetProtocol());
    ...
    public void testSerialize() {
        LoadBalancerBase model =
                new LoadBalancerBase()
                        .setName("avqcwy")
                        .setSizeUnit(546422104)
                        .setSize(LoadBalancerBaseSize.LB_LARGE)
                        .setAlgorithm(LoadBalancerBaseAlgorithm.LEAST_CONNECTIONS)
                        .setForwardingRules(
                                Arrays.asList(
                                        new ForwardingRule()
                                                .setEntryProtocol(ForwardingRuleEntryProtocol.HTTP)
                                                .setEntryPort(1764710299)
                                                .setTargetProtocol(ForwardingRuleTargetProtocol.UDP)
                                                .setTargetPort(654732708)
                                                .setCertificateId("w")
                                                .setTlsPassthrough(true),
                                        new ForwardingRule()
                                                .setEntryProtocol(ForwardingRuleEntryProtocol.HTTP)
                                                .setEntryPort(206215269)
                                                .setTargetProtocol(ForwardingRuleTargetProtocol.UDP)
                                                .setTargetPort(1572254159)
                                                .setCertificateId("efejsewrznequqyn")
                                                .setTlsPassthrough(true),
                                        new ForwardingRule()
                                                .setEntryProtocol(ForwardingRuleEntryProtocol.UDP)
                                                .setEntryPort(1503691224)
                                                .setTargetProtocol(ForwardingRuleTargetProtocol.HTTP)
                                                .setTargetPort(1353297778)
                                                .setCertificateId("ks")
                                                .setTlsPassthrough(false),
                                        new ForwardingRule()
                                                .setEntryProtocol(ForwardingRuleEntryProtocol.TCP)
                                                .setEntryPort(1935368193)
                                                .setTargetProtocol(ForwardingRuleTargetProtocol.UDP)
                                                .setTargetPort(1269282450)
                                                .setCertificateId("jhgcydijnmcvjb")
                                                .setTlsPassthrough(true)))
                        .setHealthCheck(
                                new HealthCheck()
                                        ...
                                        .setPort(967800164)
                                        .setPath("ixtdlxw")
                                        .setCheckIntervalSeconds(1670329718)
                                        .setResponseTimeoutSeconds(1105245942)
                                        .setUnhealthyThreshold(505038525)
                                        .setHealthyThreshold(136642434))
                        .setStickySessions(
                                new StickySessions()
                                        .setType(StickySessionsType.COOKIES)
                                        .setCookieName("rwrgorogeuvm")
                                        .setCookieTtlSeconds(1658204091))
