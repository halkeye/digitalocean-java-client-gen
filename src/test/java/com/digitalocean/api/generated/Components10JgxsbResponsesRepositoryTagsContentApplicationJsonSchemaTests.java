...
public final class Components10JgxsbResponsesRepositoryTagsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components10JgxsbResponsesRepositoryTagsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":223194888},\"tags\":[{\"registry_name\":\"xcacrmvjfmrsuydl\",\"repository\":\"relsxfkzrz\",\"tag\":\"rjvqxvwkiocxoer\",\"manifest_digest\":\"buocq\",\"compressed_size_bytes\":1078776215,\"size_bytes\":1999602750,\"updated_at\":\"2021-05-02T13:39:25Z\"},{\"registry_name\":\"xbc\",\"repository\":\"tezyozdb\",\"tag\":\"qnl\",\"manifest_digest\":\"xc\",\"compressed_size_bytes\":448718328,\"size_bytes\":1806399393,\"updated_at\":\"2021-08-27T12:56:56Z\"}]}")
                        .toObject(Components10JgxsbResponsesRepositoryTagsContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components10JgxsbResponsesRepositoryTagsContentApplicationJsonSchema model =
                new Components10JgxsbResponsesRepositoryTagsContentApplicationJsonSchema()
                        .setTags(
                                Arrays.asList(
                                        new RepositoryTag()
                                                .setRegistryName("xcacrmvjfmrsuydl")
                                                .setRepository("relsxfkzrz")
                                                .setTag("rjvqxvwkiocxoer")
                                                .setManifestDigest("buocq")
                                                .setCompressedSizeBytes(1078776215)
                                                .setSizeBytes(1999602750)
                                                .setUpdatedAt(OffsetDateTime.parse("2021-05-02T13:39:25Z")),
                                        new RepositoryTag()
                                                .setRegistryName("xbc")
                                                .setRepository("tezyozdb")
                                                .setTag("qnl")
                                                .setManifestDigest("xc")
                                                .setCompressedSizeBytes(448718328)
                                                .setSizeBytes(1806399393)
                                                .setUpdatedAt(OffsetDateTime.parse("2021-08-27T12:56:56Z"))))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(223194888));
        model =
