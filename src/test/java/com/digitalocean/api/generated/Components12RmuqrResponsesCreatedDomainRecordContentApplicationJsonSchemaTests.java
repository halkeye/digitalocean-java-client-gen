...
public final class Components12RmuqrResponsesCreatedDomainRecordContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components12RmuqrResponsesCreatedDomainRecordContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"domain_record\":{\"id\":133600558,\"type\":\"romv\",\"name\":\"ysemtmesrfsvpin\",\"data\":\"pat\",\"priority\":1838924635,\"port\":1014316985,\"ttl\":574098117,\"weight\":852211061,\"flags\":689179131,\"tag\":\"ojazbbgspfte\"}}")
                        .toObject(Components12RmuqrResponsesCreatedDomainRecordContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components12RmuqrResponsesCreatedDomainRecordContentApplicationJsonSchema model =
                new Components12RmuqrResponsesCreatedDomainRecordContentApplicationJsonSchema()
                        .setDomainRecord(
                                new DomainRecord()
                                        .setType("romv")
                                        .setName("ysemtmesrfsvpin")
                                        .setData("pat")
                                        .setPriority(1838924635)
                                        .setPort(1014316985)
                                        .setTtl(574098117)
                                        .setWeight(852211061)
                                        .setFlags(689179131)
