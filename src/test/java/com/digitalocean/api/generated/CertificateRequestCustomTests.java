...
public final class CertificateRequestCustomTests {
    ...
    public void testDeserialize() {
        CertificateRequestCustom model =
                BinaryData.fromString(
                                "{\"private_key\":\"lgjmtbd\",\"leaf_certificate\":\"vcqguefzh\",\"certificate_chain\":\"p\",\"name\":\"eqdurelyujlfyoum\",\"type\":\"lets_encrypt\"}")
                        .toObject(CertificateRequestCustom.class);
    ...
    public void testSerialize() {
        CertificateRequestCustom model =
                new CertificateRequestCustom()
                        .setName("eqdurelyujlfyoum")
                        .setType(CertificateCreateBaseType.LETS_ENCRYPT)
                        .setPrivateKey("lgjmtbd")
                        .setLeafCertificate("vcqguefzh")
