...
public final class DropletNextBackupWindowTests {
    ...
    public void testDeserialize() {
        DropletNextBackupWindow model = BinaryData.fromString("{\"start\":\"2021-10-28T14:39:50Z\",\"end\":\"2021-11-13T00:25:40Z\"}").toObject(DropletNextBackupWindow.class);
    ...
    public void testSerialize() {
        DropletNextBackupWindow model = new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-10-28T14:39:50Z")).setEnd(OffsetDateTime.parse("2021-11-13T00:25:40Z"));
