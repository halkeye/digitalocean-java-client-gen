...
public final class AppsDeploymentFunctionsTests {
    ...
    public void testDeserialize() {
        AppsDeploymentFunctions model =
                BinaryData.fromString(
                                "{\"name\":\"yhejhzisxgfp\",\"source_commit_hash\":\"olppvksrpqvujz\",\"namespace\":\"ehtwdwrft\"}")
                        .toObject(AppsDeploymentFunctions.class);
    ...
    public void testSerialize() {
        AppsDeploymentFunctions model =
                new AppsDeploymentFunctions()
                        .setName("yhejhzisxgfp")
                        .setSourceCommitHash("olppvksrpqvujz")
                        .setNamespace("ehtwdwrft");
