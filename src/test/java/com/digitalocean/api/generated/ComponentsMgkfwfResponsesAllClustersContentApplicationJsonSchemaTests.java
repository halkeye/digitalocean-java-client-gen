...
public final class ComponentsMgkfwfResponsesAllClustersContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals("tzrxzhcle", model.getKubernetesClusters().get(0).getMaintenancePolicy().getStartTime());
        Assertions.assertEquals(MaintenancePolicyDay.ANY, model.getKubernetesClusters().get(0).getMaintenancePolicy().getDay());
    ...
    public void testSerialize() {
        ComponentsMgkfwfResponsesAllClustersContentApplicationJsonSchema model = new ComponentsMgkfwfResponsesAllClustersContentApplicationJsonSchema().setKubernetesClusters(Arrays.asList(new Cluster().setName("nqzubfonfdbgmk").setRegion("wmjcwtewfhxw").setVersion("rk").setTags(Arrays.asList("ucb", "tredscnnstjc")).setNodePools(Arrays.asList()).setMaintenancePolicy(new MaintenancePolicy().setStartTime("tzrxzhcle").setDay(MaintenancePolicyDay.ANY)).setAutoUpgrade(false).setSurgeUpgrade(false).setHa(false), new Cluster().setName("jplbchych").setRegion("kvy").setVersion("fbqvumkxqj").setTags(Arrays.asList("lobha", "qmomfe")).setNodePools(Arrays.asList()).setMaintenancePolicy(new MaintenancePolicy().setStartTime("fr").setDay(MaintenancePolicyDay.THURSDAY)).setAutoUpgrade(false).setSurgeUpgrade(false).setHa(false), new Cluster().setName("qscag").setRegion("yvouprsytq").setVersion("ss").setTags(Arrays.asList("hvzielbp", "nqujywz", "qyggmnwsvhb", "gqiwy")).setNodePools(Arrays.asList()).setMaintenancePolicy(new MaintenancePolicy().setStartTime("bdrrpnrehkunsb").setDay(MaintenancePolicyDay.THURSDAY)).setAutoUpgrade(false).setSurgeUpgrade(true).setHa(false), new Cluster().setName("pditfnonpi").setRegion("uxlvrhprrvbwonl").setVersion("qflvtlrvbst").setTags(Arrays.asList("oqvgpnewuhw", "wjnoxuo", "tfnressfepgck", "cjmgvsnvbtqdxfm")).setNodePools(Arrays.asList()).setMaintenancePolicy(new MaintenancePolicy().setStartTime("n").setDay(MaintenancePolicyDay.ANY)).setAutoUpgrade(false).setSurgeUpgrade(true).setHa(true))).setLinks(new PageLinks()).setMeta(new MetaMeta().setTotal(1305408761));
        model = BinaryData.fromObject(model).toObject(ComponentsMgkfwfResponsesAllClustersContentApplicationJsonSchema.class);
        Assertions.assertEquals("nqzubfonfdbgmk", model.getKubernetesClusters().get(0).getName());
        Assertions.assertEquals("wmjcwtewfhxw", model.getKubernetesClusters().get(0).getRegion());
        Assertions.assertEquals("rk", model.getKubernetesClusters().get(0).getVersion());
        Assertions.assertEquals("ucb", model.getKubernetesClusters().get(0).getTags().get(0));
