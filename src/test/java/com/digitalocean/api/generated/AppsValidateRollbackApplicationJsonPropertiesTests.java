...
public final class AppsValidateRollbackApplicationJsonPropertiesTests {
    ...
    public void testDeserialize() {
        AppsValidateRollbackApplicationJsonProperties model = BinaryData.fromString("{\"code\":\"region_conflict\",\"message\":\"jybvit\",\"components\":[\"jyaznumtggmu\",\"dchozfnkfexl\",\"xn\"]}").toObject(AppsValidateRollbackApplicationJsonProperties.class);
    ...
    public void testSerialize() {
        AppsValidateRollbackApplicationJsonProperties model = new AppsValidateRollbackApplicationJsonProperties().setCode(AppRollbackValidationConditionCode.REGION_CONFLICT).setMessage("jybvit").setComponents(Arrays.asList("jyaznumtggmu", "dchozfnkfexl", "xn"));
