...
public final class Components10LqvkkResponsesDropletCreateContentApplicationJsonSchemaOneof1PropertiesLinksTests {
    ...
    public void testDeserialize() {
        Components10LqvkkResponsesDropletCreateContentApplicationJsonSchemaOneof1PropertiesLinks model =
                BinaryData.fromString(
                                "{\"actions\":[{\"id\":750233600,\"rel\":\"gbvm\",\"href\":\"wrqbebjnfv\"},{\"id\":843963341,\"rel\":\"btvkbi\",\"href\":\"nhtfgfi\"},{\"id\":977950573,\"rel\":\"hizpaczmuh\",\"href\":\"akznhokhoitwhr\"}]}")
                        .toObject(
    ...
    public void testSerialize() {
        Components10LqvkkResponsesDropletCreateContentApplicationJsonSchemaOneof1PropertiesLinks model =
                new Components10LqvkkResponsesDropletCreateContentApplicationJsonSchemaOneof1PropertiesLinks()
                        .setActions(
                                Arrays.asList(
                                        new ActionLink().setId(750233600).setRel("gbvm").setHref("wrqbebjnfv"),
                                        new ActionLink().setId(843963341).setRel("btvkbi").setHref("nhtfgfi"),
                                        new ActionLink()
                                                .setId(977950573)
                                                .setRel("hizpaczmuh")
                                                .setHref("akznhokhoitwhr")));
        model =
