...
public final class AppsDomainTests {
    ...
    public void testDeserialize() {
        AppsDomain model = BinaryData.fromString("{\"id\":\"tillucbiqtg\",\"phase\":\"ACTIVE\",\"progress\":{\"steps\":[]},\"spec\":{\"domain\":\"sldrizetpwbral\",\"type\":\"UNSPECIFIED\",\"wildcard\":false,\"zone\":\"bqzmizaka\",\"minimum_tls_version\":\"1.3\"}}").toObject(AppsDomain.class);
    ...
    public void testSerialize() {
        AppsDomain model = new AppsDomain().setId("tillucbiqtg").setPhase(AppsDomainPhase.ACTIVE).setProgress(new AppsDomainProgress().setSteps(Arrays.asList())).setSpec(new AppDomainSpec().setDomain("sldrizetpwbral").setType(AppDomainSpecType.UNSPECIFIED).setWildcard(false).setZone("bqzmizaka").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE3));
