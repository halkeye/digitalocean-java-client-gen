...
public final class DestroyAssociatedKubernetesResourcesTests {
    ...
    public void testDeserialize() {
        DestroyAssociatedKubernetesResources model =
                BinaryData.fromString(
                                "{\"load_balancers\":[\"hd\"],\"volumes\":[\"haz\",\"kx\",\"ivz\"],\"volume_snapshots\":[\"mbrygmw\",\"bios\",\"qsykq\",\"dqwdrtxtfdaglmr\"]}")
                        .toObject(DestroyAssociatedKubernetesResources.class);
    ...
    public void testSerialize() {
        DestroyAssociatedKubernetesResources model =
                new DestroyAssociatedKubernetesResources()
                        .setLoadBalancers(Arrays.asList("hd"))
                        .setVolumes(Arrays.asList("haz", "kx", "ivz"))
                        .setVolumeSnapshots(Arrays.asList("mbrygmw", "bios", "qsykq", "dqwdrtxtfdaglmr"));
