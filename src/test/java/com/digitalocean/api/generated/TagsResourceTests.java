    ...
    public void testDeserialize() {
        TagsResource model =
                BinaryData.fromString(
                                "{\"resources\":[{\"resource_id\":\"soq\",\"resource_type\":\"volume_snapshot\"},{\"resource_id\":\"yeqdob\",\"resource_type\":\"image\"},{\"resource_id\":\"c\",\"resource_type\":\"volume_snapshot\"},{\"resource_id\":\"ckcesrsi\",\"resource_type\":\"droplet\"}]}")
                        .toObject(TagsResource.class);
        Assertions.assertEquals("soq", model.getResources().get(0).getResourceId());
        Assertions.assertEquals(
                TagsResourceResourcesItemResourceType.VOLUME_SNAPSHOT, model.getResources().get(0).getResourceType());
    }
                        ...
                        .setResources(
                                Arrays.asList(
                                        new TagsResourceResourcesItem()
                                                .setResourceId("soq")
                                                .setResourceType(TagsResourceResourcesItemResourceType.VOLUME_SNAPSHOT),
                                        new TagsResourceResourcesItem()
                                                .setResourceId("yeqdob")
                                                .setResourceType(TagsResourceResourcesItemResourceType.IMAGE),
                                        new TagsResourceResourcesItem()
                                                .setResourceId("c")
                                                .setResourceType(TagsResourceResourcesItemResourceType.VOLUME_SNAPSHOT),
                                        new TagsResourceResourcesItem()
                                                .setResourceId("ckcesrsi")
