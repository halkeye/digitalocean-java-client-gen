...
public final class ErrorWithRootCausesTests {
    ...
    public void testDeserialize() {
        ErrorWithRootCauses model = BinaryData.fromString("{\"error\":\"oqwrnfckjthlok\",\"messages\":[\"awfubkngejjxu\",\"owynj\"],\"root_causes\":[\"o\",\"mxuktdrsjtmnkxj\"]}").toObject(ErrorWithRootCauses.class);
    ...
    public void testSerialize() {
        ErrorWithRootCauses model = new ErrorWithRootCauses().setError("oqwrnfckjthlok").setMessages(Arrays.asList("awfubkngejjxu", "owynj")).setRootCauses(Arrays.asList("o", "mxuktdrsjtmnkxj"));
