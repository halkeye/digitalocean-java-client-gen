...
public final class Components1Ppd4D8ResponsesCreateFirewallResponseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Ppd4D8ResponsesCreateFirewallResponseContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"firewall\":{\"id\":\"z\",\"status\":\"succeeded\",\"created_at\":\"2021-08-20T09:30:47Z\",\"pending_changes\":[{\"droplet_id\":1597472821,\"removing\":true,\"status\":\"ckyvnensmuffi\"},{\"droplet_id\":144155538,\"removing\":true,\"status\":\"bpzujqjtotdxp\"},{\"droplet_id\":132625960,\"removing\":true,\"status\":\"wuusiecktybh\"}],\"name\":\"xidhhxomil\",\"droplet_ids\":[1972558791],\"inbound_rules\":[{\"protocol\":\"icmp\",\"ports\":\"xwjwilm\"},{\"protocol\":\"icmp\",\"ports\":\"sl\"},{\"protocol\":\"icmp\",\"ports\":\"teptwujjzgxqgqwl\"},{\"protocol\":\"udp\",\"ports\":\"hgt\"}],\"outbound_rules\":[{\"protocol\":\"tcp\",\"ports\":\"qqy\"},{\"protocol\":\"icmp\",\"ports\":\"kkt\"}]}}")
                        .toObject(Components1Ppd4D8ResponsesCreateFirewallResponseContentApplicationJsonSchema.class);
        Assertions.assertEquals(
                FirewallRuleBaseProtocol.ICMP, model.getFirewall().getInboundRules().get(0).getProtocol());
    ...
    public void testSerialize() {
        Components1Ppd4D8ResponsesCreateFirewallResponseContentApplicationJsonSchema model =
                new Components1Ppd4D8ResponsesCreateFirewallResponseContentApplicationJsonSchema()
                        .setFirewall(
                                new Firewall()
                                        .setInboundRules(
                                                Arrays.asList(
                                        ...
                                        .setOutboundRules(
                                                Arrays.asList(
                                                        ...
                                                        new FirewallRulesOutboundRulesItem()
                                                                ...
                                                                .setPorts("kkt")))
                                        .setName("xidhhxomil")
                                        .setDropletIds(Arrays.asList(1972558791)));
        model =
