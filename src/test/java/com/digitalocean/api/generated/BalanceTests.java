...
public final class BalanceTests {
    ...
    public void testDeserialize() {
        Balance model = BinaryData.fromString("{\"month_to_date_balance\":\"wixvcpwnkwywzw\",\"account_balance\":\"alickduoi\",\"month_to_date_usage\":\"amt\",\"generated_at\":\"2021-07-28T03:33:13Z\"}").toObject(Balance.class);
    ...
    public void testSerialize() {
        Balance model = new Balance().setMonthToDateBalance("wixvcpwnkwywzw").setAccountBalance("alickduoi").setMonthToDateUsage("amt").setGeneratedAt(OffsetDateTime.parse("2021-07-28T03:33:13Z"));
