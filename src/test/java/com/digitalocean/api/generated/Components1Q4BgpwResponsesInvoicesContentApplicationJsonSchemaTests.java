...
public final class Components1Q4BgpwResponsesInvoicesContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Q4BgpwResponsesInvoicesContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":289338077},\"invoices\":[{\"invoice_uuid\":\"oynkrxwetwkdrcyr\",\"amount\":\"pcunnuzdq\",\"invoice_period\":\"oenodnaienh\",\"updated_at\":\"skndnelqkaadlknw\"}],\"invoice_preview\":{\"invoice_uuid\":\"nniyopetxi\",\"amount\":\"nrlyxnuc\",\"invoice_period\":\"p\",\"updated_at\":\"lkwq\"}}")
                        .toObject(Components1Q4BgpwResponsesInvoicesContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Q4BgpwResponsesInvoicesContentApplicationJsonSchema model =
                new Components1Q4BgpwResponsesInvoicesContentApplicationJsonSchema()
                        .setInvoices(
                                Arrays.asList(
                                        new InvoicePreview()
                                                .setInvoiceUuid("oynkrxwetwkdrcyr")
                                                .setAmount("pcunnuzdq")
                                                .setInvoicePeriod("oenodnaienh")
                                                .setUpdatedAt("skndnelqkaadlknw")))
                        .setInvoicePreview(
                                new InvoicePreview()
                                        .setInvoiceUuid("nniyopetxi")
                                        .setAmount("nrlyxnuc")
                                        .setInvoicePeriod("p")
                                        .setUpdatedAt("lkwq"))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(289338077));
        model =
