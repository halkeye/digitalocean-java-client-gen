...
public final class Components4Cm61PResponsesAllCertificatesContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components4Cm61PResponsesAllCertificatesContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":582809262},\"certificates\":[{\"name\":\"ujpdsxzak\",\"not_after\":\"2021-11-27T20:04:30Z\",\"sha1_fingerprint\":\"mvbi\",\"created_at\":\"2021-01-04T23:31:13Z\",\"dns_names\":[\"qcvov\",\"uf\"],\"state\":\"pending\",\"type\":\"custom\"}]}")
                        .toObject(Components4Cm61PResponsesAllCertificatesContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components4Cm61PResponsesAllCertificatesContentApplicationJsonSchema model =
                new Components4Cm61PResponsesAllCertificatesContentApplicationJsonSchema()
                        .setCertificates(
                                Arrays.asList(
                                        new Certificate()
                                                .setName("ujpdsxzak")
                                                .setDnsNames(Arrays.asList("qcvov", "uf"))
                                                .setType(CertificateType.CUSTOM)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(582809262));
        model =
