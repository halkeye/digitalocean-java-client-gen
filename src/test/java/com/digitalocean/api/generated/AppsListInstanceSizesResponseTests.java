...
public final class AppsListInstanceSizesResponseTests {
    ...
    public void testDeserialize() {
        AppsListInstanceSizesResponse model = BinaryData.fromString("{\"discount_percent\":70.82197,\"instance_sizes\":[{\"cpu_type\":\"DEDICATED\",\"cpus\":\"hmpqvw\",\"memory_bytes\":\"kondcb\",\"name\":\"imuvqejosovyrrl\",\"slug\":\"esi\",\"tier_downgrade_to\":\"qtljqobbpihehc\",\"tier_slug\":\"ybmrqbrjbbmp\",\"tier_upgrade_to\":\"lvykfrex\",\"usd_per_month\":\"s\",\"usd_per_second\":\"wjksghudgzhxo\"},{\"cpu_type\":\"DEDICATED\",\"cpus\":\"svoujkxi\",\"memory_bytes\":\"afhrkmdyomk\",\"name\":\"bv\",\"slug\":\"hd\",\"tier_downgrade_to\":\"rhpw\",\"tier_slug\":\"ddei\",\"tier_upgrade_to\":\"wzovgk\",\"usd_per_month\":\"muikjcjcaztbws\",\"usd_per_second\":\"qowxwcom\"}]}").toObject(AppsListInstanceSizesResponse.class);
    ...
    public void testSerialize() {
        AppsListInstanceSizesResponse model = new AppsListInstanceSizesResponse().setDiscountPercent(70.82197F).setInstanceSizes(Arrays.asList(new AppsInstanceSize().setCpuType(InstanceSizeCpuType.DEDICATED).setCpus("hmpqvw").setMemoryBytes("kondcb").setName("imuvqejosovyrrl").setSlug("esi").setTierDowngradeTo("qtljqobbpihehc").setTierSlug("ybmrqbrjbbmp").setTierUpgradeTo("lvykfrex").setUsdPerMonth("s").setUsdPerSecond("wjksghudgzhxo"), new AppsInstanceSize().setCpuType(InstanceSizeCpuType.DEDICATED).setCpus("svoujkxi").setMemoryBytes("afhrkmdyomk").setName("bv").setSlug("hd").setTierDowngradeTo("rhpw").setTierSlug("ddei").setTierUpgradeTo("wzovgk").setUsdPerMonth("muikjcjcaztbws").setUsdPerSecond("qowxwcom")));
