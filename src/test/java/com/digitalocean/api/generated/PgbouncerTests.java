    ...
    public void testDeserialize() {
        Pgbouncer model =
                BinaryData.fromString(
                                "{\"server_reset_query_always\":false,\"ignore_startup_parameters\":[\"search_path\",\"search_path\",\"search_path\",\"search_path\"],\"min_pool_size\":885862938,\"server_lifetime\":561158106,\"server_idle_timeout\":1446277117,\"autodb_pool_size\":1698760010,\"autodb_pool_mode\":\"transaction\",\"autodb_max_db_connections\":977143635,\"autodb_idle_timeout\":815843697}")
                        .toObject(Pgbouncer.class);
        Assertions.assertEquals(false, model.isServerResetQueryAlways());
        Assertions.assertEquals(
                PgbouncerIgnoreStartupParametersItem.SEARCH_PATH, model.getIgnoreStartupParameters().get(0));
                ...
                new Pgbouncer()
                        ...
                        .setIgnoreStartupParameters(
                                Arrays.asList(
                                        ...
                                        PgbouncerIgnoreStartupParametersItem.SEARCH_PATH,
                                        PgbouncerIgnoreStartupParametersItem.SEARCH_PATH))
                        .setMinPoolSize(885862938)
                        .setServerLifetime(561158106)
                        .setServerIdleTimeout(1446277117)
                        .setAutodbPoolSize(1698760010)
                        .setAutodbPoolMode(PgbouncerAutodbPoolMode.TRANSACTION)
                        .setAutodbMaxDbConnections(977143635)
                        .setAutodbIdleTimeout(815843697);
