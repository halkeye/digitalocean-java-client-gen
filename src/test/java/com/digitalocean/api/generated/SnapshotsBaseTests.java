...
public final class SnapshotsBaseTests {
    ...
    public void testDeserialize() {
        SnapshotsBase model =
                BinaryData.fromString(
                                "{\"name\":\"oeurbtigapdyar\",\"created_at\":\"2021-06-06T08:34:28Z\",\"regions\":[\"ejdpdfhtwm\",\"kfqbriqulwwt\",\"jmeqkvy\"],\"min_disk_size\":1435057014,\"size_gigabytes\":45.53458}")
                        .toObject(SnapshotsBase.class);
    ...
    public void testSerialize() {
        SnapshotsBase model =
                new SnapshotsBase()
                        .setName("oeurbtigapdyar")
                        .setCreatedAt(OffsetDateTime.parse("2021-06-06T08:34:28Z"))
                        .setRegions(Arrays.asList("ejdpdfhtwm", "kfqbriqulwwt", "jmeqkvy"))
                        .setMinDiskSize(1435057014)
                        .setSizeGigabytes(45.53458f);
