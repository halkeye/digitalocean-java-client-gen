...
public final class Components187F1GeSchemasLoadBalancerCreateOneof0Allof1Tests {
    ...
    public void testDeserialize() {
        Components187F1GeSchemasLoadBalancerCreateOneof0Allof1 model = BinaryData.fromString("{\"region\":\"sfo1\"}").toObject(Components187F1GeSchemasLoadBalancerCreateOneof0Allof1.class);
        Assertions.assertEquals(RegionSlug.SFO1, model.getRegion());
    }

    @Test
    public void testSerialize() {
        Components187F1GeSchemasLoadBalancerCreateOneof0Allof1 model = new Components187F1GeSchemasLoadBalancerCreateOneof0Allof1().setRegion(RegionSlug.SFO1);
