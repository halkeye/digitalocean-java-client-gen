...
public final class AppAlertProgressStepTests {
    ...
    public void testDeserialize() {
        AppAlertProgressStep model = BinaryData.fromString("{\"name\":\"jvvruxwigsyei\",\"status\":\"UNKNOWN\",\"started_at\":\"2021-08-13T07:56:44Z\",\"ended_at\":\"2021-03-14T18:33:51Z\",\"reason\":{\"code\":\"qgdgkkile\",\"message\":\"kcsmk\"}}").toObject(AppAlertProgressStep.class);
    ...
    public void testSerialize() {
        AppAlertProgressStep model = new AppAlertProgressStep().setName("jvvruxwigsyei").setStatus(AppAlertProgressStepStatus.UNKNOWN).setStartedAt(OffsetDateTime.parse("2021-08-13T07:56:44Z")).setEndedAt(OffsetDateTime.parse("2021-03-14T18:33:51Z")).setReason(new AppAlertProgressStepReason().setCode("qgdgkkile").setMessage("kcsmk"));
