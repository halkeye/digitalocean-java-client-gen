...
public final class Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"region\":\"qbkxdtbfkihainz\",\"ip_range\":\"fkzlxvcozcgo\",\"name\":\"zlibcbnunzuysaj\",\"description\":\"qlho\"}")
                        .toObject(Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema model =
                new Paths1853Y6RV2VpcsPostRequestbodyContentApplicationJsonSchema()
                        .setName("zlibcbnunzuysaj")
                        .setDescription("qlho")
                        .setRegion("qbkxdtbfkihainz")
                        .setIpRange("fkzlxvcozcgo");
        model =
