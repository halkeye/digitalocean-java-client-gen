...
public final class ComponentsH2S4NkResponsesExistingClusterContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsH2S4NkResponsesExistingClusterContentApplicationJsonSchema model = new ComponentsH2S4NkResponsesExistingClusterContentApplicationJsonSchema().setKubernetesCluster(new Cluster().setName("awk").setRegion("hkapitsks").setVersion("fyfttibjepzwh").setTags(Arrays.asList("bhdosmbngkql", "xzduvxdmxexat")).setNodePools(Arrays.asList(new KubernetesNodePool().setSize("zsoxznntwgk").setName("rsenxoi").setCount(1156669978).setTags(Arrays.asList()).setTaints(Arrays.asList()).setAutoScale(true).setMinNodes(373872535).setMaxNodes(521262525), new KubernetesNodePool().setSize("gfmxpqkjnpyr").setName("hpsapzupz").setCount(2147008649).setTags(Arrays.asList()).setTaints(Arrays.asList()).setAutoScale(true).setMinNodes(553825209).setMaxNodes(95078563), new KubernetesNodePool().setSize("wdonbexftedaubh").setName("totc").setCount(1903783101).setTags(Arrays.asList()).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(1818566408).setMaxNodes(856518798))).setMaintenancePolicy(new MaintenancePolicy().setStartTime("gzgrnq").setDay(MaintenancePolicyDay.MONDAY)).setAutoUpgrade(false).setSurgeUpgrade(false).setHa(false));
        model = BinaryData.fromObject(model).toObject(ComponentsH2S4NkResponsesExistingClusterContentApplicationJsonSchema.class);
        Assertions.assertEquals("awk", model.getKubernetesCluster().getName());
        Assertions.assertEquals("hkapitsks", model.getKubernetesCluster().getRegion());
        Assertions.assertEquals("fyfttibjepzwh", model.getKubernetesCluster().getVersion());
        Assertions.assertEquals("bhdosmbngkql", model.getKubernetesCluster().getTags().get(0));
