...
public final class KubernetesOptionsTests {
    ...
    public void testDeserialize() {
        KubernetesOptions model =
                BinaryData.fromString(
                                "{\"options\":{\"regions\":[{\"name\":\"evrntfkn\",\"slug\":\"cycsyo\"},{\"name\":\"tkhfhfs\",\"slug\":\"vcsxrmhnmiz\"},{\"name\":\"prhqqwc\",\"slug\":\"lehhkplobzg\"},{\"name\":\"taksadzighmmt\",\"slug\":\"dvucfvvra\"}],\"versions\":[{\"slug\":\"rdeewl\",\"kubernetes_version\":\"xpcbwkdwjyjizn\",\"supported_features\":[]},{\"slug\":\"o\",\"kubernetes_version\":\"m\",\"supported_features\":[]},{\"slug\":\"spmcreihuftrnigh\",\"kubernetes_version\":\"nuwqxungro\",\"supported_features\":[]}],\"sizes\":[{\"name\":\"sxjwdy\",\"slug\":\"xmvzjow\"},{\"name\":\"geerclbl\",\"slug\":\"hpwachyeu\"}]}}")
                        .toObject(KubernetesOptions.class);
                ...
                new KubernetesOptions()
                        .setOptions(
                                new KubernetesOptionsOptions()
                                        .setRegions(
                                                Arrays.asList(
                                                        new KubernetesRegion().setName("evrntfkn").setSlug("cycsyo"),
                                                        new KubernetesRegion()
                                                                .setName("tkhfhfs")
                                                                .setSlug("vcsxrmhnmiz"),
                                                        new KubernetesRegion()
                                                                .setName("prhqqwc")
                                                                .setSlug("lehhkplobzg"),
                                                        new KubernetesRegion()
                                                                .setName("taksadzighmmt")
                                                                .setSlug("dvucfvvra")))
                                        .setVersions(
                                                Arrays.asList(
                                                        new KubernetesVersion()
                                                                .setSlug("rdeewl")
                                                                .setKubernetesVersion("xpcbwkdwjyjizn")
                                                                .setSupportedFeatures(Arrays.asList()),
                                                        new KubernetesVersion()
                                                                .setSlug("o")
                                                                .setKubernetesVersion("m")
                                                                .setSupportedFeatures(Arrays.asList()),
                                                        new KubernetesVersion()
                                                                .setSlug("spmcreihuftrnigh")
                                                                .setKubernetesVersion("nuwqxungro")
                                                                .setSupportedFeatures(Arrays.asList())))
                                        .setSizes(
                                                Arrays.asList(
                                                        new KubernetesSize().setName("sxjwdy").setSlug("xmvzjow"),
                                                        new KubernetesSize()
                                                                .setName("geerclbl")
                                                                .setSlug("hpwachyeu"))));
