...
public final class Components10IqkodResponsesAllDropletBackupsContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        Components10IqkodResponsesAllDropletBackupsContentApplicationJsonSchema model = new Components10IqkodResponsesAllDropletBackupsContentApplicationJsonSchema().setBackups(Arrays.asList(new DropletSnapshot().setName("lacro").setCreatedAt(OffsetDateTime.parse("2021-06-05T02:07:08Z")).setRegions(Arrays.asList("munerkeluxz", "hxze", "bzuzu")).setMinDiskSize(2246511).setSizeGigabytes(34.792336f).setType(DropletSnapshotType.SNAPSHOT), new DropletSnapshot().setName("zskejcgwfsgqksty").setCreatedAt(OffsetDateTime.parse("2021-01-23T00:28:04Z")).setRegions(Arrays.asList("pyuijp", "rdavsjcfmazpzdq")).setMinDiskSize(1940454197).setSizeGigabytes(51.981293f).setType(DropletSnapshotType.SNAPSHOT), new DropletSnapshot().setName("cmcokxizekuv").setCreatedAt(OffsetDateTime.parse("2021-06-09T04:19:13Z")).setRegions(Arrays.asList("wucaonzvajbvb", "krdemdi", "ackzidgzw")).setMinDiskSize(2057738367).setSizeGigabytes(64.340004f).setType(DropletSnapshotType.SNAPSHOT), new DropletSnapshot().setName("misvpztd").setCreatedAt(OffsetDateTime.parse("2021-07-23T09:45:28Z")).setRegions(Arrays.asList("kpxkqejtpjfoj", "unrlshxu", "nsy")).setMinDiskSize(2081477628).setSizeGigabytes(56.810875f).setType(DropletSnapshotType.SNAPSHOT))).setLinks(new PageLinks()).setMeta(new MetaMeta().setTotal(1252912413));
        model = BinaryData.fromObject(model).toObject(Components10IqkodResponsesAllDropletBackupsContentApplicationJsonSchema.class);
        Assertions.assertEquals("lacro", model.getBackups().get(0).getName());
        Assertions.assertEquals(OffsetDateTime.parse("2021-06-05T02:07:08Z"), model.getBackups().get(0).getCreatedAt());
        Assertions.assertEquals("munerkeluxz", model.getBackups().get(0).getRegions().get(0));
        Assertions.assertEquals(2246511, model.getBackups().get(0).getMinDiskSize());
