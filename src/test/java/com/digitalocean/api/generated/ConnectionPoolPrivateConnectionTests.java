...
public final class ConnectionPoolPrivateConnectionTests {
    ...
    public void testDeserialize() {
        ConnectionPoolPrivateConnection model = BinaryData.fromString("{\"uri\":\"tbgnixxowwzkyfw\",\"database\":\"piw\",\"host\":\"ii\",\"port\":1587000231,\"user\":\"e\",\"password\":\"ldmaxxijvskwsdgk\",\"ssl\":true}").toObject(ConnectionPoolPrivateConnection.class);
    }
