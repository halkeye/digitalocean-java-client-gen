    ...
    public void testDeserialize() {
        VolumesExt4 model =
                BinaryData.fromString(
                                "{\"filesystem_type\":\"EXT4\",\"region\":\"blr1\",\"id\":\"xozesn\",\"droplet_ids\":[1549605623,716254621,2028691940],\"name\":\"xjbrixymc\",\"description\":\"kk\",\"size_gigabytes\":1205646024,\"created_at\":\"rhwis\",\"tags\":[\"mrzcqfevnkyakc\",\"tehognsddjk\"],\"snapshot_id\":\"edesuazogfcnx\"}")
                        .toObject(VolumesExt4.class);
    ...
    public void testSerialize() {
        VolumesExt4 model =
                new VolumesExt4()
                        ...
                        .setName("xjbrixymc")
                        .setDescription("kk")
                        .setSizeGigabytes(1205646024)
                        .setTags(Arrays.asList("mrzcqfevnkyakc", "tehognsddjk"))
                        .setSnapshotId("edesuazogfcnx");
