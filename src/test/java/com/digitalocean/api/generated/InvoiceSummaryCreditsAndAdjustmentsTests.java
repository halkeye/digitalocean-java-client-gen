...
public final class InvoiceSummaryCreditsAndAdjustmentsTests {
    ...
    public void testDeserialize() {
        InvoiceSummaryCreditsAndAdjustments model = BinaryData.fromString("{\"name\":\"xhqf\",\"amount\":\"ka\"}").toObject(InvoiceSummaryCreditsAndAdjustments.class);
    ...
    public void testSerialize() {
        InvoiceSummaryCreditsAndAdjustments model = new InvoiceSummaryCreditsAndAdjustments().setName("xhqf").setAmount("ka");
