...
public final class ComponentsQapjoxResponsesNodePoolCreateContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsQapjoxResponsesNodePoolCreateContentApplicationJsonSchema model = new ComponentsQapjoxResponsesNodePoolCreateContentApplicationJsonSchema().setNodePool(new KubernetesNodePool().setSize("rqnjxmvvsduydwnw").setName("fydrfbgcnyxb").setCount(2035344474).setTags(Arrays.asList("mq", "ncgaull", "styygjq", "ulmwqgmhmqmiwx")).setTaints(Arrays.asList(new KubernetesNodePoolTaint().setKey("ucqfgufjnbxwbm").setValue("ukin").setEffect(KubernetesNodePoolTaintEffect.PREFER_NO_SCHEDULE), new KubernetesNodePoolTaint().setKey("gde").setValue("kzou").setEffect(KubernetesNodePoolTaintEffect.NO_SCHEDULE), new KubernetesNodePoolTaint().setKey("wpzrdwcgl").setValue("hgcand").setEffect(KubernetesNodePoolTaintEffect.NO_EXECUTE))).setAutoScale(true).setMinNodes(134000347).setMaxNodes(1131383097));
        model = BinaryData.fromObject(model).toObject(ComponentsQapjoxResponsesNodePoolCreateContentApplicationJsonSchema.class);
        Assertions.assertEquals("rqnjxmvvsduydwnw", model.getNodePool().getSize());
        Assertions.assertEquals("fydrfbgcnyxb", model.getNodePool().getName());
        Assertions.assertEquals(2035344474, model.getNodePool().getCount());
        Assertions.assertEquals("mq", model.getNodePool().getTags().get(0));
