...
public final class ComponentsNhzig9ResponsesGetImageActionsResponseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsNhzig9ResponsesGetImageActionsResponseContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1598988170},\"actions\":[{\"id\":843273318,\"status\":\"in-progress\",\"type\":\"exduetbapfczew\",\"started_at\":\"2021-10-04T17:52:57Z\",\"completed_at\":\"2021-08-24T22:12:47Z\",\"resource_id\":1369595242,\"resource_type\":\"yazkjpir\",\"region\":{\"name\":\"xvb\",\"slug\":\"zwhy\",\"available\":false}}]}")
                        .toObject(ComponentsNhzig9ResponsesGetImageActionsResponseContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-08-24T22:12:47Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        ComponentsNhzig9ResponsesGetImageActionsResponseContentApplicationJsonSchema model =
                new ComponentsNhzig9ResponsesGetImageActionsResponseContentApplicationJsonSchema()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(843273318)
                                                .setStatus(ActionStatus.IN_PROGRESS)
                                                .setType("exduetbapfczew")
                                                .setStartedAt(OffsetDateTime.parse("2021-10-04T17:52:57Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-08-24T22:12:47Z"))
                                                .setResourceId(1369595242)
                                                .setResourceType("yazkjpir")
                                                .setRegion(
                                                        new Region()
                                                                .setName("xvb")
                                                                .setSlug("zwhy")
                        ...
                        .setMeta(new MetaMeta().setTotal(1598988170));
        model =
