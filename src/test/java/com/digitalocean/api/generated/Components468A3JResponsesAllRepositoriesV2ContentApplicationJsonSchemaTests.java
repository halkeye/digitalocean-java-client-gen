...
public final class Components468A3JResponsesAllRepositoriesV2ContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(1491222274, model.getRepositories().get(0).getLatestManifest().getCompressedSizeBytes());
        Assertions.assertEquals(42020637, model.getRepositories().get(0).getLatestManifest().getSizeBytes());
        Assertions.assertEquals(OffsetDateTime.parse("2021-02-22T02:26:57Z"), model.getRepositories().get(0).getLatestManifest().getUpdatedAt());
    ...
    public void testSerialize() {
        Components468A3JResponsesAllRepositoriesV2ContentApplicationJsonSchema model = new Components468A3JResponsesAllRepositoriesV2ContentApplicationJsonSchema().setRepositories(Arrays.asList(new RepositoryV2().setRegistryName("khwqdmohheuyuu").setName("myevyigdeipn").setLatestManifest(new RepositoryManifest().setRegistryName("ejwli").setRepository("cndjzwhajo").setDigest("pqokhdyncra").setCompressedSizeBytes(1491222274).setSizeBytes(42020637).setUpdatedAt(OffsetDateTime.parse("2021-02-22T02:26:57Z")).setTags(Arrays.asList()).setBlobs(Arrays.asList())).setTagCount(1991210767).setManifestCount(640565722), new RepositoryV2().setRegistryName("nme").setName("ksy").setLatestManifest(new RepositoryManifest().setRegistryName("iclm").setRepository("nunkqvzlbbbajdex").setDigest("awexizb").setCompressedSizeBytes(1011761866).setSizeBytes(1751949591).setUpdatedAt(OffsetDateTime.parse("2021-09-12T13:56:48Z")).setTags(Arrays.asList()).setBlobs(Arrays.asList())).setTagCount(1283529110).setManifestCount(167900023), new RepositoryV2().setRegistryName("jvvyxtvvxnakzix").setName("aybf").setLatestManifest(new RepositoryManifest().setRegistryName("gfwhrmvlaknujmwx").setRepository("zblxna").setDigest("smfndcbsyhludzjk").setCompressedSizeBytes(94433668).setSizeBytes(1558101093).setUpdatedAt(OffsetDateTime.parse("2021-05-03T23:26:40Z")).setTags(Arrays.asList()).setBlobs(Arrays.asList())).setTagCount(352831383).setManifestCount(922241690))).setLinks(new PageLinks()).setMeta(new MetaMeta().setTotal(1239712532));
        model = BinaryData.fromObject(model).toObject(Components468A3JResponsesAllRepositoriesV2ContentApplicationJsonSchema.class);
        Assertions.assertEquals("khwqdmohheuyuu", model.getRepositories().get(0).getRegistryName());
        Assertions.assertEquals("myevyigdeipn", model.getRepositories().get(0).getName());
        Assertions.assertEquals("ejwli", model.getRepositories().get(0).getLatestManifest().getRegistryName());
        Assertions.assertEquals("cndjzwhajo", model.getRepositories().get(0).getLatestManifest().getRepository());
