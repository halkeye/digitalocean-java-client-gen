...
public final class RepositoryTests {
    ...
    public void testDeserialize() {
        Repository model =
                BinaryData.fromString(
                                "{\"registry_name\":\"ifqnff\",\"name\":\"xsqtzngxbs\",\"latest_tag\":{\"registry_name\":\"wguxcmmhipbvskci\",\"repository\":\"y\",\"tag\":\"wfsaa\",\"manifest_digest\":\"fgb\",\"compressed_size_bytes\":274077860,\"size_bytes\":1717985540,\"updated_at\":\"2021-09-23T02:59:20Z\"},\"tag_count\":1605492433}")
    ...
    public void testSerialize() {
        Repository model =
                new Repository()
                        .setRegistryName("ifqnff")
                        .setName("xsqtzngxbs")
                        .setLatestTag(
                                new RepositoryTag()
                                        .setRegistryName("wguxcmmhipbvskci")
                                        .setRepository("y")
                                        .setTag("wfsaa")
                                        .setManifestDigest("fgb")
                                        .setCompressedSizeBytes(274077860)
                                        .setSizeBytes(1717985540)
                                        .setUpdatedAt(OffsetDateTime.parse("2021-09-23T02:59:20Z")))
                        .setTagCount(1605492433);
