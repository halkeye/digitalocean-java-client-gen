...
public final class DatabaseClusterMaintenanceWindowTests {
    ...
    public void testDeserialize() {
        DatabaseClusterMaintenanceWindow model =
                BinaryData.fromString(
                                "{\"day\":\"f\",\"hour\":\"xrqrkijpeuqlsd\",\"pending\":false,\"description\":[\"vxwmwwmjs\",\"en\",\"wwa\",\"ecleqioulndhzyo\"]}")
                        .toObject(DatabaseClusterMaintenanceWindow.class);
    ...
    public void testSerialize() {
        DatabaseClusterMaintenanceWindow model =
                new DatabaseClusterMaintenanceWindow().setDay("f").setHour("xrqrkijpeuqlsd");
