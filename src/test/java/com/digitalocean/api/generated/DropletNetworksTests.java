...
public final class DropletNetworksTests {
    ...
    public void testDeserialize() {
        DropletNetworks model =
                BinaryData.fromString(
                                "{\"v4\":[{\"ip_address\":\"rukizyhgsqt\",\"netmask\":\"s\",\"gateway\":\"xqfpj\",\"type\":\"private\"},{\"ip_address\":\"weeiwdhdmnc\",\"netmask\":\"fzuscstun\",\"gateway\":\"hxdfbkl\",\"type\":\"public\"},{\"ip_address\":\"hgjsysmvxo\",\"netmask\":\"wxfkzsifcuvbdujg\",\"gateway\":\"xvecbbwjt\",\"type\":\"private\"},{\"ip_address\":\"izagbbgiar\",\"netmask\":\"ykpgd\",\"gateway\":\"wabzr\",\"type\":\"private\"}],\"v6\":[{\"ip_address\":\"ac\",\"netmask\":487908700,\"gateway\":\"sqkptjqgkifm\"},{\"ip_address\":\"inwhed\",\"netmask\":295145185,\"gateway\":\"qwuntob\"},{\"ip_address\":\"z\",\"netmask\":1704378858,\"gateway\":\"lw\"},{\"ip_address\":\"ydjufbnklbl\",\"netmask\":632583114,\"gateway\":\"gjwdab\"}]}")
                        .toObject(DropletNetworks.class);
        ...
        DropletNetworks model =
                new DropletNetworks()
                        .setV4(
                                Arrays.asList(
                                        new NetworkV4()
                                                .setIpAddress("rukizyhgsqt")
                                                .setNetmask("s")
                                                .setGateway("xqfpj")
                                                .setType(NetworkV4Type.PRIVATE),
                                        new NetworkV4()
                                                .setIpAddress("weeiwdhdmnc")
                                                .setNetmask("fzuscstun")
                                                .setGateway("hxdfbkl")
                                                .setType(NetworkV4Type.PUBLIC),
                                        new NetworkV4()
                                                .setIpAddress("hgjsysmvxo")
                                                .setNetmask("wxfkzsifcuvbdujg")
                                                .setGateway("xvecbbwjt")
                                                .setType(NetworkV4Type.PRIVATE),
                                        new NetworkV4()
                                                .setIpAddress("izagbbgiar")
                                                .setNetmask("ykpgd")
                                                .setGateway("wabzr")
                                                .setType(NetworkV4Type.PRIVATE)))
                        .setV6(
                                Arrays.asList(
                                        new NetworkV6()
                                                .setIpAddress("ac")
                                                .setNetmask(487908700)
                                                .setGateway("sqkptjqgkifm"),
                                        new NetworkV6()
                                                .setIpAddress("inwhed")
                                                .setNetmask(295145185)
                                                .setGateway("qwuntob"),
                                        new NetworkV6().setIpAddress("z").setNetmask(1704378858).setGateway("lw"),
                                        new NetworkV6()
                                                .setIpAddress("ydjufbnklbl")
                                                .setNetmask(632583114)
                                                .setGateway("gjwdab")));
