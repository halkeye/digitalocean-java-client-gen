...
public final class AppProposeTests {
    ...
    public void testSerialize() {
        AppPropose model = new AppPropose().setSpec(new AppSpec().setName("rbqgvgov").setRegion(AppSpecRegion.NYC).setDomains(Arrays.asList(new AppDomainSpec().setDomain("efjokn").setType(AppDomainSpecType.ALIAS).setWildcard(true).setZone("edikdfrdbiq").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE3), new AppDomainSpec().setDomain("geihfql").setType(AppDomainSpecType.PRIMARY).setWildcard(true).setZone("zcxmjpbyep").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE2), new AppDomainSpec().setDomain("t").setType(AppDomainSpecType.UNSPECIFIED).setWildcard(false).setZone("m").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE2), new AppDomainSpec().setDomain("i").setType(AppDomainSpecType.DEFAULT).setWildcard(false).setZone("omyqwcabvnuileey").setMinimumTlsVersion(AppDomainSpecMinimumTlsVersion.ONE3))).setServices(Arrays.asList(new AppServiceSpec().setName("oauk").setDockerfilePath("sizmoae").setBuildCommand("xjw").setRunCommand("vedwcgyeewx").setSourceDir("qbpsmg").setEnvs(Arrays.asList()).setEnvironmentSlug("u").setHttpPort(6044702270976415412L).setInternalPorts(Arrays.asList()).setRoutes(Arrays.asList()).setInstanceCount(3960460149409264910L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASICM), new AppServiceSpec().setName("ufcshhvnew").setDockerfilePath("pqanxrjkix").setBuildCommand("bta").setRunCommand("pnyghs").setSourceDir("cyl").setEnvs(Arrays.asList()).setEnvironmentSlug("mnsghpxycphdr").setHttpPort(769127322308420402L).setInternalPorts(Arrays.asList()).setRoutes(Arrays.asList()).setInstanceCount(5592106315617662810L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASICM), new AppServiceSpec().setName("xnqmhrpqpdfwm").setDockerfilePath("ssffxuifmc").setBuildCommand("p").setRunCommand("kdqzrdzsylo").setSourceDir("gtrczzydmxzjijpv").setEnvs(Arrays.asList()).setEnvironmentSlug("rkihcirld").setHttpPort(4104565600880841187L).setInternalPorts(Arrays.asList()).setRoutes(Arrays.asList()).setInstanceCount(1090681073720986389L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.PROFESSIONAL_XS), new AppServiceSpec().setName("urnnqbnqbpiz").setDockerfilePath("dogypxrxvbfi").setBuildCommand("u").setRunCommand("ctafsrbxrblm").setSourceDir("owxih").setEnvs(Arrays.asList()).setEnvironmentSlug("xwqagnepzw").setHttpPort(921467946090795096L).setInternalPorts(Arrays.asList()).setRoutes(Arrays.asList()).setInstanceCount(7396785488806348756L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASICM))).setStaticSites(Arrays.asList(new AppStaticSiteSpec().setName("hqo").setDockerfilePath("ueayfbpcmsplb").setBuildCommand("rueqthwm").setRunCommand("mbscbbx").setSourceDir("dhxiidlopedbwd").setEnvs(Arrays.asList()).setEnvironmentSlug("yybxubmdnafcbqw").setIndexDocument("sbq").setErrorDocument("agwwrxaom").setCatchallDocument("sgl").setOutputDir("czezkhhlt").setRoutes(Arrays.asList()))).setJobs(Arrays.asList(new AppJobSpec().setName("ele").setDockerfilePath("vwzkj").setBuildCommand("wbeonrlkwzdqy").setRunCommand("ceakxc").setSourceDir("soqfyiaseqchkrt").setEnvs(Arrays.asList()).setEnvironmentSlug("azisgyk").setKind(AppJobSpecKind.POST_DEPLOY).setInstanceCount(17608559898312941L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASIC_XXS), new AppJobSpec().setName("ohmn").setDockerfilePath("jklinh").setBuildCommand("ptysprq").setRunCommand("nzxojpslsvjgpli").setSourceDir("iqwoyxqvapcoh").setEnvs(Arrays.asList()).setEnvironmentSlug("cqpqojxcxzrzdc").setKind(AppJobSpecKind.PREDEPLOY).setInstanceCount(7475327936023485805L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASIC_XS), new AppJobSpec().setName("awetzq").setDockerfilePath("ljhznamtuatmzwcj").setBuildCommand("cqtjzmi").setRunCommand("gbgatzuuvbxn").setSourceDir("ebwgga").setEnvs(Arrays.asList()).setEnvironmentSlug("zlswvajqf").setKind(AppJobSpecKind.FAILED_DEPLOY).setInstanceCount(1846574721619281570L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.BASIC_XXS))).setWorkers(Arrays.asList(new AppWorkerSpec().setName("unwqr").setDockerfilePath("haohcmbuo").setBuildCommand("jrohmbpyryxameb").setRunCommand("dyvkfkmr").setSourceDir("xne").setEnvs(Arrays.asList()).setEnvironmentSlug("mtodl").setInstanceCount(4019217553392959801L).setInstanceSizeSlug(AppComponentInstanceBaseInstanceSizeSlug.PROFESSIONAL_XL))).setFunctions(Arrays.asList(new AppFunctionsSpec().setRoutes(Arrays.asList()).setName("cygvoavyunssx").setSourceDir("hi").setAlerts(Arrays.asList()).setEnvs(Arrays.asList()), new AppFunctionsSpec().setRoutes(Arrays.asList()).setName("aseksgbuxantuyg").setSourceDir("gaqi").setAlerts(Arrays.asList()).setEnvs(Arrays.asList()))).setDatabases(Arrays.asList(new AppDatabaseSpec().setClusterName("ulopmjnlexwhcb").setDbName("ibkeph").setDbUser("uerct").setEngine(AppDatabaseSpecEngine.UNSET).setName("yintqpbrlcy").setProduction(true).setVersion("zkgofxyf"), new AppDatabaseSpec().setClusterName("uc").setDbName("rrp").setDbUser("ttbst").setEngine(AppDatabaseSpecEngine.REDIS).setName("aqnrmvvfkoxmlg").setProduction(true).setVersion("idvrmaz"), new AppDatabaseSpec().setClusterName("dwwexymz").setDbName("azipbhpwvqsg").setDbUser("yuuzivens").setEngine(AppDatabaseSpecEngine.PG).setName("eyyvpkpatl").setProduction(false).setVersion("zgs")))).setAppId("rfhfvo");
