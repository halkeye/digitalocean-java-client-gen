...
public final class AppsDeploymentStaticSiteTests {
    ...
    public void testDeserialize() {
        AppsDeploymentStaticSite model =
                BinaryData.fromString("{\"name\":\"wnhhtqlgehgppip\",\"source_commit_hash\":\"hpfeoajvgcxtxjc\"}")
                        .toObject(AppsDeploymentStaticSite.class);
    ...
    public void testSerialize() {
        AppsDeploymentStaticSite model =
                new AppsDeploymentStaticSite().setName("wnhhtqlgehgppip").setSourceCommitHash("hpfeoajvgcxtxjc");
