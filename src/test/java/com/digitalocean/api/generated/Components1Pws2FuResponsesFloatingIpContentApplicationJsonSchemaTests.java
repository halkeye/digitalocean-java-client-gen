...
public final class Components1Pws2FuResponsesFloatingIpContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Pws2FuResponsesFloatingIpContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"floating_ip\":{\"ip\":\"cjcd\",\"region\":{\"name\":\"zpf\",\"slug\":\"eortwwyjmgvr\",\"available\":true},\"locked\":true}}")
                        .toObject(Components1Pws2FuResponsesFloatingIpContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Pws2FuResponsesFloatingIpContentApplicationJsonSchema model =
                new Components1Pws2FuResponsesFloatingIpContentApplicationJsonSchema()
                        .setFloatingIp(
                                new FloatingIp()
                                        .setIp("cjcd")
                                        .setRegion(
