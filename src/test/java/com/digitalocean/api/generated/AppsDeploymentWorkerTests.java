...
public final class AppsDeploymentWorkerTests {
    ...
    public void testDeserialize() {
        AppsDeploymentWorker model =
                BinaryData.fromString("{\"name\":\"eafidltugsresm\",\"source_commit_hash\":\"sjhoiftxfkfwegpr\"}")
                        .toObject(AppsDeploymentWorker.class);
    ...
    public void testSerialize() {
        AppsDeploymentWorker model =
                new AppsDeploymentWorker().setName("eafidltugsresm").setSourceCommitHash("sjhoiftxfkfwegpr");
