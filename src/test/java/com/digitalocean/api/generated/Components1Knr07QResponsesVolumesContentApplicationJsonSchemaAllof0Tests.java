...
public final class Components1Knr07QResponsesVolumesContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testSerialize() {
        Components1Knr07QResponsesVolumesContentApplicationJsonSchemaAllof0 model =
                new Components1Knr07QResponsesVolumesContentApplicationJsonSchemaAllof0()
                        .setVolumes(
                                Arrays.asList(
                                        new VolumeFull()
                                                .setName("ehcbs")
                                                .setDescription("pus")
                                                .setSizeGigabytes(1251046581)
                                                .setTags(Arrays.asList("fflzvslua"))
                                                .setFilesystemType("lutjsjzels")
                                                .setFilesystemLabel("emvupmeak"),
                                        new VolumeFull()
                                                .setName("wrjsbd")
                                                .setDescription("seesacuicnvq")
                                                .setSizeGigabytes(1738107936)
                                                .setTags(Arrays.asList("rmm", "lh", "k", "xrqkekcdavi"))
                                                .setFilesystemType("zmrjgo")
                                                .setFilesystemLabel("kxeheowse"),
                                        new VolumeFull()
                                                .setName("zjqthykcvo")
                                                .setDescription("cwfzotkxxl")
                                                .setSizeGigabytes(1815938169)
                                                .setTags(Arrays.asList("dmgobxehujcqg", "wvxwi", "aoibmjk"))
                                                .setFilesystemType("tweobptscruykkie")
                                                .setFilesystemLabel("yyno"),
                                        new VolumeFull()
                                                .setName("jzebp")
                                                .setDescription("ciyoypoedk")
                                                .setSizeGigabytes(261309443)
                                                .setTags(Arrays.asList("yxsx", "euikhzn"))
                                                .setFilesystemType("rjiqoqovqhgphgxu")
                                                .setFilesystemLabel("d")));
        model =
