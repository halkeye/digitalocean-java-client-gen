...
public final class InvoiceSummaryUserBillingAddressTests {
    ...
    public void testDeserialize() {
        InvoiceSummaryUserBillingAddress model =
                BinaryData.fromString(
                                "{\"address_line1\":\"gqtagd\",\"address_line2\":\"lss\",\"city\":\"jomevtfycnlb\",\"region\":\"jcodkkgjiiytssi\",\"postal_code\":\"z\",\"country_iso2_code\":\"ufqbvntnr\",\"created_at\":\"qsorh\",\"updated_at\":\"kxgnlykmxcpwzvmd\"}")
                        .toObject(InvoiceSummaryUserBillingAddress.class);
    ...
    public void testSerialize() {
        InvoiceSummaryUserBillingAddress model =
                new InvoiceSummaryUserBillingAddress()
                        .setAddressLine1("gqtagd")
                        .setAddressLine2("lss")
                        .setCity("jomevtfycnlb")
                        .setRegion("jcodkkgjiiytssi")
                        .setPostalCode("z")
                        .setCountryIso2Code("ufqbvntnr")
                        .setCreatedAt("qsorh")
                        .setUpdatedAt("kxgnlykmxcpwzvmd");
