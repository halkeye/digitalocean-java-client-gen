...
public final class FirewallRulesInboundRulesItemTests {
    ...
    public void testDeserialize() {
        FirewallRulesInboundRulesItem model =
                BinaryData.fromString(
                                "{\"sources\":{\"addresses\":[\"ncgagdvc\",\"qhftzbpyfaofd\",\"phtnc\",\"mhjobzr\"],\"droplet_ids\":[478729922],\"load_balancer_uids\":[\"cqhyftcvbz\"],\"kubernetes_ids\":[\"h\",\"kg\"]},\"protocol\":\"icmp\",\"ports\":\"uoorssatfybipufd\"}")
                        .toObject(FirewallRulesInboundRulesItem.class);
    ...
    public void testSerialize() {
        FirewallRulesInboundRulesItem model =
                new FirewallRulesInboundRulesItem()
                        ...
                        .setPorts("uoorssatfybipufd")
                        .setSources(
                                new FirewallRulesInboundRulesAllOfProperties()
                                        .setAddresses(Arrays.asList("ncgagdvc", "qhftzbpyfaofd", "phtnc", "mhjobzr"))
                                        .setDropletIds(Arrays.asList(478729922))
                                        .setLoadBalancerUids(Arrays.asList("cqhyftcvbz"))
                                        .setKubernetesIds(Arrays.asList("h", "kg")));
