...
public final class SubscriptionTierBaseTests {
    ...
    public void testDeserialize() {
        SubscriptionTierBase model =
                BinaryData.fromString(
                                "{\"name\":\"xagysokli\",\"slug\":\"s\",\"included_repositories\":1698205031,\"included_storage_bytes\":437815467,\"allow_storage_overage\":true,\"included_bandwidth_bytes\":1737482959,\"monthly_price_in_cents\":1165187891,\"storage_overage_price_in_cents\":856342763}")
                        .toObject(SubscriptionTierBase.class);
    ...
    public void testSerialize() {
        SubscriptionTierBase model =
                new SubscriptionTierBase()
                        .setName("xagysokli")
                        .setSlug("s")
                        .setIncludedRepositories(1698205031)
                        .setIncludedStorageBytes(437815467)
                        .setAllowStorageOverage(true)
                        .setIncludedBandwidthBytes(1737482959)
                        .setMonthlyPriceInCents(1165187891)
                        .setStorageOveragePriceInCents(856342763);
