    ...
    public void testDeserialize() {
        VolumeBase model =
                BinaryData.fromString(
                                "{\"id\":\"iti\",\"droplet_ids\":[631438840],\"name\":\"smkir\",\"description\":\"n\",\"size_gigabytes\":1096028966,\"created_at\":\"m\",\"tags\":[\"omeobwkeuzltenlb\"]}")
                        .toObject(VolumeBase.class);
    ...
    public void testSerialize() {
        VolumeBase model =
                new VolumeBase()
                        .setName("smkir")
                        .setDescription("n")
                        .setSizeGigabytes(1096028966)
                        .setTags(Arrays.asList("omeobwkeuzltenlb"));
