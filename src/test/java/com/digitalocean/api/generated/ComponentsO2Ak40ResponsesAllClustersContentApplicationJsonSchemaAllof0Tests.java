...
public final class ComponentsO2Ak40ResponsesAllClustersContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                MaintenancePolicyDay.THURSDAY, model.getKubernetesClusters().get(0).getMaintenancePolicy().getDay());
    ...
    public void testSerialize() {
        ComponentsO2Ak40ResponsesAllClustersContentApplicationJsonSchemaAllof0 model =
                new ComponentsO2Ak40ResponsesAllClustersContentApplicationJsonSchemaAllof0()
                        .setKubernetesClusters(
                                Arrays.asList(
                                        new Cluster()
                                                ...
                                                .setRegion("yt")
                                                .setVersion("slyekcgn")
                                                .setTags(Arrays.asList("cytesmf", "crtfodqhuauzm", "iv", "trfzhhezvh"))
                                                .setNodePools(Arrays.asList())
                                                .setMaintenancePolicy(
                                                        new MaintenancePolicy()
                                                                .setStartTime("dyyrudma")
                                        ...
                                        new Cluster()
                                                .setName("xndmuvar")
                                                .setRegion("lmzjotprrmu")
                                                .setVersion("cuhtuzlxiwy")
                                                .setTags(Arrays.asList("a", "c", "dazabundtse", "kaupwhlz"))
                                                .setNodePools(Arrays.asList())
                                                .setMaintenancePolicy(
                                                        new MaintenancePolicy()
                                                                .setStartTime("emgjlm")
                                                                .setDay(MaintenancePolicyDay.WEDNESDAY))
                                        ...
                                        new Cluster()
                                                ...
                                                .setRegion("tfbjampq")
                                                .setVersion("c")
                                                .setTags(Arrays.asList("okr"))
                                                .setNodePools(Arrays.asList())
                                                .setMaintenancePolicy(
                                                        new MaintenancePolicy()
                                                                .setStartTime("gaojbtqpqsdo")
                                                                .setDay(MaintenancePolicyDay.WEDNESDAY))
                                                .setAutoUpgrade(true)
                                                .setSurgeUpgrade(false)
                                                .setHa(false)));
