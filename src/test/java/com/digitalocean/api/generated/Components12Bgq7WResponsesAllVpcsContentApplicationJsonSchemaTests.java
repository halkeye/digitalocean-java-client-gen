...
public final class Components12Bgq7WResponsesAllVpcsContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        Components12Bgq7WResponsesAllVpcsContentApplicationJsonSchema model =
                new Components12Bgq7WResponsesAllVpcsContentApplicationJsonSchema()
                        .setVpcs(
                                Arrays.asList(
                                        new Vpc()
                                                .setName("edeuenthshnf")
                                                .setDescription("gpgpkkhpjnglaqlm")
                                                .setRegion("utbuvedwu")
                                                .setIpRange("bmenxcqs")
                                                .setDefaultProperty(true)
                                                .setUrn("kcrudekkbnjre"),
                                        new Vpc()
                                                .setName("xdifbwblijhp")
                                                .setDescription("kxgoyxontb")
                                                .setRegion("nmtrd")
                                                .setIpRange("xiw")
                                                .setDefaultProperty(true)
                                                .setUrn("vfpnrzikvoxloeoh"),
                                        new Vpc()
                                                .setName("klwjpz")
                                                .setDescription("ncw")
                                                .setRegion("qrxrosuqrrldxfu")
                                                .setIpRange("fewxatktwjrppi")
                                                .setDefaultProperty(true)
                                                .setUrn("velrmdcizhvk"),
                                        new Vpc()
                                                .setName("snliyzn")
                                                .setDescription("uqzgpdglkfv")
                                                .setRegion("mpyeyzolbf")
                                                .setIpRange("lytfxudui")
                                                .setDefaultProperty(true)
                                                .setUrn("swkq")))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(2011761513));
        model =
