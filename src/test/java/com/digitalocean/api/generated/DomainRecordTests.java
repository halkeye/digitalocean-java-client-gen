    ...
    public void testDeserialize() {
        DomainRecord model =
                BinaryData.fromString(
                                "{\"id\":1570012392,\"type\":\"mihzbdnpxp\",\"name\":\"dpr\",\"data\":\"xelyicghflr\",\"priority\":216422946,\"port\":574077072,\"ttl\":2140503117,\"weight\":1056053067,\"flags\":1781553839,\"tag\":\"kb\"}")
                        .toObject(DomainRecord.class);
    ...
    public void testSerialize() {
        DomainRecord model =
                new DomainRecord()
                        ...
                        .setName("dpr")
                        .setData("xelyicghflr")
                        .setPriority(216422946)
                        .setPort(574077072)
                        .setTtl(2140503117)
                        .setWeight(1056053067)
                        .setFlags(1781553839)
                        .setTag("kb");
