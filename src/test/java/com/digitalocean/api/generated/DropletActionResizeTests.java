...
public final class DropletActionResizeTests {
    ...
    public void testDeserialize() {
        DropletActionResize model =
                BinaryData.fromString("{\"disk\":false,\"size\":\"ftpzcrryklleyn\",\"type\":\"reboot\"}")
                        .toObject(DropletActionResize.class);
    ...
    public void testSerialize() {
        DropletActionResize model =
                new DropletActionResize().setType(DropletActionType.REBOOT).setDisk(false).setSize("ftpzcrryklleyn");
