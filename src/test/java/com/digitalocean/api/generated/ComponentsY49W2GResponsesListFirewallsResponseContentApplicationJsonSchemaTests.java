...
public final class ComponentsY49W2GResponsesListFirewallsResponseContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsY49W2GResponsesListFirewallsResponseContentApplicationJsonSchema model =
                new ComponentsY49W2GResponsesListFirewallsResponseContentApplicationJsonSchema()
                        .setFirewalls(
                                Arrays.asList(
                                        new Firewall()
                                                ...
                                                .setName("xebjl")
                                                .setDropletIds(
                                                        Arrays.asList(1672299180, 1383021224, 1310590136, 240222931)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("uxlymsvvyl")
                                                .setDropletIds(Arrays.asList(1062595906, 141398680)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("xx")
                                                .setDropletIds(Arrays.asList(1145040996)),
                                        new Firewall()
                                                .setInboundRules(Arrays.asList())
                                                .setOutboundRules(Arrays.asList())
                                                .setName("qawbmpspfe")
                                                .setDropletIds(
                                                        Arrays.asList(1509995040, 1732921110, 1084512341, 1461342536))))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(162424717));
        model =
