...
public final class Components1Sa8LwhResponsesBillingHistoryContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        Components1Sa8LwhResponsesBillingHistoryContentApplicationJsonSchemaAllof0 model =
                BinaryData.fromString(
                                "{\"billing_history\":[{\"description\":\"r\",\"amount\":\"lfg\",\"invoice_id\":\"nnnoytz\",\"invoice_uuid\":\"sewxigpxvkqm\",\"date\":\"2021-05-06T23:25:16Z\",\"type\":\"Adjustment\"}]}")
                        .toObject(Components1Sa8LwhResponsesBillingHistoryContentApplicationJsonSchemaAllof0.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-05-06T23:25:16Z"), model.getBillingHistory().get(0).getDate());
    ...
    public void testSerialize() {
        Components1Sa8LwhResponsesBillingHistoryContentApplicationJsonSchemaAllof0 model =
                new Components1Sa8LwhResponsesBillingHistoryContentApplicationJsonSchemaAllof0()
                        .setBillingHistory(
                                Arrays.asList(
                                        new BillingHistory()
                                                .setDescription("r")
                                                .setAmount("lfg")
                                                .setInvoiceId("nnnoytz")
                                                .setInvoiceUuid("sewxigpxvkqm")
                                                .setDate(OffsetDateTime.parse("2021-05-06T23:25:16Z"))
