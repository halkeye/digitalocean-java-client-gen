...
public final class ImageTests {
    ...
    public void testDeserialize() {
        Image model = BinaryData.fromString("{\"id\":449104692,\"name\":\"wnf\",\"type\":\"backup\",\"distribution\":\"Unknown\",\"slug\":\"zsinqbdnddb\",\"public\":true,\"regions\":[\"sfo2\",\"tor1\"],\"created_at\":\"2021-06-11T00:23Z\",\"min_disk_size\":1283788447,\"size_gigabytes\":12.315691,\"description\":\"rchwudlxeei\",\"tags\":[\"mnoejhqlfmsib\",\"oyrfgxk\",\"dpmypgfqvmtywh\"],\"status\":\"NEW\",\"error_message\":\"p\"}").toObject(Image.class);
    ...
    public void testSerialize() {
        Image model = new Image().setName("wnf").setType(ImageType.BACKUP).setDistribution(Distribution.UNKNOWN).setSlug("zsinqbdnddb").setPublicProperty(true).setRegions(Arrays.asList(RegionSlug.SFO2, RegionSlug.TOR1)).setCreatedAt(OffsetDateTime.parse("2021-06-11T00:23Z")).setMinDiskSize(1283788447).setSizeGigabytes(12.315691F).setDescription("rchwudlxeei").setTags(Arrays.asList("mnoejhqlfmsib", "oyrfgxk", "dpmypgfqvmtywh")).setStatus(ImageStatus.NEW).setErrorMessage("p");
