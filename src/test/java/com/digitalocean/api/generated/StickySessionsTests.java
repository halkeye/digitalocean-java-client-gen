...
public final class StickySessionsTests {
    ...
    public void testDeserialize() {
        StickySessions model = BinaryData.fromString("{\"type\":\"none\",\"cookie_name\":\"gjzscueza\",\"cookie_ttl_seconds\":1749500004}").toObject(StickySessions.class);
    ...
    public void testSerialize() {
        StickySessions model = new StickySessions().setType(StickySessionsType.NONE).setCookieName("gjzscueza").setCookieTtlSeconds(1749500004);
