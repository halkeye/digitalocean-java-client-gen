...
public final class ComponentsCbli51ResponsesDropletActionsResponseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsCbli51ResponsesDropletActionsResponseContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"actions\":[{\"id\":21349222,\"status\":\"completed\",\"type\":\"ezpfki\",\"started_at\":\"2021-06-20T10:54:30Z\",\"completed_at\":\"2020-12-23T00:05:51Z\",\"resource_id\":1056831410,\"resource_type\":\"aoq\",\"region\":{\"name\":\"gpto\",\"slug\":\"xjqfiafcnlrtbfi\",\"available\":true}},{\"id\":1825571960,\"status\":\"in-progress\",\"type\":\"olbuauktwieope\",\"started_at\":\"2021-07-10T13:35Z\",\"completed_at\":\"2021-07-29T21:43:01Z\",\"resource_id\":207870243,\"resource_type\":\"swyiljpibkgxyxy\",\"region\":{\"name\":\"xre\",\"slug\":\"do\",\"available\":true}}]}")
                        .toObject(ComponentsCbli51ResponsesDropletActionsResponseContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2020-12-23T00:05:51Z"), model.getActions().get(0).getCompletedAt());
    ...
    public void testSerialize() {
        ComponentsCbli51ResponsesDropletActionsResponseContentApplicationJsonSchema model =
                new ComponentsCbli51ResponsesDropletActionsResponseContentApplicationJsonSchema()
                        .setActions(
                                Arrays.asList(
                                        new Action()
                                                .setId(21349222)
                                                ...
                                                .setType("ezpfki")
                                                .setStartedAt(OffsetDateTime.parse("2021-06-20T10:54:30Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2020-12-23T00:05:51Z"))
                                                .setResourceId(1056831410)
                                                .setResourceType("aoq")
                                                .setRegion(
                                                        new Region()
                                                                .setName("gpto")
                                                                .setSlug("xjqfiafcnlrtbfi")
                                                                .setAvailable(true)),
                                        new Action()
                                                .setId(1825571960)
                                                .setStatus(ActionStatus.IN_PROGRESS)
                                                .setType("olbuauktwieope")
                                                .setStartedAt(OffsetDateTime.parse("2021-07-10T13:35Z"))
                                                .setCompletedAt(OffsetDateTime.parse("2021-07-29T21:43:01Z"))
                                                .setResourceId(207870243)
                                                .setResourceType("swyiljpibkgxyxy")
                                                .setRegion(
                                                        new Region().setName("xre").setSlug("do").setAvailable(true))));
        model =
