...
public final class Components1Ariq5GResponsesAllRepositoriesContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(
                OffsetDateTime.parse("2021-10-29T17:27:49Z"),
    ...
    public void testSerialize() {
        Components1Ariq5GResponsesAllRepositoriesContentApplicationJsonSchema model =
                new Components1Ariq5GResponsesAllRepositoriesContentApplicationJsonSchema()
                        .setRepositories(
                                Arrays.asList(
                                        new Repository()
                                                .setRegistryName("fsvpzxg")
                                                .setName("wxuymlfjymg")
                                                .setLatestTag(
                                                        new RepositoryTag()
                                                                .setRegistryName("szcfyzqpeqreg")
                                                                .setRepository("rdpagknxmaovr")
                                                                .setTag("hlnzffew")
                                                                .setManifestDigest("kycjcg")
                                                                .setCompressedSizeBytes(1608962177)
                                                                .setSizeBytes(1908779140)
                                                                .setUpdatedAt(
                                                                        OffsetDateTime.parse("2021-10-29T17:27:49Z")))
                                                .setTagCount(1628148711),
                                        new Repository()
                                                .setRegistryName("fwtyd")
                                                .setName("mabhgc")
                                                .setLatestTag(
                                                        new RepositoryTag()
                                                                .setRegistryName("qzhpvhxpbad")
                                                                .setRepository("eullgfyog")
                                                                .setTag("scjpvqe")
                                                                .setManifestDigest("xkomwdzpzlhcue")
                                                                .setCompressedSizeBytes(2005686175)
                                                                .setSizeBytes(2138095366)
                                                                .setUpdatedAt(
                                                                        OffsetDateTime.parse("2021-08-09T06:33:48Z")))
                                                .setTagCount(1663750320)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(404924727));
        model =
