...
public final class AppsGetInstanceSizeResponseTests {
    ...
    public void testDeserialize() {
        AppsGetInstanceSizeResponse model = BinaryData.fromString("{\"instance_size\":{\"cpu_type\":\"UNSPECIFIED\",\"cpus\":\"hemlwywaee\",\"memory_bytes\":\"gfbukklelss\",\"name\":\"lycsxz\",\"slug\":\"ksrl\",\"tier_downgrade_to\":\"desqplpvmjcdo\",\"tier_slug\":\"bidyv\",\"tier_upgrade_to\":\"owx\",\"usd_per_month\":\"piudeugfsxzecpa\",\"usd_per_second\":\"kufykhvu\"}}").toObject(AppsGetInstanceSizeResponse.class);
    ...
    public void testSerialize() {
        AppsGetInstanceSizeResponse model = new AppsGetInstanceSizeResponse().setInstanceSize(new AppsInstanceSize().setCpuType(InstanceSizeCpuType.UNSPECIFIED).setCpus("hemlwywaee").setMemoryBytes("gfbukklelss").setName("lycsxz").setSlug("ksrl").setTierDowngradeTo("desqplpvmjcdo").setTierSlug("bidyv").setTierUpgradeTo("owx").setUsdPerMonth("piudeugfsxzecpa").setUsdPerSecond("kufykhvu"));
