...
public final class AppAlertProgressStepReasonTests {
    ...
    public void testDeserialize() {
        AppAlertProgressStepReason model =
                BinaryData.fromString("{\"code\":\"wtbbaedorvvmqf\",\"message\":\"ygbdgwumgxdgdhpa\"}")
                        .toObject(AppAlertProgressStepReason.class);
    ...
    public void testSerialize() {
        AppAlertProgressStepReason model =
                new AppAlertProgressStepReason().setCode("wtbbaedorvvmqf").setMessage("ygbdgwumgxdgdhpa");
