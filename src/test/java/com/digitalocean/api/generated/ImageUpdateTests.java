...
public final class ImageUpdateTests {
    ...
    public void testDeserialize() {
        ImageUpdate model =
                BinaryData.fromString("{\"name\":\"kqiq\",\"distribution\":\"Ubuntu\",\"description\":\"hlq\"}")
    ...
    public void testSerialize() {
        ImageUpdate model =
                new ImageUpdate().setName("kqiq").setDistribution(Distribution.UBUNTU).setDescription("hlq");
