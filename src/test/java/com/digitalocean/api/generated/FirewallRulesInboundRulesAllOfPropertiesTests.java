...
public final class FirewallRulesInboundRulesAllOfPropertiesTests {
    ...
    public void testDeserialize() {
        FirewallRulesInboundRulesAllOfProperties model =
                BinaryData.fromString(
                                "{\"addresses\":[\"nmotpuwnnoh\"],\"droplet_ids\":[1117526151,1229503991,146984176,14114597],\"load_balancer_uids\":[\"juypwyiulaynosu\"],\"kubernetes_ids\":[\"haxttpf\",\"mwgsghq\"]}")
                        .toObject(FirewallRulesInboundRulesAllOfProperties.class);
    ...
    public void testSerialize() {
        FirewallRulesInboundRulesAllOfProperties model =
                new FirewallRulesInboundRulesAllOfProperties()
                        .setAddresses(Arrays.asList("nmotpuwnnoh"))
                        .setDropletIds(Arrays.asList(1117526151, 1229503991, 146984176, 14114597))
                        .setLoadBalancerUids(Arrays.asList("juypwyiulaynosu"))
                        .setKubernetesIds(Arrays.asList("haxttpf", "mwgsghq"));
