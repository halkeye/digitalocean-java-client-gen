...
public final class ListAlertPolicyTests {
    ...
    public void testDeserialize() {
        ListAlertPolicy model = BinaryData.fromString("{\"policies\":[{\"alerts\":{\"email\":[],\"slack\":[]},\"compare\":\"GreaterThan\",\"description\":\"htmzstqlfxolrwv\",\"enabled\":false,\"entities\":[\"x\",\"fjswequflzyyopoa\",\"twwgwqubot\"],\"tags\":[\"ufrkwjiemimdt\",\"powewjs\"],\"type\":\"v1/insights/lbaas/droplet_health\",\"uuid\":\"eeedddrftfquulp\",\"value\":13.92169,\"window\":\"10m\"}]}").toObject(ListAlertPolicy.class);
    ...
    public void testSerialize() {
        ListAlertPolicy model = new ListAlertPolicy().setPolicies(Arrays.asList(new AlertPolicy().setAlerts(new Alerts().setEmail(Arrays.asList()).setSlack(Arrays.asList())).setCompare(AlertPolicyCompare.GREATER_THAN).setDescription("htmzstqlfxolrwv").setEnabled(false).setEntities(Arrays.asList("x", "fjswequflzyyopoa", "twwgwqubot")).setTags(Arrays.asList("ufrkwjiemimdt", "powewjs")).setType(AlertPolicyType.V1INSIGHTS_LBAAS_DROPLET_HEALTH).setUuid("eeedddrftfquulp").setValue(13.92169f).setWindow(AlertPolicyWindow.TENM)));
