...
public final class DropletCreateApplicationJsonOneOfPropertiesTests {
    ...
    public void testDeserialize() {
        DropletCreateApplicationJsonOneOfProperties model =
                BinaryData.fromString(
                                "{\"actions\":[{\"id\":643700815,\"rel\":\"xnmxgnmguzb\",\"href\":\"vorbalkjnbk\"},{\"id\":42280374,\"rel\":\"ltqstqkqsygxiyn\",\"href\":\"ovagzkheuban\"},{\"id\":239129430,\"rel\":\"pqcckqiawzlz\",\"href\":\"aslgacizuxlrarwp\"},{\"id\":1124635117,\"rel\":\"udoejtighsxjp\",\"href\":\"nkqb\"}]}")
                        .toObject(DropletCreateApplicationJsonOneOfProperties.class);
    ...
    public void testSerialize() {
        DropletCreateApplicationJsonOneOfProperties model =
                new DropletCreateApplicationJsonOneOfProperties()
                        .setActions(
                                Arrays.asList(
                                        new ActionLink().setId(643700815).setRel("xnmxgnmguzb").setHref("vorbalkjnbk"),
                                        new ActionLink()
                                                .setId(42280374)
                                                .setRel("ltqstqkqsygxiyn")
                                                .setHref("ovagzkheuban"),
                                        new ActionLink()
                                                .setId(239129430)
                                                .setRel("pqcckqiawzlz")
                                                .setHref("aslgacizuxlrarwp"),
                                        new ActionLink().setId(1124635117).setRel("udoejtighsxjp").setHref("nkqb")));
