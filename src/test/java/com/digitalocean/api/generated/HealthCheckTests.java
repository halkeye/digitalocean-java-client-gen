...
public final class HealthCheckTests {
    ...
    public void testDeserialize() {
        HealthCheck model = BinaryData.fromString("{\"protocol\":\"http\",\"port\":1710348012,\"path\":\"pmw\",\"check_interval_seconds\":658607362,\"response_timeout_seconds\":816933848,\"unhealthy_threshold\":1394061441,\"healthy_threshold\":699538327}").toObject(HealthCheck.class);
    ...
    public void testSerialize() {
        HealthCheck model = new HealthCheck().setProtocol(HealthCheckProtocol.HTTP).setPort(1710348012).setPath("pmw").setCheckIntervalSeconds(658607362).setResponseTimeoutSeconds(816933848).setUnhealthyThreshold(1394061441).setHealthyThreshold(699538327);
