...
public final class AssociatedKubernetesResourcesTests {
    ...
    public void testDeserialize() {
        AssociatedKubernetesResources model =
                BinaryData.fromString(
                                "{\"load_balancers\":[{\"id\":\"hdoaqipmnx\",\"name\":\"frsbzrnmuvwvpu\"}],\"volumes\":[{\"id\":\"tb\",\"name\":\"ekjcnginxdvma\"},{\"id\":\"qxfvgyx\",\"name\":\"xynofxlttxoqxtd\"},{\"id\":\"ujsjirkrpskcj\",\"name\":\"mofbnivd\"},{\"id\":\"kykpaxnls\",\"name\":\"nyscaccpt\"}],\"volume_snapshots\":[{\"id\":\"x\",\"name\":\"xxicee\"}]}")
                        .toObject(AssociatedKubernetesResources.class);
    ...
    public void testSerialize() {
        AssociatedKubernetesResources model =
                new AssociatedKubernetesResources()
                        .setLoadBalancers(
                                Arrays.asList(
                                        new AssociatedKubernetesResource()
                                                .setId("hdoaqipmnx")
                                                .setName("frsbzrnmuvwvpu")))
                        .setVolumes(
                                Arrays.asList(
                                        new AssociatedKubernetesResource().setId("tb").setName("ekjcnginxdvma"),
                                        new AssociatedKubernetesResource().setId("qxfvgyx").setName("xynofxlttxoqxtd"),
                                        new AssociatedKubernetesResource().setId("ujsjirkrpskcj").setName("mofbnivd"),
                                        new AssociatedKubernetesResource().setId("kykpaxnls").setName("nyscaccpt")))
                        .setVolumeSnapshots(
