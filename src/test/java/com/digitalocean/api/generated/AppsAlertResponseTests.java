...
public final class AppsAlertResponseTests {
    ...
    public void testDeserialize() {
        AppsAlertResponse model = BinaryData.fromString("{\"alert\":{\"id\":\"xfwush\",\"component_name\":\"pkupnq\",\"spec\":{\"rule\":\"DEPLOYMENT_FAILED\",\"disabled\":true,\"operator\":\"UNSPECIFIED_OPERATOR\",\"value\":93.58416,\"window\":\"ONE_HOUR\"},\"emails\":[\"ojfizfav\",\"jzwfb\",\"yay\",\"mmfz\"],\"slack_webhooks\":[{\"url\":\"xrzxmdewsrsxkrp\",\"channel\":\"jazejwwviyoyp\"},{\"url\":\"hbrnnhjx\",\"channel\":\"wjh\"},{\"url\":\"biwetpo\",\"channel\":\"c\"}],\"phase\":\"ERROR\",\"progress\":{\"steps\":[]}}}").toObject(AppsAlertResponse.class);
    ...
    public void testSerialize() {
        AppsAlertResponse model = new AppsAlertResponse().setAlert(new AppAlert().setComponentName("pkupnq").setSpec(new AppAlertSpec().setRule(AppAlertSpecRule.DEPLOYMENT_FAILED).setDisabled(true).setOperator(AppAlertSpecOperator.UNSPECIFIED_OPERATOR).setValue(93.58416F).setWindow(AppAlertSpecWindow.ONEHOUR)).setEmails(Arrays.asList("ojfizfav", "jzwfb", "yay", "mmfz")).setSlackWebhooks(Arrays.asList(new AppAlertSlackWebhook().setUrl("xrzxmdewsrsxkrp").setChannel("jazejwwviyoyp"), new AppAlertSlackWebhook().setUrl("hbrnnhjx").setChannel("wjh"), new AppAlertSlackWebhook().setUrl("biwetpo").setChannel("c"))).setPhase(AppAlertPhase.ERROR).setProgress(new AppAlertProgress().setSteps(Arrays.asList())));
