...
public final class KubernetesNodePoolTests {
    ...
    public void testDeserialize() {
        KubernetesNodePool model =
                BinaryData.fromString(
                                "{\"name\":\"wnghojo\",\"count\":916967136,\"tags\":[\"micjixxfsf\",\"crtnuguefxxi\"],\"taints\":[{\"key\":\"veywetkrhlolmcn\",\"value\":\"pfgsvbbvaqdljnp\",\"effect\":\"PreferNoSchedule\"},{\"key\":\"n\",\"value\":\"etawevx\",\"effect\":\"PreferNoSchedule\"},{\"key\":\"kdxl\",\"value\":\"vdovbrb\",\"effect\":\"NoExecute\"}],\"auto_scale\":false,\"min_nodes\":1265726343,\"max_nodes\":220876789,\"nodes\":[{\"name\":\"cbnygd\",\"status\":{\"state\":\"draining\"},\"droplet_id\":\"bpwyykd\",\"created_at\":\"2020-12-22T08:32:32Z\",\"updated_at\":\"2021-02-03T07:20:15Z\"}],\"size\":\"zndasdnidmj\"}")
                        .toObject(KubernetesNodePool.class);
    ...
    public void testSerialize() {
        KubernetesNodePool model =
                new KubernetesNodePool()
                        ...
                        .setName("wnghojo")
                        .setCount(916967136)
                        .setTags(Arrays.asList("micjixxfsf", "crtnuguefxxi"))
                        .setTaints(
                                Arrays.asList(
                                        new KubernetesNodePoolTaint()
                                                .setKey("veywetkrhlolmcn")
                                                .setValue("pfgsvbbvaqdljnp")
                        ...
                        .setAutoScale(false)
                        .setMinNodes(1265726343)
                        .setMaxNodes(220876789);
