...
public final class ActionTests {
    ...
    public void testDeserialize() {
        Action model = BinaryData.fromString("{\"id\":2010421384,\"status\":\"errored\",\"type\":\"xsabkyqdu\",\"started_at\":\"2021-07-17T19:18:59Z\",\"completed_at\":\"2021-09-28T15:07:41Z\",\"resource_id\":1447556622,\"resource_type\":\"dzevndhkrw\",\"region\":{\"name\":\"appd\",\"slug\":\"bdkvwrwjf\",\"available\":false}}").toObject(Action.class);
    ...
    public void testSerialize() {
        Action model = new Action().setId(2010421384).setStatus(ActionStatus.ERRORED).setType("xsabkyqdu").setStartedAt(OffsetDateTime.parse("2021-07-17T19:18:59Z")).setCompletedAt(OffsetDateTime.parse("2021-09-28T15:07:41Z")).setResourceId(1447556622).setResourceType("dzevndhkrw").setRegion(new Region().setName("appd").setSlug("bdkvwrwjf").setAvailable(false));
