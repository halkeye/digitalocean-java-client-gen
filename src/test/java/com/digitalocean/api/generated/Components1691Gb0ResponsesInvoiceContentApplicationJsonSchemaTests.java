...
public final class Components1691Gb0ResponsesInvoiceContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1691Gb0ResponsesInvoiceContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1752119196},\"invoice_items\":[{\"product\":\"mbmslzoyov\",\"resource_uuid\":\"dbpqvybefgvm\",\"resource_id\":\"okcvtlubses\",\"group_description\":\"cua\",\"description\":\"rhunlp\",\"amount\":\"ykycndzfqi\",\"duration\":\"reuykbbmnwagl\",\"duration_unit\":\"xoe\",\"start_time\":\"nqlnfwmyymvqd\",\"end_time\":\"bhfckdvezcrcssb\",\"project_name\":\"ddubbnqfblhkal\"}]}")
                        .toObject(Components1691Gb0ResponsesInvoiceContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1691Gb0ResponsesInvoiceContentApplicationJsonSchema model =
                new Components1691Gb0ResponsesInvoiceContentApplicationJsonSchema()
                        .setInvoiceItems(
                                Arrays.asList(
                                        new InvoiceItem()
                                                .setProduct("mbmslzoyov")
                                                .setResourceUuid("dbpqvybefgvm")
                                                .setResourceId("okcvtlubses")
                                                .setGroupDescription("cua")
                                                .setDescription("rhunlp")
                                                .setAmount("ykycndzfqi")
                                                .setDuration("reuykbbmnwagl")
                                                .setDurationUnit("xoe")
                                                .setStartTime("nqlnfwmyymvqd")
                                                .setEndTime("bhfckdvezcrcssb")
                                                .setProjectName("ddubbnqfblhkal")))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1752119196));
        model =
