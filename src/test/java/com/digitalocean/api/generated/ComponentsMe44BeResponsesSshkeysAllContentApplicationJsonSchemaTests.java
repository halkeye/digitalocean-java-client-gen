...
public final class ComponentsMe44BeResponsesSshkeysAllContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsMe44BeResponsesSshkeysAllContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":1983903346},\"ssh_keys\":[{\"id\":857832438,\"fingerprint\":\"arcryuanzwuxzdxt\",\"public_key\":\"yrlhmwhfpmrqobm\",\"name\":\"u\"}]}")
                        .toObject(ComponentsMe44BeResponsesSshkeysAllContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsMe44BeResponsesSshkeysAllContentApplicationJsonSchema model =
                new ComponentsMe44BeResponsesSshkeysAllContentApplicationJsonSchema()
                        .setSshKeys(Arrays.asList(new SshKeys().setPublicKey("yrlhmwhfpmrqobm").setName("u")))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(1983903346));
        model =
