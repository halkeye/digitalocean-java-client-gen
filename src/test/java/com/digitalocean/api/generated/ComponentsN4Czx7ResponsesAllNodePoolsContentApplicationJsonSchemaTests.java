...
public final class ComponentsN4Czx7ResponsesAllNodePoolsContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        ComponentsN4Czx7ResponsesAllNodePoolsContentApplicationJsonSchema model = new ComponentsN4Czx7ResponsesAllNodePoolsContentApplicationJsonSchema().setNodePools(Arrays.asList(new KubernetesNodePool().setSize("rbrct").setName("xsqcowscuyfqlam").setCount(578004367).setTags(Arrays.asList("u", "k", "fu", "pn")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(487218261).setMaxNodes(1859577844), new KubernetesNodePool().setSize("e").setName("oocqsazmzlpc").setCount(415205509).setTags(Arrays.asList("xxr", "ic")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(1959146131).setMaxNodes(1679768391), new KubernetesNodePool().setSize("jxlpiy").setName("finmp").setCount(976296889).setTags(Arrays.asList("kjr", "fwkyluobdxw", "qdcclcv", "srupayl")).setTaints(Arrays.asList()).setAutoScale(false).setMinNodes(1758659043).setMaxNodes(270029055)));
        model = BinaryData.fromObject(model).toObject(ComponentsN4Czx7ResponsesAllNodePoolsContentApplicationJsonSchema.class);
        Assertions.assertEquals("rbrct", model.getNodePools().get(0).getSize());
        Assertions.assertEquals("xsqcowscuyfqlam", model.getNodePools().get(0).getName());
        Assertions.assertEquals(578004367, model.getNodePools().get(0).getCount());
        Assertions.assertEquals("u", model.getNodePools().get(0).getTags().get(0));
