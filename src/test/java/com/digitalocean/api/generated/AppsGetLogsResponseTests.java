...
public final class AppsGetLogsResponseTests {
    ...
    public void testDeserialize() {
        AppsGetLogsResponse model = BinaryData.fromString("{\"historic_urls\":[\"c\",\"rkolawjm\"],\"live_url\":\"mwrokcdxfzzzwyja\"}").toObject(AppsGetLogsResponse.class);
    ...
    public void testSerialize() {
        AppsGetLogsResponse model = new AppsGetLogsResponse().setHistoricUrls(Arrays.asList("c", "rkolawjm")).setLiveUrl("mwrokcdxfzzzwyja");
