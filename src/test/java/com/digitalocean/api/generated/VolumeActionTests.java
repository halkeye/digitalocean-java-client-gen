    ...
    public void testDeserialize() {
        VolumeAction model =
                BinaryData.fromString(
                                "{\"type\":\"maxcebnb\",\"resource_id\":200495153,\"id\":357172292,\"status\":\"completed\",\"started_at\":\"2021-02-25T00:20:16Z\",\"completed_at\":\"2021-10-24T08:03:12Z\",\"resource_type\":\"erwqxpjpv\",\"region\":{\"name\":\"dfkhttuobrxz\",\"slug\":\"hyt\",\"available\":false}}")
                        .toObject(VolumeAction.class);
    ...
    public void testSerialize() {
        VolumeAction model =
                new VolumeAction()
                        ...
                        .setStartedAt(OffsetDateTime.parse("2021-02-25T00:20:16Z"))
                        .setCompletedAt(OffsetDateTime.parse("2021-10-24T08:03:12Z"))
                        .setResourceType("erwqxpjpv")
                        .setRegion(new Region().setName("dfkhttuobrxz").setSlug("hyt").setAvailable(false))
                        .setType("maxcebnb")
                        .setResourceId(200495153);
