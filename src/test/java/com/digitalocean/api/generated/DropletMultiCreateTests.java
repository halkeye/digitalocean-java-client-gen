...
public final class DropletMultiCreateTests {
    ...
    public void testDeserialize() {
        DropletMultiCreate model =
                BinaryData.fromString(
                                "{\"names\":[\"nfy\",\"avfrb\"],\"region\":\"picdbk\",\"size\":\"dj\",\"ssh_keys\":[],\"backups\":false,\"ipv6\":false,\"monitoring\":true,\"tags\":[\"gonjhxshthmgpczq\",\"lptkbvc\",\"xt\",\"higqqbtimpkjbl\"],\"user_data\":\"nsihqhudsm\",\"private_networking\":false,\"vpc_uuid\":\"awja\",\"with_droplet_agent\":false}")
                        .toObject(DropletMultiCreate.class);
    ...
    public void testSerialize() {
        DropletMultiCreate model =
                new DropletMultiCreate()
                        ...
                        .setIpv6(false)
                        .setMonitoring(true)
                        .setTags(Arrays.asList("gonjhxshthmgpczq", "lptkbvc", "xt", "higqqbtimpkjbl"))
                        .setUserData("nsihqhudsm")
                        .setPrivateNetworking(false)
                        .setVpcUuid("awja")
                        .setWithDropletAgent(false)
                        .setNames(Arrays.asList("nfy", "avfrb"));
