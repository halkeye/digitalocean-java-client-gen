...
public final class FirewallRuleTargetTests {
    ...
    public void testDeserialize() {
        FirewallRuleTarget model =
                BinaryData.fromString(
                                "{\"addresses\":[\"lddauqmllfe\",\"thxuarigrjdl\",\"lkqhvkrbzkua\"],\"droplet_ids\":[450518329,567743563,1658926692],\"load_balancer_uids\":[\"uul\"],\"kubernetes_ids\":[\"t\"]}")
                        .toObject(FirewallRuleTarget.class);
    ...
    public void testSerialize() {
        FirewallRuleTarget model =
                new FirewallRuleTarget()
                        .setAddresses(Arrays.asList("lddauqmllfe", "thxuarigrjdl", "lkqhvkrbzkua"))
                        .setDropletIds(Arrays.asList(450518329, 567743563, 1658926692))
                        .setLoadBalancerUids(Arrays.asList("uul"))
                        .setKubernetesIds(Arrays.asList("t"));
