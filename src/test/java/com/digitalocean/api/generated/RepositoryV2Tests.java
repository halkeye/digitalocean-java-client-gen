...
public final class RepositoryV2Tests {
    ...
    public void testSerialize() {
        RepositoryV2 model = new RepositoryV2().setRegistryName("zcsla").setName("rkqoyimxpg").setLatestManifest(new RepositoryManifest().setRegistryName("teagbgac").setRepository("pjuytvu").setDigest("ylpbybki").setCompressedSizeBytes(898349819).setSizeBytes(1330737112).setUpdatedAt(OffsetDateTime.parse("2021-06-11T04:56:34Z")).setTags(Arrays.asList("pwdj", "au", "fshznu")).setBlobs(Arrays.asList(new RepositoryBlob().setDigest("haaaxxdcdjm").setCompressedSizeBytes(972935361), new RepositoryBlob().setDigest("xfrmbecxstowag").setCompressedSizeBytes(2039605634), new RepositoryBlob().setDigest("ihwe").setCompressedSizeBytes(1755943107), new RepositoryBlob().setDigest("aqgblkkncyp").setCompressedSizeBytes(51713703)))).setTagCount(1720955047).setManifestCount(288667891);
