...
public final class Components1Vf55PaResponsesExistingImageContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Vf55PaResponsesExistingImageContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"image\":{\"id\":1431651894,\"name\":\"rchxwwuzdmhvwl\",\"type\":\"backup\",\"distribution\":\"RancherOS\",\"slug\":\"mlitqdsj\",\"public\":false,\"regions\":[\"nyc3\",\"sfo2\"],\"created_at\":\"2021-02-28T22:25:44Z\",\"min_disk_size\":181599105,\"size_gigabytes\":38.409676,\"description\":\"ifefndslv\",\"tags\":[\"emwsieeailwdq\",\"qfy\"],\"status\":\"NEW\",\"error_message\":\"mfxlkdlgwgnamkuu\"}}")
                        .toObject(Components1Vf55PaResponsesExistingImageContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Vf55PaResponsesExistingImageContentApplicationJsonSchema model =
                new Components1Vf55PaResponsesExistingImageContentApplicationJsonSchema()
                        .setImage(
                                new Image()
                                        .setName("rchxwwuzdmhvwl")
                                        .setType(ImageType.BACKUP)
                                        .setDistribution(Distribution.RANCHER_OS)
                                        .setSlug("mlitqdsj")
                                        .setPublicProperty(false)
                                        .setRegions(Arrays.asList(RegionSlug.NYC3, RegionSlug.SFO2))
                                        .setCreatedAt(OffsetDateTime.parse("2021-02-28T22:25:44Z"))
                                        .setMinDiskSize(181599105)
                                        .setSizeGigabytes(38.409676F)
                                        .setDescription("ifefndslv")
                                        .setTags(Arrays.asList("emwsieeailwdq", "qfy"))
                                        .setStatus(ImageStatus.NEW)
                                        .setErrorMessage("mfxlkdlgwgnamkuu"));
        model =
