...
public final class ComponentsWgxinyResponsesReservedIpActionContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsWgxinyResponsesReservedIpActionContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"action\":{\"id\":1499800798,\"status\":\"in-progress\",\"type\":\"gkwedwlxtzhgbgb\",\"started_at\":\"2021-01-22T14:24:40Z\",\"completed_at\":\"2021-11-15T03:09:21Z\",\"resource_id\":1767903934,\"resource_type\":\"mvrrqfibpk\",\"region\":{\"name\":\"amrlfizjuddnd\",\"slug\":\"hupngyhylqyafew\",\"available\":true}}}")
                        .toObject(ComponentsWgxinyResponsesReservedIpActionContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsWgxinyResponsesReservedIpActionContentApplicationJsonSchema model =
                new ComponentsWgxinyResponsesReservedIpActionContentApplicationJsonSchema()
                        .setAction(
                                new Action()
                                        .setId(1499800798)
                                        .setStatus(ActionStatus.IN_PROGRESS)
                                        .setType("gkwedwlxtzhgbgb")
                                        .setStartedAt(OffsetDateTime.parse("2021-01-22T14:24:40Z"))
                                        .setCompletedAt(OffsetDateTime.parse("2021-11-15T03:09:21Z"))
                                        .setResourceId(1767903934)
                                        .setResourceType("mvrrqfibpk")
                                        .setRegion(
                                                new Region()
                                                        .setName("amrlfizjuddnd")
                                                        .setSlug("hupngyhylqyafew")
                                                        .setAvailable(true)));
        model =
