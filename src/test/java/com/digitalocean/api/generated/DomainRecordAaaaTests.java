...
public final class DomainRecordAaaaTests {
    ...
    public void testDeserialize() {
        DomainRecordAaaa model = BinaryData.fromString("{\"id\":1932285332,\"type\":\"eimseobfsxstcyil\",\"name\":\"zmmx\",\"data\":\"zlquzexo\",\"priority\":1852997398,\"port\":531411541,\"ttl\":1440326594,\"weight\":1964355203,\"flags\":217627140,\"tag\":\"abwmvogljsv\"}").toObject(DomainRecordAaaa.class);
    ...
    public void testSerialize() {
        DomainRecordAaaa model = new DomainRecordAaaa().setType("eimseobfsxstcyil").setName("zmmx").setData("zlquzexo").setPriority(1852997398).setPort(531411541).setTtl(1440326594).setWeight(1964355203).setFlags(217627140).setTag("abwmvogljsv");
