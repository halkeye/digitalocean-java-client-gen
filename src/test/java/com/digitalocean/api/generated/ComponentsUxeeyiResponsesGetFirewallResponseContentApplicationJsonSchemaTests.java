...
public final class ComponentsUxeeyiResponsesGetFirewallResponseContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsUxeeyiResponsesGetFirewallResponseContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"firewall\":{\"id\":\"ejogmkor\",\"status\":\"failed\",\"created_at\":\"2021-11-28T18:11:05Z\",\"pending_changes\":[{\"droplet_id\":1430715530,\"removing\":false,\"status\":\"bsn\"},{\"droplet_id\":269831289,\"removing\":false,\"status\":\"wkmz\"}],\"name\":\"fetya\",\"droplet_ids\":[725690227],\"inbound_rules\":[{\"protocol\":\"icmp\",\"ports\":\"zgbjbhrpgi\"},{\"protocol\":\"tcp\",\"ports\":\"ttcucrcm\"},{\"protocol\":\"icmp\",\"ports\":\"ixpqj\"},{\"protocol\":\"tcp\",\"ports\":\"ifhb\"}],\"outbound_rules\":[{\"protocol\":\"icmp\",\"ports\":\"ttohqclna\"}]}}")
                        .toObject(ComponentsUxeeyiResponsesGetFirewallResponseContentApplicationJsonSchema.class);
        ...
        Assertions.assertEquals(
                FirewallRuleBaseProtocol.ICMP, model.getFirewall().getOutboundRules().get(0).getProtocol());
    ...
    public void testSerialize() {
        ComponentsUxeeyiResponsesGetFirewallResponseContentApplicationJsonSchema model =
                new ComponentsUxeeyiResponsesGetFirewallResponseContentApplicationJsonSchema()
                        .setFirewall(
                                new Firewall()
                                        .setInboundRules(
                                                Arrays.asList(
                                        ...
                                        .setOutboundRules(
                                                Arrays.asList(
                                                        new FirewallRulesOutboundRulesItem()
                                                                ...
                                                                .setPorts("ttohqclna")))
                                        .setName("fetya")
                                        .setDropletIds(Arrays.asList(725690227)));
        model =
