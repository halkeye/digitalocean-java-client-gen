...
public final class Paths1Mxnz3IV2FirewallsFirewallIdDropletsPostRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Paths1Mxnz3IV2FirewallsFirewallIdDropletsPostRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString("{\"droplet_ids\":[1496067796,1965532334]}")
                        .toObject(
    ...
    public void testSerialize() {
        Paths1Mxnz3IV2FirewallsFirewallIdDropletsPostRequestbodyContentApplicationJsonSchema model =
                new Paths1Mxnz3IV2FirewallsFirewallIdDropletsPostRequestbodyContentApplicationJsonSchema()
                        .setDropletIds(Arrays.asList(1496067796, 1965532334));
        model =
