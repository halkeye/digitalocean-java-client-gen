...
public final class AppVariableDefinitionTests {
    ...
    public void testDeserialize() {
        AppVariableDefinition model = BinaryData.fromString("{\"key\":\"jazysdzhezwwvaiq\",\"scope\":\"UNSET\",\"type\":\"SECRET\",\"value\":\"nk\"}").toObject(AppVariableDefinition.class);
    ...
    public void testSerialize() {
        AppVariableDefinition model = new AppVariableDefinition().setKey("jazysdzhezwwvaiq").setScope(AppVariableDefinitionScope.UNSET).setType(AppVariableDefinitionType.SECRET).setValue("nk");
