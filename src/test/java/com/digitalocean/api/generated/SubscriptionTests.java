...
public final class SubscriptionTests {
    ...
    public void testDeserialize() {
        Subscription model = BinaryData.fromString("{\"tier\":{\"name\":\"gqokjbmsrk\",\"slug\":\"yxxhwrlqom\",\"included_repositories\":1725463021,\"included_storage_bytes\":789600653,\"allow_storage_overage\":false,\"included_bandwidth_bytes\":86867819,\"monthly_price_in_cents\":1364902399,\"storage_overage_price_in_cents\":745842544},\"created_at\":\"2021-05-31T20:29:17Z\",\"updated_at\":\"2021-11-12T12:18Z\"}").toObject(Subscription.class);
    ...
    public void testSerialize() {
        Subscription model = new Subscription().setTier(new SubscriptionTierBase().setName("gqokjbmsrk").setSlug("yxxhwrlqom").setIncludedRepositories(1725463021).setIncludedStorageBytes(789600653).setAllowStorageOverage(false).setIncludedBandwidthBytes(86867819).setMonthlyPriceInCents(1364902399).setStorageOveragePriceInCents(745842544));
