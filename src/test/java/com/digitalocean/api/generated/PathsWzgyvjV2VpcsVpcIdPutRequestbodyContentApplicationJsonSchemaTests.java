...
public final class PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString("{\"default\":false,\"name\":\"gaex\",\"description\":\"skvctvu\"}")
                        .toObject(PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema model =
                new PathsWzgyvjV2VpcsVpcIdPutRequestbodyContentApplicationJsonSchema()
                        .setName("gaex")
                        .setDescription("skvctvu")
