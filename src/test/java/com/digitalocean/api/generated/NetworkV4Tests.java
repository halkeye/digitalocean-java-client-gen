...
public final class NetworkV4Tests {
    ...
    public void testDeserialize() {
        NetworkV4 model = BinaryData.fromString("{\"ip_address\":\"fdxaglzfytlbtlq\",\"netmask\":\"pxouvmr\",\"gateway\":\"flikyypzkgxfxfmy\",\"type\":\"private\"}").toObject(NetworkV4.class);
    ...
    public void testSerialize() {
        NetworkV4 model = new NetworkV4().setIpAddress("fdxaglzfytlbtlq").setNetmask("pxouvmr").setGateway("flikyypzkgxfxfmy").setType(NetworkV4Type.PRIVATE);
