...
public final class PathsDh0O2RV2LoadBalancersLbIdForwardingRulesPostRequestbodyContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        PathsDh0O2RV2LoadBalancersLbIdForwardingRulesPostRequestbodyContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"forwarding_rules\":[{\"entry_protocol\":\"http2\",\"entry_port\":1790621244,\"target_protocol\":\"http2\",\"target_port\":103033953,\"certificate_id\":\"btfloilmk\",\"tls_passthrough\":true}]}")
                        .toObject(
                                PathsDh0O2RV2LoadBalancersLbIdForwardingRulesPostRequestbodyContentApplicationJsonSchema
                                        .class);
        Assertions.assertEquals(
                ForwardingRuleEntryProtocol.HTTP2, model.getForwardingRules().get(0).getEntryProtocol());
        Assertions.assertEquals(1790621244, model.getForwardingRules().get(0).getEntryPort());
        Assertions.assertEquals(
                ForwardingRuleTargetProtocol.HTTP2, model.getForwardingRules().get(0).getTargetProtocol());
    ...
    public void testSerialize() {
        PathsDh0O2RV2LoadBalancersLbIdForwardingRulesPostRequestbodyContentApplicationJsonSchema model =
                new PathsDh0O2RV2LoadBalancersLbIdForwardingRulesPostRequestbodyContentApplicationJsonSchema()
                        .setForwardingRules(
                                Arrays.asList(
                                        new ForwardingRule()
                                                .setEntryProtocol(ForwardingRuleEntryProtocol.HTTP2)
                                                .setEntryPort(1790621244)
                                                .setTargetProtocol(ForwardingRuleTargetProtocol.HTTP2)
                                                .setTargetPort(103033953)
                                                .setCertificateId("btfloilmk")
