...
public final class AppLogDestinationDefinitionTests {
    ...
    public void testDeserialize() {
        AppLogDestinationDefinition model = BinaryData.fromString("{\"name\":\"hhqyi\",\"papertrail\":{\"endpoint\":\"y\"},\"datadog\":{\"endpoint\":\"yavluwmncstt\",\"api_key\":\"jfybvpoekrsgsgb\"},\"logtail\":{\"token\":\"zq\"}}").toObject(AppLogDestinationDefinition.class);
    ...
    public void testSerialize() {
        AppLogDestinationDefinition model = new AppLogDestinationDefinition().setName("hhqyi").setPapertrail(new AppLogDestinationPapertrailSpec().setEndpoint("y")).setDatadog(new AppLogDestinationDatadogSpec().setEndpoint("yavluwmncstt").setApiKey("jfybvpoekrsgsgb")).setLogtail(new AppLogDestinationLogtailSpec().setToken("zq"));
