...
public final class FloatingIpTests {
    ...
    public void testDeserialize() {
        FloatingIp model =
                BinaryData.fromString(
                                "{\"ip\":\"rifiozttcbiichg\",\"region\":{\"name\":\"dsozodwjcfqoyxry\",\"slug\":\"ycymzrlcfgdwzauz\",\"available\":true},\"locked\":true}")
                        .toObject(FloatingIp.class);
    ...
    public void testSerialize() {
        FloatingIp model =
                new FloatingIp()
                        .setIp("rifiozttcbiichg")
                        .setRegion(
                                new FloatingIpRegion()
                                        .setName("dsozodwjcfqoyxry")
                                        .setSlug("ycymzrlcfgdwzauz")
                                        .setAvailable(true))
                        .setLocked(true);
