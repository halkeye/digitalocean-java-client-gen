...
public final class MultipleDropletResponseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-05-05T22:15:12Z"), model.getDroplets().get(0).getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-08-27T10:11:36Z"), model.getDroplets().get(0).getNextBackupWindow().getStart());
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-20T07:59:43Z"), model.getDroplets().get(0).getNextBackupWindow().getEnd());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-07-04T16:33:20Z"), model.getDroplets().get(0).getImage().getCreatedAt());
    ...
    public void testSerialize() {
        MultipleDropletResponse model = new MultipleDropletResponse().setDroplets(Arrays.asList(new Droplet().setId(86766502).setName("cngkegxcypxb").setMemory(1291178098).setVcpus(960544610).setDisk(400268893).setLocked(false).setStatus(DropletStatus.ACTIVE).setKernel(new Kernel().setId(971394241).setName("oxpdxq").setVersion("r")).setCreatedAt(OffsetDateTime.parse("2021-05-05T22:15:12Z")).setFeatures(Arrays.asList("ow", "kiu", "jew", "ahwkxjjm")).setBackupIds(Arrays.asList(1492922483, 271039239, 785648055, 1307109337)).setNextBackupWindow(new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-08-27T10:11:36Z")).setEnd(OffsetDateTime.parse("2021-03-20T07:59:43Z"))).setSnapshotIds(Arrays.asList(1027774384, 1071691858, 683789637)).setImage(new Image().setName("yswcrptveajczx").setType(ImageType.BACKUP).setDistribution(Distribution.FEDORA_ATOMIC).setSlug("krfizrpyw").setPublicProperty(true).setRegions(Arrays.asList()).setCreatedAt(OffsetDateTime.parse("2021-07-04T16:33:20Z")).setMinDiskSize(1847694071).setSizeGigabytes(8.067054F).setDescription("skykpfuofix").setTags(Arrays.asList()).setStatus(ImageStatus.PENDING).setErrorMessage("ykkpyycpa")).setVolumeIds(Arrays.asList("pjprdpwr", "cfpcfjfwzlgz")).setSize(new Size().setSlug("wk").setMemory(650465257).setVcpus(264619884).setDisk(1446786780).setTransfer(19.62331f).setPriceMonthly(78.2249f).setPriceHourly(30.47425f).setRegions(Arrays.asList()).setAvailable(true).setDescription("nnidmdiawpzxk")).setSizeSlug("rntmkctdhu").setNetworks(new DropletNetworks().setV4(Arrays.asList()).setV6(Arrays.asList())).setRegion(new Region().setName("wqpsqaz").setSlug("hqodv").setAvailable(true)).setTags(Arrays.asList("nb", "cbmjkztibniyntsx")).setVpcUuid("fmeftvhk"), new Droplet().setId(48892036).setName("ogjrhskbwgm").setMemory(146775166).setVcpus(2092147628).setDisk(165219531).setLocked(false).setStatus(DropletStatus.OFF).setKernel(new Kernel().setId(1988101548).setName("hcxnwjtpfdzxco").setVersion("fwofwakukzkdtz")).setCreatedAt(OffsetDateTime.parse("2021-08-25T23:54:47Z")).setFeatures(Arrays.asList("ednlwglihezo", "ucmqgisnione", "bzdrdpuenxkgt", "zlm")).setBackupIds(Arrays.asList(1471351682, 212272318, 169178227)).setNextBackupWindow(new DropletNextBackupWindow().setStart(OffsetDateTime.parse("2021-04-10T04:22:57Z")).setEnd(OffsetDateTime.parse("2021-11-03T18:18:17Z"))).setSnapshotIds(Arrays.asList(1160452306, 2009894505)).setImage(new Image().setName("xlxmwtygeqzusi").setType(ImageType.CUSTOM).setDistribution(Distribution.CORE_OS).setSlug("fsgbjmlreesrf").setPublicProperty(true).setRegions(Arrays.asList()).setCreatedAt(OffsetDateTime.parse("2020-12-26T17:04:35Z")).setMinDiskSize(1234465237).setSizeGigabytes(89.02015F).setDescription("olntfx").setTags(Arrays.asList()).setStatus(ImageStatus.DELETED).setErrorMessage("ipfjwfoygizmshx")).setVolumeIds(Arrays.asList("aizabu", "nvgskjtoxjd", "jsjznv", "xqqm")).setSize(new Size().setSlug("i").setMemory(1331358631).setVcpus(160628157).setDisk(2013340237).setTransfer(38.371353f).setPriceMonthly(10.524559f).setPriceHourly(95.00202f).setRegions(Arrays.asList()).setAvailable(true).setDescription("ocxm")).setSizeSlug("fshksnyzmspamwb").setNetworks(new DropletNetworks().setV4(Arrays.asList()).setV6(Arrays.asList())).setRegion(new Region().setName("nlslcef").setSlug("qdktwtkvihlp").setAvailable(false)).setTags(Arrays.asList("woynguu", "hwvladpc")).setVpcUuid("jha"))).setLinks(new Components10LqvkkResponsesDropletCreateContentApplicationJsonSchemaOneof1PropertiesLinks().setActions(Arrays.asList(new ActionLink().setId(1474714310).setRel("kymffztsils").setHref("qs"), new ActionLink().setId(492672269).setRel("hfym").setHref("uihyeseuugcig"))));
