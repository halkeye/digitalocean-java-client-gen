...
public final class Components1MywxwzResponsesAllLoadBalancersContentApplicationJsonSchemaAllof0Tests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(LoadBalancerBaseAlgorithm.LEAST_CONNECTIONS, model.getLoadBalancers().get(0).getAlgorithm());
        Assertions.assertEquals(HealthCheckProtocol.HTTPS, model.getLoadBalancers().get(0).getHealthCheck().getProtocol());
        ...
        Assertions.assertEquals(155787926, model.getLoadBalancers().get(0).getHealthCheck().getResponseTimeoutSeconds());
    ...
    public void testSerialize() {
        Components1MywxwzResponsesAllLoadBalancersContentApplicationJsonSchemaAllof0 model = new Components1MywxwzResponsesAllLoadBalancersContentApplicationJsonSchemaAllof0().setLoadBalancers(Arrays.asList(new LoadBalancer().setName("wokyqsf").setSizeUnit(1123585127).setSize(LoadBalancerBaseSize.LB_MEDIUM).setAlgorithm(LoadBalancerBaseAlgorithm.LEAST_CONNECTIONS).setForwardingRules(Arrays.asList()).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.HTTPS).setPort(314147469).setPath("d").setCheckIntervalSeconds(293525589).setResponseTimeoutSeconds(155787926).setUnhealthyThreshold(697382672).setHealthyThreshold(1422718965)).setStickySessions(new StickySessions().setType(StickySessionsType.NONE).setCookieName("njdvv").setCookieTtlSeconds(1968267739)).setRedirectHttpToHttps(false).setEnableProxyProtocol(false).setEnableBackendKeepalive(true).setDisableLetsEncryptDnsRecords(true).setTag("xnrp"), new LoadBalancer().setName("gdkwbkurklpiigfu").setSizeUnit(1405753409).setSize(LoadBalancerBaseSize.LB_MEDIUM).setAlgorithm(LoadBalancerBaseAlgorithm.LEAST_CONNECTIONS).setForwardingRules(Arrays.asList()).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.TCP).setPort(2002633487).setPath("zzevtzqwczochwb").setCheckIntervalSeconds(575448740).setResponseTimeoutSeconds(1854687293).setUnhealthyThreshold(590017454).setHealthyThreshold(1088863938)).setStickySessions(new StickySessions().setType(StickySessionsType.COOKIES).setCookieName("iysdhorkslhraqki").setCookieTtlSeconds(1574377606)).setRedirectHttpToHttps(false).setEnableProxyProtocol(false).setEnableBackendKeepalive(true).setDisableLetsEncryptDnsRecords(true).setTag("qzbvbpsuvqhxt"), new LoadBalancer().setName("ef").setSizeUnit(2133577099).setSize(LoadBalancerBaseSize.LB_SMALL).setAlgorithm(LoadBalancerBaseAlgorithm.ROUND_ROBIN).setForwardingRules(Arrays.asList()).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.HTTP).setPort(169430650).setPath("hkxunsaujqgbb").setCheckIntervalSeconds(56442846).setResponseTimeoutSeconds(1048576922).setUnhealthyThreshold(337273485).setHealthyThreshold(1561894894)).setStickySessions(new StickySessions().setType(StickySessionsType.NONE).setCookieName("csloygsabdg").setCookieTtlSeconds(3439867)).setRedirectHttpToHttps(false).setEnableProxyProtocol(true).setEnableBackendKeepalive(false).setDisableLetsEncryptDnsRecords(true).setTag("oguflteat"), new LoadBalancer().setName("qhgzuyxtrvfdb").setSizeUnit(1815430425).setSize(LoadBalancerBaseSize.LB_SMALL).setAlgorithm(LoadBalancerBaseAlgorithm.ROUND_ROBIN).setForwardingRules(Arrays.asList()).setHealthCheck(new HealthCheck().setProtocol(HealthCheckProtocol.HTTP).setPort(1052451212).setPath("fdwfbwxy").setCheckIntervalSeconds(1038736198).setResponseTimeoutSeconds(1548321491).setUnhealthyThreshold(208581764).setHealthyThreshold(132351733)).setStickySessions(new StickySessions().setType(StickySessionsType.COOKIES).setCookieName("gajrzctw").setCookieTtlSeconds(1478328356)).setRedirectHttpToHttps(true).setEnableProxyProtocol(false).setEnableBackendKeepalive(true).setDisableLetsEncryptDnsRecords(true).setTag("vz")));
        model = BinaryData.fromObject(model).toObject(Components1MywxwzResponsesAllLoadBalancersContentApplicationJsonSchemaAllof0.class);
        Assertions.assertEquals("wokyqsf", model.getLoadBalancers().get(0).getName());
        Assertions.assertEquals(1123585127, model.getLoadBalancers().get(0).getSizeUnit());
        Assertions.assertEquals(LoadBalancerBaseSize.LB_MEDIUM, model.getLoadBalancers().get(0).getSize());
        Assertions.assertEquals(LoadBalancerBaseAlgorithm.LEAST_CONNECTIONS, model.getLoadBalancers().get(0).getAlgorithm());
