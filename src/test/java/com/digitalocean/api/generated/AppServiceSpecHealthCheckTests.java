...
public final class AppServiceSpecHealthCheckTests {
    ...
    public void testDeserialize() {
        AppServiceSpecHealthCheck model = BinaryData.fromString("{\"failure_threshold\":2125678810,\"port\":944157000221842248,\"http_path\":\"fhoqca\",\"initial_delay_seconds\":2104625260,\"period_seconds\":631291214,\"success_threshold\":1642223312,\"timeout_seconds\":668953670}").toObject(AppServiceSpecHealthCheck.class);
    ...
    public void testSerialize() {
        AppServiceSpecHealthCheck model = new AppServiceSpecHealthCheck().setFailureThreshold(2125678810).setPort(944157000221842248L).setHttpPath("fhoqca").setInitialDelaySeconds(2104625260).setPeriodSeconds(631291214).setSuccessThreshold(1642223312).setTimeoutSeconds(668953670);
