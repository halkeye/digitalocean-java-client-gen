...
public final class InvoicePreviewTests {
    ...
    public void testDeserialize() {
        InvoicePreview model = BinaryData.fromString("{\"invoice_uuid\":\"de\",\"amount\":\"qcwgaxfgvaknokz\",\"invoice_period\":\"jzrltixldzy\",\"updated_at\":\"ytpqsixymmpujiv\"}").toObject(InvoicePreview.class);
    ...
    public void testSerialize() {
        InvoicePreview model = new InvoicePreview().setInvoiceUuid("de").setAmount("qcwgaxfgvaknokz").setInvoicePeriod("jzrltixldzy").setUpdatedAt("ytpqsixymmpujiv");
