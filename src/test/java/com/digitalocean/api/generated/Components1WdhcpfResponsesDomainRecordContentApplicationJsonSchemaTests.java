...
public final class Components1WdhcpfResponsesDomainRecordContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1WdhcpfResponsesDomainRecordContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"domain_record\":{\"id\":262113779,\"type\":\"pvpvd\",\"name\":\"ytcovqs\",\"data\":\"srfjbdxzfxnx\",\"priority\":144885282,\"port\":278111652,\"ttl\":1373368105,\"weight\":404347705,\"flags\":1750181750,\"tag\":\"ihdcyyyzlw\"}}")
                        .toObject(Components1WdhcpfResponsesDomainRecordContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1WdhcpfResponsesDomainRecordContentApplicationJsonSchema model =
                new Components1WdhcpfResponsesDomainRecordContentApplicationJsonSchema()
                        .setDomainRecord(
                                new DomainRecord()
                                        .setType("pvpvd")
                                        .setName("ytcovqs")
                                        .setData("srfjbdxzfxnx")
                                        .setPriority(144885282)
                                        .setPort(278111652)
                                        .setTtl(1373368105)
                                        .setWeight(404347705)
                                        .setFlags(1750181750)
