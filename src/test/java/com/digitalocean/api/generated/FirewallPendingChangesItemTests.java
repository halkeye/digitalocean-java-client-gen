...
public final class FirewallPendingChangesItemTests {
    ...
    public void testDeserialize() {
        FirewallPendingChangesItem model =
                BinaryData.fromString("{\"droplet_id\":1021083960,\"removing\":true,\"status\":\"eboozflyacagaed\"}")
                        .toObject(FirewallPendingChangesItem.class);
    ...
    public void testSerialize() {
        FirewallPendingChangesItem model =
                new FirewallPendingChangesItem()
                        .setDropletId(1021083960)
                        .setRemoving(true)
                        .setStatus("eboozflyacagaed");
