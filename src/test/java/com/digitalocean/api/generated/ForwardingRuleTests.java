    ...
    public void testDeserialize() {
        ForwardingRule model =
                BinaryData.fromString(
                                "{\"entry_protocol\":\"http\",\"entry_port\":1515129407,\"target_protocol\":\"https\",\"target_port\":996544782,\"certificate_id\":\"nqpljpet\",\"tls_passthrough\":true}")
                        .toObject(ForwardingRule.class);
    ...
    public void testSerialize() {
        ForwardingRule model =
                new ForwardingRule()
                        ...
                        .setEntryPort(1515129407)
                        .setTargetProtocol(ForwardingRuleTargetProtocol.HTTPS)
                        .setTargetPort(996544782)
                        .setCertificateId("nqpljpet")
