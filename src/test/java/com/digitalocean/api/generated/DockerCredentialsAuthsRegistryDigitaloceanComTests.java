...
public final class DockerCredentialsAuthsRegistryDigitaloceanComTests {
    ...
    public void testDeserialize() {
        DockerCredentialsAuthsRegistryDigitaloceanCom model =
                BinaryData.fromString("{\"auth\":\"fbxjblajybdnb\"}")
                        .toObject(DockerCredentialsAuthsRegistryDigitaloceanCom.class);
    ...
    public void testSerialize() {
        DockerCredentialsAuthsRegistryDigitaloceanCom model =
                new DockerCredentialsAuthsRegistryDigitaloceanCom().setAuth("fbxjblajybdnb");
