...
public final class AppResponseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-07-20T17:56:39Z"), model.getApp().getActiveDeployment().getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-27T05:29:46Z"), model.getApp().getActiveDeployment().getPhaseLastUpdatedAt());
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-22T17:32:57Z"), model.getApp().getActiveDeployment().getUpdatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-28T18:40:43Z"), model.getApp().getInProgressDeployment().getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-10-06T20:56:23Z"), model.getApp().getInProgressDeployment().getPhaseLastUpdatedAt());
        Assertions.assertEquals(OffsetDateTime.parse("2021-03-02T18:46:22Z"), model.getApp().getInProgressDeployment().getUpdatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-06-17T05:28:42Z"), model.getApp().getPinnedDeployment().getCreatedAt());
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-09-24T01:09:52Z"), model.getApp().getPinnedDeployment().getPhaseLastUpdatedAt());
        Assertions.assertEquals(OffsetDateTime.parse("2021-07-24T04:45:31Z"), model.getApp().getPinnedDeployment().getUpdatedAt());
    }

    @Test
    public void testSerialize() {
        AppResponse model = new AppResponse().setApp(new App().setActiveDeployment(new AppsDeployment().setCause("mowaziynknlqwzdv").setClonedFrom("w").setCreatedAt(OffsetDateTime.parse("2021-07-20T17:56:39Z")).setId("zdtmaajquhuxylrj").setJobs(Arrays.asList()).setFunctions(Arrays.asList()).setPhase(AppsDeploymentPhase.PENDING_DEPLOY).setPhaseLastUpdatedAt(OffsetDateTime.parse("2021-03-27T05:29:46Z")).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setUpdatedAt(OffsetDateTime.parse("2021-03-22T17:32:57Z")).setWorkers(Arrays.asList())).setInProgressDeployment(new AppsDeployment().setCause("pzgpxtivhj").setClonedFrom("idibgqjxgpn").setCreatedAt(OffsetDateTime.parse("2021-03-28T18:40:43Z")).setId("vfgpikqmhhaowjrm").setJobs(Arrays.asList()).setFunctions(Arrays.asList()).setPhase(AppsDeploymentPhase.ERROR).setPhaseLastUpdatedAt(OffsetDateTime.parse("2021-10-06T20:56:23Z")).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setUpdatedAt(OffsetDateTime.parse("2021-03-02T18:46:22Z")).setWorkers(Arrays.asList())).setRegion(new AppsRegion()).setSpec(new AppSpec().setName("lu").setRegion(AppSpecRegion.FRA).setDomains(Arrays.asList()).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setJobs(Arrays.asList()).setWorkers(Arrays.asList()).setFunctions(Arrays.asList()).setDatabases(Arrays.asList())).setPinnedDeployment(new AppPinnedDeployment().setCause("mcuqudtcvc").setClonedFrom("ynpdkvgfab").setCreatedAt(OffsetDateTime.parse("2021-06-17T05:28:42Z")).setId("ibuz").setJobs(Arrays.asList()).setFunctions(Arrays.asList()).setPhase(AppsDeploymentPhase.ERROR).setPhaseLastUpdatedAt(OffsetDateTime.parse("2021-09-24T01:09:52Z")).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setUpdatedAt(OffsetDateTime.parse("2021-07-24T04:45:31Z")).setWorkers(Arrays.asList())));
