...
public final class ComponentsHjzmbwResponsesExistingCertificateContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsHjzmbwResponsesExistingCertificateContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"certificate\":{\"name\":\"wbqamteuliy\",\"not_after\":\"2021-06-17T06:47:53Z\",\"sha1_fingerprint\":\"cvmwfauxxepmy\",\"created_at\":\"2021-05-30T15:08:41Z\",\"dns_names\":[\"c\",\"miciij\",\"pkzfbojxj\"],\"state\":\"verified\",\"type\":\"lets_encrypt\"}}")
                        .toObject(ComponentsHjzmbwResponsesExistingCertificateContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsHjzmbwResponsesExistingCertificateContentApplicationJsonSchema model =
                new ComponentsHjzmbwResponsesExistingCertificateContentApplicationJsonSchema()
                        .setCertificate(
                                new Certificate()
                                        .setName("wbqamteuliy")
                                        .setDnsNames(Arrays.asList("c", "miciij", "pkzfbojxj"))
