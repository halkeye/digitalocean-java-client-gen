...
public final class Components1RzambuResponsesAccountContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1RzambuResponsesAccountContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"account\":{\"droplet_limit\":1080301009,\"floating_ip_limit\":1931850121,\"email\":\"sqe\",\"uuid\":\"aagdfmg\",\"email_verified\":true,\"status\":\"locked\",\"status_message\":\"hjxri\",\"team\":{\"uuid\":\"mrvktsizntoc\",\"name\":\"a\"}}}")
                        .toObject(Components1RzambuResponsesAccountContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1RzambuResponsesAccountContentApplicationJsonSchema model =
                new Components1RzambuResponsesAccountContentApplicationJsonSchema()
                        .setAccount(
                                new Account()
                                        .setDropletLimit(1080301009)
                                        .setFloatingIpLimit(1931850121)
                                        .setEmail("sqe")
                                        .setUuid("aagdfmg")
                                        .setEmailVerified(true)
                                        .setStatus(AccountStatus.LOCKED)
                                        .setStatusMessage("hjxri")
                                        .setTeam(new AccountTeam().setUuid("mrvktsizntoc").setName("a")));
        model =
