...
public final class ProductChargeItemTests {
    ...
    public void testDeserialize() {
        ProductChargeItem model =
                BinaryData.fromString("{\"amount\":\"cdmkxwxdcvjw\",\"name\":\"z\",\"count\":\"keciqchxrtuicd\"}")
                        .toObject(ProductChargeItem.class);
    ...
    public void testSerialize() {
        ProductChargeItem model =
                new ProductChargeItem().setAmount("cdmkxwxdcvjw").setName("z").setCount("keciqchxrtuicd");
