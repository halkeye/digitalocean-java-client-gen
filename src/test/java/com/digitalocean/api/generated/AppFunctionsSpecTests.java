...
public final class AppFunctionsSpecTests {
    ...
    public void testSerialize() {
        AppFunctionsSpec model = new AppFunctionsSpec().setCors(new AppsCorsPolicy().setAllowOrigins(Arrays.asList(new AppsStringMatch().setExact("y").setPrefix("uxakjsqzhzbezk").setRegex("msidxasicddyvv"), new AppsStringMatch().setExact("kgfmocwahpq").setPrefix("tjeaahhvjhh").setRegex("kzyb"))).setAllowMethods(Arrays.asList("idjks")).setAllowHeaders(Arrays.asList("yxvxevblbjed", "ljlageuaulxu", "smjbnkppxyn", "nlsvxeiz")).setExposeHeaders(Arrays.asList("klnsrmffey", "xcktpiymerteeamm", "qiekkkzddrt")).setMaxAge("doj").setAllowCredentials(false)).setRoutes(Arrays.asList(new AppRouteSpec().setPath("refdee").setPreservePathPrefix(true))).setName("cuijpxt").setSourceDir("uwprtujwsawd").setAlerts(Arrays.asList(new AppAlertSpec().setRule(AppAlertSpecRule.DOMAIN_LIVE).setDisabled(true).setOperator(AppAlertSpecOperator.GREATER_THAN).setValue(64.71156F).setWindow(AppAlertSpecWindow.TENMINUTES), new AppAlertSpec().setRule(AppAlertSpecRule.DOMAIN_LIVE).setDisabled(false).setOperator(AppAlertSpecOperator.LESS_THAN).setValue(90.4149F).setWindow(AppAlertSpecWindow.THIRTY_MINUTES), new AppAlertSpec().setRule(AppAlertSpecRule.FUNCTIONS_GBRATE_PERSECOND).setDisabled(true).setOperator(AppAlertSpecOperator.GREATER_THAN).setValue(82.394005F).setWindow(AppAlertSpecWindow.THIRTY_MINUTES), new AppAlertSpec().setRule(AppAlertSpecRule.DOMAIN_FAILED).setDisabled(true).setOperator(AppAlertSpecOperator.GREATER_THAN).setValue(12.662607F).setWindow(AppAlertSpecWindow.UNSPECIFIED_WINDOW))).setEnvs(Arrays.asList(new AppVariableDefinition().setKey("b").setScope(AppVariableDefinitionScope.RUNTIME).setType(AppVariableDefinitionType.GENERAL).setValue("db"), new AppVariableDefinition().setKey("vodhtn").setScope(AppVariableDefinitionScope.RUNANDBUILD_TIME).setType(AppVariableDefinitionType.SECRET).setValue("z"))).setGit(new AppsGitSourceSpec().setBranch("sckdlp").setRepoCloneUrl("zrcxfailcfxwmdbo")).setGithub(new AppsGithubSourceSpec().setBranch("gsftufqobrjlnacg").setDeployOnPush(true).setRepo("nhxk")).setGitlab(new AppsGitlabSourceSpec().setBranch("ytnrzvuljraae").setDeployOnPush(false).setRepo("kqg")).setLogDestinations(new AppLogDestinationDefinition().setName("kjq").setPapertrail(new AppLogDestinationPapertrailSpec().setEndpoint("broyla")).setDatadog(new AppLogDestinationDatadogSpec().setEndpoint("lcdisd").setApiKey("sfjbjsvg")).setLogtail(new AppLogDestinationLogtailSpec().setToken("hryvy")));
