...
public final class DomainRecordCaaTests {
    ...
    public void testDeserialize() {
        DomainRecordCaa model = BinaryData.fromString("{\"id\":387760911,\"type\":\"idnwceha\",\"name\":\"do\",\"data\":\"l\",\"priority\":1237789789,\"port\":1849168573,\"ttl\":1019863501,\"weight\":460615176,\"flags\":801948793,\"tag\":\"aeapfsergd\"}").toObject(DomainRecordCaa.class);
    ...
    public void testSerialize() {
        DomainRecordCaa model = new DomainRecordCaa().setType("idnwceha").setName("do").setData("l").setPriority(1237789789).setPort(1849168573).setTtl(1019863501).setWeight(460615176).setFlags(801948793).setTag("aeapfsergd");
