...
public final class Components1Ndvt7KResponsesReservedIpContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        Components1Ndvt7KResponsesReservedIpContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"reserved_ip\":{\"ip\":\"omxoalknuyapvi\",\"region\":{\"name\":\"icyv\",\"slug\":\"chcaptkhjxnrk\",\"available\":false},\"locked\":false}}")
                        .toObject(Components1Ndvt7KResponsesReservedIpContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        Components1Ndvt7KResponsesReservedIpContentApplicationJsonSchema model =
                new Components1Ndvt7KResponsesReservedIpContentApplicationJsonSchema()
                        .setReservedIp(
                                new ReservedIp()
                                        .setIp("omxoalknuyapvi")
                                        .setRegion(
                                                new ReservedIpRegion()
                                                        .setName("icyv")
                                                        .setSlug("chcaptkhjxnrk")
                                                        .setAvailable(false))
                                        .setLocked(false));
        model =
