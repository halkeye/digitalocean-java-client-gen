...
public final class ComponentsJhlieaResponsesAllRegionsContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsJhlieaResponsesAllRegionsContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"links\":{},\"meta\":{\"total\":460864060},\"regions\":[{\"name\":\"c\",\"slug\":\"xvlqgfbrve\",\"available\":true}]}")
                        .toObject(ComponentsJhlieaResponsesAllRegionsContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsJhlieaResponsesAllRegionsContentApplicationJsonSchema model =
                new ComponentsJhlieaResponsesAllRegionsContentApplicationJsonSchema()
                        .setRegions(Arrays.asList(new Region().setName("c").setSlug("xvlqgfbrve").setAvailable(true)))
                        .setLinks(new PageLinks())
                        .setMeta(new MetaMeta().setTotal(460864060));
        model =
