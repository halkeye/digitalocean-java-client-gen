...
public final class Components1Gyiz9ResponsesNodePoolUpdateContentApplicationJsonSchemaTests {
    ...
    public void testSerialize() {
        Components1Gyiz9ResponsesNodePoolUpdateContentApplicationJsonSchema model = new Components1Gyiz9ResponsesNodePoolUpdateContentApplicationJsonSchema().setNodePool(new KubernetesNodePool().setSize("wfcn").setName("wy").setCount(1842021804).setTags(Arrays.asList("qldqabn")).setTaints(Arrays.asList(new KubernetesNodePoolTaint().setKey("bqxfbb").setValue("cfddofxnfb").setEffect(KubernetesNodePoolTaintEffect.PREFER_NO_SCHEDULE), new KubernetesNodePoolTaint().setKey("rqaedwo").setValue("cytjgoea").setEffect(KubernetesNodePoolTaintEffect.NO_EXECUTE))).setAutoScale(false).setMinNodes(768416570).setMaxNodes(806704541));
        model = BinaryData.fromObject(model).toObject(Components1Gyiz9ResponsesNodePoolUpdateContentApplicationJsonSchema.class);
        Assertions.assertEquals("wfcn", model.getNodePool().getSize());
        Assertions.assertEquals("wy", model.getNodePool().getName());
        Assertions.assertEquals(1842021804, model.getNodePool().getCount());
        Assertions.assertEquals("qldqabn", model.getNodePool().getTags().get(0));
