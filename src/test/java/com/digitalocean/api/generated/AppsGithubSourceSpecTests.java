...
public final class AppsGithubSourceSpecTests {
    ...
    public void testDeserialize() {
        AppsGithubSourceSpec model = BinaryData.fromString("{\"branch\":\"qtmldgxo\",\"deploy_on_push\":false,\"repo\":\"clnpkci\"}").toObject(AppsGithubSourceSpec.class);
    ...
    public void testSerialize() {
        AppsGithubSourceSpec model = new AppsGithubSourceSpec().setBranch("qtmldgxo").setDeployOnPush(false).setRepo("clnpkci");
