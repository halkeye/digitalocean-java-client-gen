...
public final class AppsDeploymentResponseTests {
    ...
    public void testDeserialize() {
        ...
        Assertions.assertEquals(OffsetDateTime.parse("2021-11-23T05:17:09Z"), model.getDeployment().getPhaseLastUpdatedAt());
    ...
    public void testSerialize() {
        AppsDeploymentResponse model = new AppsDeploymentResponse().setDeployment(new AppsDeployment().setCause("leallklm").setClonedFrom("hlowkx").setCreatedAt(OffsetDateTime.parse("2021-06-16T07:34:23Z")).setId("rdfjmzsyzfhotl").setJobs(Arrays.asList(new AppsDeploymentJob().setName("yych").setSourceCommitHash("sjlpjrtwszhv"))).setFunctions(Arrays.asList(new AppsDeploymentFunctions().setName("phvtrrmhwrb").setSourceCommitHash("pyf").setNamespace("bhvjglr"), new AppsDeploymentFunctions().setName("uyzlw").setSourceCommitHash("memhooclutnpq").setNamespace("mczjkm"), new AppsDeploymentFunctions().setName("kyujxsglhsrrr").setSourceCommitHash("jylmbkzudnigr").setNamespace("hotj"))).setPhase(AppsDeploymentPhase.PENDING_BUILD).setPhaseLastUpdatedAt(OffsetDateTime.parse("2021-11-23T05:17:09Z")).setProgress(new AppsDeploymentProgress().setErrorSteps(289344898).setPendingSteps(446095930).setRunningSteps(1271933494).setSteps(Arrays.asList()).setSuccessSteps(1865358517).setSummarySteps(Arrays.asList()).setTotalSteps(659940169)).setServices(Arrays.asList(new AppsDeploymentService().setName("iqakydiwfbr").setSourceCommitHash("pzdqtvhcspod"), new AppsDeploymentService().setName("axsipietgb").setSourceCommitHash("jfulbmoic"), new AppsDeploymentService().setName("lpnfpubntnb").setSourceCommitHash("zviqsowsaae"))).setSpec(new AppSpec().setName("attcju").setRegion(AppSpecRegion.NYC).setDomains(Arrays.asList()).setServices(Arrays.asList()).setStaticSites(Arrays.asList()).setJobs(Arrays.asList()).setWorkers(Arrays.asList()).setFunctions(Arrays.asList()).setDatabases(Arrays.asList())).setStaticSites(Arrays.asList(new AppsDeploymentStaticSite().setName("kyylizr").setSourceCommitHash("jpsfxsfu"), new AppsDeploymentStaticSite().setName("lvt").setSourceCommitHash("agb"), new AppsDeploymentStaticSite().setName("dqlvhukoveof").setSourceCommitHash("rvjfnmjmvlw"))).setUpdatedAt(OffsetDateTime.parse("2021-05-11T11:22:01Z")).setWorkers(Arrays.asList(new AppsDeploymentWorker().setName("puuyjucejik").setSourceCommitHash("eovvtzej"), new AppsDeploymentWorker().setName("jklntikyj").setSourceCommitHash("k"), new AppsDeploymentWorker().setName("qzolxrzvhqjw").setSourceCommitHash("htgv"))));
