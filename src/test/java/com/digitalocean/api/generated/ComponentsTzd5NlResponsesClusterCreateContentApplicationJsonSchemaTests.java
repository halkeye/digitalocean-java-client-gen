...
public final class ComponentsTzd5NlResponsesClusterCreateContentApplicationJsonSchemaTests {
    ...
    public void testDeserialize() {
        ComponentsTzd5NlResponsesClusterCreateContentApplicationJsonSchema model =
                BinaryData.fromString(
                                "{\"kubernetes_cluster\":{\"name\":\"dw\",\"region\":\"tf\",\"version\":\"bvtzldzchub\",\"cluster_subnet\":\"wnlzuvi\",\"service_subnet\":\"lghfrbzakpjtcqra\",\"ipv4\":\"jpsucmxi\",\"endpoint\":\"wqxynqjgsatkyvsc\",\"tags\":[\"gcru\",\"xhirc\",\"gcvsvkkjbjolpy\",\"klkvuznadvh\"],\"node_pools\":[{\"name\":\"oi\",\"count\":1423889561,\"tags\":[],\"taints\":[],\"auto_scale\":false,\"min_nodes\":944011358,\"max_nodes\":1145717220,\"nodes\":[],\"size\":\"emqwtq\"}],\"maintenance_policy\":{\"start_time\":\"gyksikaw\",\"duration\":\"vmwdvgjqcrbk\",\"day\":\"monday\"},\"auto_upgrade\":false,\"status\":{\"state\":\"deleted\",\"message\":\"weoj\"},\"created_at\":\"2020-12-27T19:59:50Z\",\"updated_at\":\"2021-06-07T02:56:02Z\",\"surge_upgrade\":true,\"ha\":true,\"registry_enabled\":false}}")
                        .toObject(ComponentsTzd5NlResponsesClusterCreateContentApplicationJsonSchema.class);
    ...
    public void testSerialize() {
        ComponentsTzd5NlResponsesClusterCreateContentApplicationJsonSchema model =
                new ComponentsTzd5NlResponsesClusterCreateContentApplicationJsonSchema()
                        .setKubernetesCluster(
                                new Cluster()
                                        .setName("dw")
                                        .setRegion("tf")
                                        .setVersion("bvtzldzchub")
                                        .setTags(Arrays.asList("gcru", "xhirc", "gcvsvkkjbjolpy", "klkvuznadvh"))
                                        .setNodePools(
                                                Arrays.asList(
                                                        new KubernetesNodePool()
                                                                ...
                                                                .setAutoScale(false)
                                                                .setMinNodes(944011358)
                                                                .setMaxNodes(1145717220)))
                                        .setMaintenancePolicy(
                                                new MaintenancePolicy()
                                                        .setStartTime("gyksikaw")
